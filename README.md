...
A lightweight markdown editor library with perfect WYSIWYG alignment using an invisible textarea overlay technique. Includes optional toolbar. ~122KB minified with all features.
...
|---------|----------|---------|----------|------------|---------|
| **Size** | ~122KB | 364.02 KB | 344.51 KB | 560.99 KB | 323.69 KB |
