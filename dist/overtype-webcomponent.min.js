...
`)}function dt(i,e={},t={}){return{...i,colors:{...i.colors,...e},previewColors:{...i.previewColors,...t}}}function Se(i={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=i,a=Object.keys(s).length>0?`
  ...
  `}var pe={};lt(pe,{applyCustomFormat:()=>Et,default:()=>Bi,expandSelection:()=>_t,getActiveFormats:()=>Re,getDebugMode:()=>Ge,hasFormat:()=>Lt,insertHeader:()=>ce,insertLink:()=>Te,preserveSelection:()=>xt,setDebugMode:()=>vt,setUndoMethod:()=>wt,toggleBold:()=>Ee,toggleBulletList:()=>He,toggleCode:()=>Ce,toggleH1:()=>Pe,toggleH2:()=>$e,toggleH3:()=>Ie,toggleItalic:()=>Ae,toggleNumberedList:()=>Me,toggleQuote:()=>Oe,toggleTaskList:()=>le});var Ei=Object.defineProperty,ht=Object.getOwnPropertySymbols,Ai=Object.prototype.hasOwnProperty,Ci=Object.prototype.propertyIsEnumerable,ut=(i,e,t)=>e in i?Ei(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,ft=(i,e)=>{for(var t in e||(e={}))Ai.call(e,t)&&ut(i,t,e[t]);if(ht)for(var t of ht(e))Ci.call(e,t)&&ut(i,t,e[t]);return i},R={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function Ti(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function B(i){return ft(ft({},Ti()),i)}var ae=!1;function vt(i){ae=i}function Ge(){return ae}function x(i,e,t){ae&&(console.group(`\u{1F50D} ${i}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function Le(i,e){if(!ae)return;let t=i.value.slice(i.selectionStart,i.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=i.value.slice(Math.max(0,i.selectionStart-10),i.selectionStart),o=i.value.slice(i.selectionEnd,Math.min(i.value.length,i.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(o)),console.groupEnd()}function yt(i){ae&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(i.text)),console.log("New selection:",`${i.selectionStart}-${i.selectionEnd}`),console.groupEnd())}var T=null;function N(i,{text:e,selectionStart:t,selectionEnd:n}){let o=Ge();o&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),i.focus();let r=i.selectionStart,s=i.selectionEnd,a=i.value.slice(0,r),l=i.value.slice(s);o&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(l.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(i.value.slice(r,s))));let c=i.value,p=r!==s;if(T===null||T===!0){i.contentEditable="true";try{T=document.execCommand("insertText",!1,e),o&&console.log("execCommand returned:",T,"for text with",e.split(`
`).length,"lines")}catch(d){T=!1,o&&console.log("execCommand threw error:",d)}i.contentEditable="false"}if(o&&(console.log("canInsertText before:",T),console.log("execCommand result:",T)),T){let d=a+e+l,h=i.value;o&&(console.log("Expected length:",d.length),console.log("Actual length:",h.length)),h!==d&&o&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(d.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!T)if(o&&console.log("Using manual insertion"),i.value===c){o&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(d){}i.value=a+e+l;try{document.execCommand("ms-endUndoUnit")}catch(d){}i.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else o&&console.log("Value was changed by execCommand, skipping manual insertion");o&&console.log("Setting selection range:",t,n),t!=null&&n!=null?i.setSelectionRange(t,n):i.setSelectionRange(r,i.selectionEnd),o&&(console.log("Final value length:",i.value.length),console.groupEnd())}function wt(i){switch(i){case"native":T=!0;break;case"manual":T=!1;break;case"auto":T=null;break}}function Qe(i){return i.trim().split(`
`).length>1}function Hi(i,e){let t=e;for(;i[t]&&i[t-1]!=null&&!i[t-1].match(/\s/);)t--;return t}function Mi(i,e,t){let n=e,o=t?/\n/:/\s/;for(;i[n]&&!i[n].match(o);)n++;return n}function bt(i){let e=i.value.split(`
`),t=0;for(let n=0;n<e.length;n++){let o=e[n].length+1;i.selectionStart>=t&&i.selectionStart<t+o&&(i.selectionStart=t),i.selectionEnd>=t&&i.selectionEnd<t+o&&(n===e.length-1?i.selectionEnd=Math.min(t+e[n].length,i.value.length):i.selectionEnd=t+o-1),t+=o}}function Oi(i,e,t,n=!1){if(i.selectionStart===i.selectionEnd)i.selectionStart=Hi(i.value,i.selectionStart),i.selectionEnd=Mi(i.value,i.selectionEnd,n);else{let o=i.selectionStart-e.length,r=i.selectionEnd+t.length,s=i.value.slice(o,i.selectionStart)===e,a=i.value.slice(i.selectionEnd,r)===t;s&&a&&(i.selectionStart=o,i.selectionEnd=r)}return i.value.slice(i.selectionStart,i.selectionEnd)}function Je(i){let e=i.value.slice(0,i.selectionStart),t=i.value.slice(i.selectionEnd),n=e.match(/\n*$/),o=t.match(/^\n*/),r=n?n[0].length:0,s=o?o[0].length:0,a="",l="";return e.match(/\S/)&&r<2&&(a=`
...
`;)c++;i.selectionStart=a,i.selectionEnd=c}else bt(i);let l=e(i);if(t.adjustSelection){let p=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),d=t.adjustSelection(p,n,o,a);l.selectionStart=d.start,l.selectionEnd=d.end}else if(t.prefix){let p=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?p?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=n+t.prefix.length,l.selectionEnd=l.selectionStart):p?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=Math.max(o-t.prefix.length,a)):(l.selectionStart=n+t.prefix.length,l.selectionEnd=o+t.prefix.length)}return l}function te(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:c,scanFor:p,surroundWithNewlines:d,trimFirst:h}=e,u=i.selectionStart,f=i.selectionEnd,m=i.value.slice(i.selectionStart,i.selectionEnd),v=Qe(m)&&s&&s.length>0?`${s}
`:o,y=Qe(m)&&a&&a.length>0?`
${a}`:r;if(c){let k=i.value[i.selectionStart-1];i.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(v=` ${v}`)}m=Oi(i,v,y,e.multiline);let w=i.selectionStart,b=i.selectionEnd,S=l&&l.length>0&&y.indexOf(l)>-1&&m.length>0;if(d){let k=Je(i);t=k.newlinesToAppend,n=k.newlinesToPrepend,v=t+o,y+=n}if(m.startsWith(v)&&m.endsWith(y)){let k=m.slice(v.length,m.length-y.length);if(u===f){let _=u-v.length;_=Math.max(_,w),_=Math.min(_,w+k.length),w=b=_}else b=w+k.length;return{text:k,selectionStart:w,selectionEnd:b}}else if(S)if(p&&p.length>0&&m.match(p)){y=y.replace(l,m);let k=v+y;return w=b=w+v.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=v+m+y;return w=w+v.length+m.length+y.indexOf(l),b=w+l.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=v+m+y;w=u+v.length,b=f+v.length;let _=m.match(/^\s*|\s*$/g);if(h&&_){let be=_[0]||"",Y=_[1]||"";k=be+v+m.trim()+y+Y,w+=be.length,b-=Y.length}return{text:k,selectionStart:w,selectionEnd:b}}}function Xe(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,l=r.split(`
`);if(l.every(p=>p.startsWith(t)&&(!n||p.endsWith(n))))r=l.map(p=>{let d=p.slice(t.length);return n&&(d=d.slice(0,d.length-n.length)),d}).join(`
`),a=s+r.length;else if(r=l.map(p=>t+p+(n||"")).join(`
`),o){let{newlinesToAppend:p,newlinesToPrepend:d}=Je(i);s+=p.length,a=s+r.length,r=p+r+d}return{text:r,selectionStart:s,selectionEnd:a}}function mt(i){let e=i.split(`
...
`),processed:n}}function se(i,e){return e?"- ":`${i+1}. `}function Pi(i,e){let t,n,o;return i.orderedList?(t=mt(e),n=gt(t.text),o=n.text):(t=gt(e),n=mt(t.text),o=n.text),[t,n,o]}function $i(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;bt(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,l]=Pi(e,r),c=l.split(`
`).map((m,v)=>`${se(v,e.unorderedList)}${m}`),p=c.reduce((m,v,y)=>m+se(y,e.unorderedList).length,0),d=c.reduce((m,v,y)=>m+se(y,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-se(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-p),{text:l,selectionStart:n,selectionEnd:o};let{newlinesToAppend:h,newlinesToPrepend:u}=Je(i),f=h+c.join(`
`)+u;return t?(n=Math.max(n+se(0,e.unorderedList).length+h.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+p-d):(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+p),{text:f,selectionStart:n,selectionEnd:o}}function kt(i,e){let t=_e(i,n=>$i(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),l=/^\d+\.\s+/,c=/^- /,p=l.test(a),d=c.test(a),h=e.orderedList&&p||e.unorderedList&&d;if(o===r)if(h){let u=a.match(e.orderedList?l:c),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(p||d){let u=a.match(p?l:c),f=u?u[0].length:0,v=(e.unorderedList?2:3)-f;return{start:o+v,end:o+v}}else{let u=e.unorderedList?2:3;return{start:o+u,end:o+u}}else if(h){let u=a.match(e.orderedList?l:c),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(p||d){let u=a.match(p?l:c),f=u?u[0].length:0,v=(e.unorderedList?2:3)-f;return{start:o+v,end:r+v}}else{let u=e.unorderedList?2:3;return{start:o+u,end:r+u}}}});N(i,t)}function St(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let d of r){if(t>=s&&t<=s+d.length){a=d;break}s+=d.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,t-10),c=Math.min(o.length,n+10),p=o.slice(l,c);if(p.includes("**")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(p.includes("_")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(p.includes("`")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100));d.includes("`")&&h.includes("`")&&e.push("code")}if(p.includes("[")&&p.includes("]")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&o.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function Ii(i,e){return St(i).includes(e)}function Ri(i,e={}){if(!i)return;let{toWord:t,toLine:n,toFormat:o}=e,{selectionStart:r,selectionEnd:s,value:a}=i;if(n){let l=a.split(`
`),c=0,p=0,d=0;for(let h of l){if(r>=d&&r<=d+h.length){c=d,p=d+h.length;break}d+=h.length+1}i.selectionStart=c,i.selectionEnd=p}else if(t&&r===s){let l=r,c=s;for(;l>0&&!/\s/.test(a[l-1]);)l--;for(;c<a.length&&!/\s/.test(a[c]);)c++;i.selectionStart=l,i.selectionEnd=c}}function Ee(i){if(!i||i.disabled||i.readOnly)return;x("toggleBold","Starting"),Le(i,"Before");let e=B(R.bold),t=te(i,e);yt(t),N(i,t),Le(i,"After")}function Ae(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.italic),t=te(i,e);N(i,t)}function Ce(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.code),t=te(i,e);N(i,t)}function Te(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=B(R.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=te(i,n);N(i,r)}function He(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.bulletList);kt(i,e)}function Me(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.numberedList);kt(i,e)}function Oe(i){if(!i||i.disabled||i.readOnly)return;x("toggleQuote","Starting"),Le(i,"Initial");let e=B(R.quote),t=_e(i,n=>Xe(n,e),{prefix:e.prefix});yt(t),N(i,t),Le(i,"Final")}function le(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.taskList),t=_e(i,n=>Xe(n,e),{prefix:e.prefix});N(i,t)}function ce(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${t}`),x("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=B(R[n]||R.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let c=a;for(;c<r.length&&r[c]!==`
`;)c++;let p=r.slice(l,c);x("insertHeader",`Current line (before): "${p}"`);let d=p.match(/^(#{1,6})\s*/),h=d?d[1].length:0,u=d?d[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${d?`"${d[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${h}`),x("insertHeader",`  - Existing prefix length: ${u}`),x("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let m=_e(i,v=>{let y=v.value.slice(v.selectionStart,v.selectionEnd);x("insertHeader",`Line in operation: "${y}"`);let w=y.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${w}"`);let b;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),b=w):h>0?(x("insertHeader",`ACTION: Replacing H${h} with H${e}`),b=o.prefix+w):(x("insertHeader","ACTION: Adding new header"),b=o.prefix+w),x("insertHeader",`New line: "${b}"`),{text:b,selectionStart:v.selectionStart,selectionEnd:v.selectionEnd}},{prefix:o.prefix,adjustSelection:(v,y,w,b)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${v}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${y}, selEnd: ${w}`),x("insertHeader",`  - lineStartPos: ${b}`),f){let S=Math.max(y-u,b);return x("insertHeader",`  - Removing header, adjusting by -${u}`),{start:S,end:y===w?S:Math.max(w-u,b)}}else if(u>0){let S=o.prefix.length-u;return x("insertHeader",`  - Replacing header, adjusting by ${S}`),{start:y+S,end:w+S}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:y+o.prefix.length,end:w+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),N(i,m)}function Pe(i){ce(i,1,!0)}function $e(i){ce(i,2,!0)}function Ie(i){ce(i,3,!0)}function Re(i){return St(i)}function Lt(i,e){return Ii(i,e)}function _t(i,e={}){Ri(i,e)}function Et(i,e){if(!i||i.disabled||i.readOnly)return;let t=B(e),n;if(t.multiline){let o=i.value.slice(i.selectionStart,i.selectionEnd);Qe(o)?n=Xe(i,t):n=te(i,t)}else n=te(i,t);N(i,n)}var Bi={toggleBold:Ee,toggleItalic:Ae,toggleCode:Ce,insertLink:Te,toggleBulletList:He,toggleNumberedList:Me,toggleQuote:Oe,toggleTaskList:le,insertHeader:ce,toggleH1:Pe,toggleH2:$e,toggleH3:Ie,getActiveFormats:Re,hasFormat:Lt,expandSelection:_t,applyCustomFormat:Et,preserveSelection:xt,setUndoMethod:wt,setDebugMode:vt,getDebugMode:Ge};var Be=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let t=this.createSeparator();this.container.appendChild(t)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let t=document.createElement("button");return t.className="overtype-toolbar-button",t.type="button",t.setAttribute("data-button",e.name),t.title=e.title||"",t.setAttribute("aria-label",e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(t.classList.add("has-dropdown"),t.dataset.dropdown="true",t.addEventListener("click",n=>{n.preventDefault(),this.toggleViewModeDropdown(t)}),t):(t._clickHandler=n=>{n.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,n)},t.addEventListener("click",t._clickHandler),t)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:t=>this.editor.setValue(t),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:t}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){let t=document.querySelector(".overtype-dropdown-menu");if(t){t.remove(),e.classList.remove("dropdown-active");return}e.classList.add("dropdown-active");let n=this.createViewModeDropdown(e),o=e.getBoundingClientRect();n.style.position="absolute",n.style.top=`${o.bottom+5}px`,n.style.left=`${o.left}px`,document.body.appendChild(n),this.handleDocumentClick=r=>{!n.contains(r.target)&&!e.contains(r.target)&&(n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createViewModeDropdown(e){let t=document.createElement("div");t.className="overtype-dropdown-menu";let n=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return n.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.textContent=r.label,r.id===o){s.classList.add("active"),s.setAttribute("aria-current","true");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}t.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),t.appendChild(s)}),t}updateButtonStates(){var e;try{let t=((e=Re)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([n,o])=>{if(n==="viewMode")return;let r=!1;switch(n){case"bold":r=t.includes("bold");break;case"italic":r=t.includes("italic");break;case"code":r=!1;break;case"bulletList":r=t.includes("bullet-list");break;case"orderedList":r=t.includes("numbered-list");break;case"taskList":r=t.includes("task-list");break;case"quote":r=t.includes("quote");break;case"h1":r=t.includes("header");break;case"h2":r=t.includes("header-2");break;case"h3":r=t.includes("header-3");break}o.classList.toggle("active",r),o.setAttribute("aria-pressed",r.toString())})}catch(t){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var he=Math.min,U=Math.max,ue=Math.round;var P=i=>({x:i,y:i}),Fi={left:"right",right:"left",bottom:"top",top:"bottom"},zi={start:"end",end:"start"};function Ye(i,e,t){return U(i,he(e,t))}function fe(i,e){return typeof i=="function"?i(e):i}function W(i){return i.split("-")[0]}function me(i){return i.split("-")[1]}function et(i){return i==="x"?"y":"x"}function tt(i){return i==="y"?"height":"width"}var Ni=new Set(["top","bottom"]);function D(i){return Ni.has(W(i))?"y":"x"}function it(i){return et(D(i))}function Tt(i,e,t){t===void 0&&(t=!1);let n=me(i),o=it(i),r=tt(o),s=o==="x"?n===(t?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=de(s)),[s,de(s)]}function Ht(i){let e=de(i);return[Fe(i),e,Fe(e)]}function Fe(i){return i.replace(/start|end/g,e=>zi[e])}var At=["left","right"],Ct=["right","left"],Di=["top","bottom"],ji=["bottom","top"];function Vi(i,e,t){switch(i){case"top":case"bottom":return t?e?Ct:At:e?At:Ct;case"left":case"right":return e?Di:ji;default:return[]}}function Mt(i,e,t,n){let o=me(i),r=Vi(W(i),t==="start",n);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(Fe)))),r}function de(i){return i.replace(/left|right|bottom|top/g,e=>Fi[e])}function Ui(i){return{top:0,right:0,bottom:0,left:0,...i}}function Ot(i){return typeof i!="number"?Ui(i):{top:i,right:i,bottom:i,left:i}}function G(i){let{x:e,y:t,width:n,height:o}=i;return{width:n,height:o,top:t,left:e,right:e+n,bottom:t+o,x:e,y:t}}function Pt(i,e,t){let{reference:n,floating:o}=i,r=D(e),s=it(e),a=tt(s),l=W(e),c=r==="y",p=n.x+n.width/2-o.width/2,d=n.y+n.height/2-o.height/2,h=n[a]/2-o[a]/2,u;switch(l){case"top":u={x:p,y:n.y-o.height};break;case"bottom":u={x:p,y:n.y+n.height};break;case"right":u={x:n.x+n.width,y:d};break;case"left":u={x:n.x-o.width,y:d};break;default:u={x:n.x,y:n.y}}switch(me(e)){case"start":u[s]-=h*(t&&c?-1:1);break;case"end":u[s]+=h*(t&&c?-1:1);break}return u}async function $t(i,e){var t;e===void 0&&(e={});let{x:n,y:o,platform:r,rects:s,elements:a,strategy:l}=i,{boundary:c="clippingAncestors",rootBoundary:p="viewport",elementContext:d="floating",altBoundary:h=!1,padding:u=0}=fe(e,i),f=Ot(u),v=a[h?d==="floating"?"reference":"floating":d],y=G(await r.getClippingRect({element:(t=await(r.isElement==null?void 0:r.isElement(v)))==null||t?v:v.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:p,strategy:l})),w=d==="floating"?{x:n,y:o,width:s.floating.width,height:s.floating.height}:s.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},k=G(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:b,strategy:l}):w);return{top:(y.top-k.top+f.top)/S.y,bottom:(k.bottom-y.bottom+f.bottom)/S.y,left:(y.left-k.left+f.left)/S.x,right:(k.right-y.right+f.right)/S.x}}var It=async(i,e,t)=>{let{placement:n="bottom",strategy:o="absolute",middleware:r=[],platform:s}=t,a=r.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(e)),c=await s.getElementRects({reference:i,floating:e,strategy:o}),{x:p,y:d}=Pt(c,n,l),h=n,u={},f=0;for(let v=0;v<a.length;v++){var m;let{name:y,fn:w}=a[v],{x:b,y:S,data:k,reset:_}=await w({x:p,y:d,initialPlacement:n,placement:h,strategy:o,middlewareData:u,rects:c,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:$t},elements:{reference:i,floating:e}});p=b!=null?b:p,d=S!=null?S:d,u={...u,[y]:{...u[y],...k}},_&&f<=50&&(f++,typeof _=="object"&&(_.placement&&(h=_.placement),_.rects&&(c=_.rects===!0?await s.getElementRects({reference:i,floating:e,strategy:o}):_.rects),{x:p,y:d}=Pt(c,h,l)),v=-1)}return{x:p,y:d,placement:h,strategy:o,middlewareData:u}};var Rt=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(e){var t,n;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:l,elements:c}=e,{mainAxis:p=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...v}=fe(i,e);if((t=r.arrow)!=null&&t.alignmentOffset)return{};let y=W(o),w=D(a),b=W(a)===a,S=await(l.isRTL==null?void 0:l.isRTL(c.floating)),k=h||(b||!m?[de(a)]:Ht(a)),_=f!=="none";!h&&_&&k.push(...Mt(a,m,f,S));let be=[a,...k],Y=await l.detectOverflow(e,v),xe=[],ee=((n=r.flip)==null?void 0:n.overflows)||[];if(p&&xe.push(Y[y]),d){let K=Tt(o,s,S);xe.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:xe}],!xe.every(K=>K<=0)){var rt,st;let K=(((rt=r.flip)==null?void 0:rt.index)||0)+1,Ke=be[K];if(Ke&&(!(d==="alignment"?w!==D(Ke):!1)||ee.every(O=>D(O.placement)===w?O.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:Ke}};let oe=(st=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,O)=>Z.overflows[1]-O.overflows[1])[0])==null?void 0:st.placement;if(!oe)switch(u){case"bestFit":{var at;let Z=(at=ee.filter(O=>{if(_){let V=D(O.placement);return V===w||V==="y"}return!0}).map(O=>[O.placement,O.overflows.filter(V=>V>0).reduce((V,wi)=>V+wi,0)]).sort((O,V)=>O[1]-V[1])[0])==null?void 0:at[0];Z&&(oe=Z);break}case"initialPlacement":oe=a;break}if(o!==oe)return{reset:{placement:oe}}}return{}}}};var Wi=new Set(["left","top"]);async function qi(i,e){let{placement:t,platform:n,elements:o}=i,r=await(n.isRTL==null?void 0:n.isRTL(o.floating)),s=W(t),a=me(t),l=D(t)==="y",c=Wi.has(s)?-1:1,p=r&&l?-1:1,d=fe(e,i),{mainAxis:h,crossAxis:u,alignmentAxis:f}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&typeof f=="number"&&(u=a==="end"?f*-1:f),l?{x:u*p,y:h*c}:{x:h*c,y:u*p}}var Bt=function(i){return i===void 0&&(i=0),{name:"offset",options:i,async fn(e){var t,n;let{x:o,y:r,placement:s,middlewareData:a}=e,l=await qi(e,i);return s===((t=a.offset)==null?void 0:t.placement)&&(n=a.arrow)!=null&&n.alignmentOffset?{}:{x:o+l.x,y:r+l.y,data:{...l,placement:s}}}}},Ft=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(e){let{x:t,y:n,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:y=>{let{x:w,y:b}=y;return{x:w,y:b}}},...c}=fe(i,e),p={x:t,y:n},d=await r.detectOverflow(e,c),h=D(W(o)),u=et(h),f=p[u],m=p[h];if(s){let y=u==="y"?"top":"left",w=u==="y"?"bottom":"right",b=f+d[y],S=f-d[w];f=Ye(b,f,S)}if(a){let y=h==="y"?"top":"left",w=h==="y"?"bottom":"right",b=m+d[y],S=m-d[w];m=Ye(b,m,S)}let v=l.fn({...e,[u]:f,[h]:m});return{...v,data:{x:v.x-t,y:v.y-n,enabled:{[u]:s,[h]:a}}}}}};function Ne(){return typeof window<"u"}function J(i){return Nt(i)?(i.nodeName||"").toLowerCase():"#document"}function C(i){var e;return(i==null||(e=i.ownerDocument)==null?void 0:e.defaultView)||window}function F(i){var e;return(e=(Nt(i)?i.ownerDocument:i.document)||window.document)==null?void 0:e.documentElement}function Nt(i){return Ne()?i instanceof Node||i instanceof C(i).Node:!1}function H(i){return Ne()?i instanceof Element||i instanceof C(i).Element:!1}function $(i){return Ne()?i instanceof HTMLElement||i instanceof C(i).HTMLElement:!1}function zt(i){return!Ne()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof C(i).ShadowRoot}var Ki=new Set(["inline","contents"]);function ie(i){let{overflow:e,overflowX:t,overflowY:n,display:o}=M(i);return/auto|scroll|overlay|hidden|clip/.test(e+n+t)&&!Ki.has(o)}var Zi=new Set(["table","td","th"]);function Dt(i){return Zi.has(J(i))}var Qi=[":popover-open",":modal"];function ge(i){return Qi.some(e=>{try{return i.matches(e)}catch(t){return!1}})}var Gi=["transform","translate","scale","rotate","perspective"],Ji=["transform","translate","scale","rotate","perspective","filter"],Xi=["paint","layout","strict","content"];function De(i){let e=je(),t=H(i)?M(i):i;return Gi.some(n=>t[n]?t[n]!=="none":!1)||(t.containerType?t.containerType!=="normal":!1)||!e&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!e&&(t.filter?t.filter!=="none":!1)||Ji.some(n=>(t.willChange||"").includes(n))||Xi.some(n=>(t.contain||"").includes(n))}function jt(i){let e=j(i);for(;$(e)&&!X(e);){if(De(e))return e;if(ge(e))return null;e=j(e)}return null}function je(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Yi=new Set(["html","body","#document"]);function X(i){return Yi.has(J(i))}function M(i){return C(i).getComputedStyle(i)}function ve(i){return H(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function j(i){if(J(i)==="html")return i;let e=i.assignedSlot||i.parentNode||zt(i)&&i.host||F(i);return zt(e)?e.host:e}function Vt(i){let e=j(i);return X(e)?i.ownerDocument?i.ownerDocument.body:i.body:$(e)&&ie(e)?e:Vt(e)}function ze(i,e,t){var n;e===void 0&&(e=[]),t===void 0&&(t=!0);let o=Vt(i),r=o===((n=i.ownerDocument)==null?void 0:n.body),s=C(o);if(r){let a=Ve(s);return e.concat(s,s.visualViewport||[],ie(o)?o:[],a&&t?ze(a):[])}return e.concat(o,ze(o,[],t))}function Ve(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function Kt(i){let e=M(i),t=parseFloat(e.width)||0,n=parseFloat(e.height)||0,o=$(i),r=o?i.offsetWidth:t,s=o?i.offsetHeight:n,a=ue(t)!==r||ue(n)!==s;return a&&(t=r,n=s),{width:t,height:n,$:a}}function Zt(i){return H(i)?i:i.contextElement}function ne(i){let e=Zt(i);if(!$(e))return P(1);let t=e.getBoundingClientRect(),{width:n,height:o,$:r}=Kt(e),s=(r?ue(t.width):t.width)/n,a=(r?ue(t.height):t.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var en=P(0);function Qt(i){let e=C(i);return!je()||!e.visualViewport?en:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function tn(i,e,t){return e===void 0&&(e=!1),!t||e&&t!==C(i)?!1:e}function ye(i,e,t,n){e===void 0&&(e=!1),t===void 0&&(t=!1);let o=i.getBoundingClientRect(),r=Zt(i),s=P(1);e&&(n?H(n)&&(s=ne(n)):s=ne(i));let a=tn(r,t,n)?Qt(r):P(0),l=(o.left+a.x)/s.x,c=(o.top+a.y)/s.y,p=o.width/s.x,d=o.height/s.y;if(r){let h=C(r),u=n&&H(n)?C(n):n,f=h,m=Ve(f);for(;m&&n&&u!==f;){let v=ne(m),y=m.getBoundingClientRect(),w=M(m),b=y.left+(m.clientLeft+parseFloat(w.paddingLeft))*v.x,S=y.top+(m.clientTop+parseFloat(w.paddingTop))*v.y;l*=v.x,c*=v.y,p*=v.x,d*=v.y,l+=b,c+=S,f=C(m),m=Ve(f)}}return G({width:p,height:d,x:l,y:c})}function Ue(i,e){let t=ve(i).scrollLeft;return e?e.left+t:ye(F(i)).left+t}function Gt(i,e){let t=i.getBoundingClientRect(),n=t.left+e.scrollLeft-Ue(i,t),o=t.top+e.scrollTop;return{x:n,y:o}}function nn(i){let{elements:e,rect:t,offsetParent:n,strategy:o}=i,r=o==="fixed",s=F(n),a=e?ge(e.floating):!1;if(n===s||a&&r)return t;let l={scrollLeft:0,scrollTop:0},c=P(1),p=P(0),d=$(n);if((d||!d&&!r)&&((J(n)!=="body"||ie(s))&&(l=ve(n)),$(n))){let u=ye(n);c=ne(n),p.x=u.x+n.clientLeft,p.y=u.y+n.clientTop}let h=s&&!d&&!r?Gt(s,l):P(0);return{width:t.width*c.x,height:t.height*c.y,x:t.x*c.x-l.scrollLeft*c.x+p.x+h.x,y:t.y*c.y-l.scrollTop*c.y+p.y+h.y}}function on(i){return Array.from(i.getClientRects())}function rn(i){let e=F(i),t=ve(i),n=i.ownerDocument.body,o=U(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=U(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),s=-t.scrollLeft+Ue(i),a=-t.scrollTop;return M(n).direction==="rtl"&&(s+=U(e.clientWidth,n.clientWidth)-o),{width:o,height:r,x:s,y:a}}var Ut=25;function sn(i,e){let t=C(i),n=F(i),o=t.visualViewport,r=n.clientWidth,s=n.clientHeight,a=0,l=0;if(o){r=o.width,s=o.height;let p=je();(!p||p&&e==="fixed")&&(a=o.offsetLeft,l=o.offsetTop)}let c=Ue(n);if(c<=0){let p=n.ownerDocument,d=p.body,h=getComputedStyle(d),u=p.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,f=Math.abs(n.clientWidth-d.clientWidth-u);f<=Ut&&(r-=f)}else c<=Ut&&(r+=c);return{width:r,height:s,x:a,y:l}}var an=new Set(["absolute","fixed"]);function ln(i,e){let t=ye(i,!0,e==="fixed"),n=t.top+i.clientTop,o=t.left+i.clientLeft,r=$(i)?ne(i):P(1),s=i.clientWidth*r.x,a=i.clientHeight*r.y,l=o*r.x,c=n*r.y;return{width:s,height:a,x:l,y:c}}function Wt(i,e,t){let n;if(e==="viewport")n=sn(i,t);else if(e==="document")n=rn(F(i));else if(H(e))n=ln(e,t);else{let o=Qt(i);n={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return G(n)}function Jt(i,e){let t=j(i);return t===e||!H(t)||X(t)?!1:M(t).position==="fixed"||Jt(t,e)}function cn(i,e){let t=e.get(i);if(t)return t;let n=ze(i,[],!1).filter(a=>H(a)&&J(a)!=="body"),o=null,r=M(i).position==="fixed",s=r?j(i):i;for(;H(s)&&!X(s);){let a=M(s),l=De(s);!l&&a.position==="fixed"&&(o=null),(r?!l&&!o:!l&&a.position==="static"&&!!o&&an.has(o.position)||ie(s)&&!l&&Jt(i,s))?n=n.filter(p=>p!==s):o=a,s=j(s)}return e.set(i,n),n}function pn(i){let{element:e,boundary:t,rootBoundary:n,strategy:o}=i,s=[...t==="clippingAncestors"?ge(e)?[]:cn(e,this._c):[].concat(t),n],a=s[0],l=s.reduce((c,p)=>{let d=Wt(e,p,o);return c.top=U(d.top,c.top),c.right=he(d.right,c.right),c.bottom=he(d.bottom,c.bottom),c.left=U(d.left,c.left),c},Wt(e,a,o));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function dn(i){let{width:e,height:t}=Kt(i);return{width:e,height:t}}function hn(i,e,t){let n=$(e),o=F(e),r=t==="fixed",s=ye(i,!0,r,e),a={scrollLeft:0,scrollTop:0},l=P(0);function c(){l.x=Ue(o)}if(n||!n&&!r)if((J(e)!=="body"||ie(o))&&(a=ve(e)),n){let u=ye(e,!0,r,e);l.x=u.x+e.clientLeft,l.y=u.y+e.clientTop}else o&&c();r&&!n&&o&&c();let p=o&&!n&&!r?Gt(o,a):P(0),d=s.left+a.scrollLeft-l.x-p.x,h=s.top+a.scrollTop-l.y-p.y;return{x:d,y:h,width:s.width,height:s.height}}function nt(i){return M(i).position==="static"}function qt(i,e){if(!$(i)||M(i).position==="fixed")return null;if(e)return e(i);let t=i.offsetParent;return F(i)===t&&(t=t.ownerDocument.body),t}function Xt(i,e){let t=C(i);if(ge(i))return t;if(!$(i)){let o=j(i);for(;o&&!X(o);){if(H(o)&&!nt(o))return o;o=j(o)}return t}let n=qt(i,e);for(;n&&Dt(n)&&nt(n);)n=qt(n,e);return n&&X(n)&&nt(n)&&!De(n)?t:n||jt(i)||t}var un=async function(i){let e=this.getOffsetParent||Xt,t=this.getDimensions,n=await t(i.floating);return{reference:hn(i.reference,await e(i.floating),i.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function fn(i){return M(i).direction==="rtl"}var mn={convertOffsetParentRelativeRectToViewportRelativeRect:nn,getDocumentElement:F,getClippingRect:pn,getOffsetParent:Xt,getElementRects:un,getClientRects:on,getDimensions:dn,getScale:ne,isElement:H,isRTL:fn};var Yt=Bt;var ei=Ft,ti=Rt;var ii=(i,e,t)=>{let n=new Map,o={platform:mn,...t},r={...o.platform,_c:n};return It(i,e,{...o,platform:r})};var We=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
...
`),n=e.length,o=e.split(/\s+/).filter(p=>p.length>0).length,r=this._editor.textarea.selectionStart,a=e.substring(0,r).split(`
`),l=a.length,c=a[a.length-1].length+1;return{characters:n,words:o,lines:t.length,line:l,column:c}}isReady(){return this._initialized&&this._editor!==null}getEditor(){return this._editor}showToolbar(){this._editor&&this._editor.showToolbar()}hideToolbar(){this._editor&&this._editor.hideToolbar()}};customElements.get("overtype-editor")||customElements.define("overtype-editor",qe);var bn=qe;return _i(xn);})();
/**
