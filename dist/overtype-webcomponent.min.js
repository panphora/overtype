...
`),processed:i}}function re(n,e){return e?"- ":`${n+1}. `}function Cn(n,e){let t,i,o;return n.orderedList?(t=Ye(e),i=et(t.text),o=i.text):(t=et(e),i=Ye(t.text),o=i.text),[t,i,o]}function An(n,e){let t=n.selectionStart===n.selectionEnd,i=n.selectionStart,o=n.selectionEnd;nt(n);let r=n.value.slice(n.selectionStart,n.selectionEnd),[s,a,c]=Cn(e,r),d=c.split(`
`).map((m,g)=>`${re(g,e.unorderedList)}${m}`),l=d.reduce((m,g,y)=>m+re(y,e.unorderedList).length,0),p=d.reduce((m,g,y)=>m+re(y,!e.unorderedList).length,0);if(s.processed)return t?(i=Math.max(i-re(0,e.unorderedList).length,0),o=i):(i=n.selectionStart,o=n.selectionEnd-l),{text:c,selectionStart:i,selectionEnd:o};let{newlinesToAppend:u,newlinesToPrepend:h}=Re(n),f=u+d.join(`
`)+h;return t?(i=Math.max(i+re(0,e.unorderedList).length+u.length,0),o=i):a.processed?(i=Math.max(n.selectionStart+u.length,0),o=n.selectionEnd+u.length+l-p):(i=Math.max(n.selectionStart+u.length,0),o=n.selectionEnd+u.length+l),{text:f,selectionStart:i,selectionEnd:o}}function ot(n,e){let t=xe(n,i=>An(i,e),{adjustSelection:(i,o,r,s)=>{let a=n.value.slice(s,n.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),u=e.orderedList&&l||e.unorderedList&&p;if(o===r)if(u){let h=a.match(e.orderedList?c:d),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(l||p){let h=a.match(l?c:d),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:o+h}}else if(u){let h=a.match(e.orderedList?c:d),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(l||p){let h=a.match(l?c:d),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:r+h}}}});j(n,t)}function _n(n){if(!n)return[];let e=[],{selectionStart:t,selectionEnd:i,value:o}=n,r=o.split(`
