...
`),i){let{newlinesToAppend:l,newlinesToPrepend:p}=X(o);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function he(o){let e=o.split(`
`),t=/^\d+\.\s+/,n=e.every(r=>t.test(r)),i=e;return n&&(i=e.map(r=>r.replace(t,""))),{text:i.join(`
`),processed:n}}function ue(o){let e=o.split(`
`),t="- ",n=e.every(r=>r.startsWith(t)),i=e;return n&&(i=e.map(r=>r.slice(t.length))),{text:i.join(`
`),processed:n}}function O(o,e){return e?"- ":`${o+1}. `}function Xe(o,e){let t,n,i;return o.orderedList?(t=he(e),n=ue(t.text),i=n.text):(t=ue(e),n=he(t.text),i=n.text),[t,n,i]}function Ye(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;fe(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,a,c]=Xe(e,r),d=c.split(`
`).map((m,g)=>`${O(g,e.unorderedList)}${m}`),l=d.reduce((m,g,v)=>m+O(v,e.unorderedList).length,0),p=d.reduce((m,g,v)=>m+O(v,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-O(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-l),{text:c,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=X(o),f=h+d.join(`
`)+u;return t?(n=Math.max(n+O(0,e.unorderedList).length+h.length,0),i=n):a.processed?(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+l-p):(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+l),{text:f,selectionStart:n,selectionEnd:i}}function ve(o,e){let t=W(o,n=>Ye(n,e),{adjustSelection:(n,i,r,s)=>{let a=o.value.slice(s,o.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),h=e.orderedList&&l||e.unorderedList&&p;if(i===r)if(h){let u=a.match(e.orderedList?c:d),f=u?u[0].length:0;return{start:Math.max(i-f,s),end:Math.max(i-f,s)}}else if(l||p){let u=a.match(l?c:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:i+g,end:i+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=a.match(e.orderedList?c:d),f=u?u[0].length:0;return{start:Math.max(i-f,s),end:Math.max(r-f,s)}}else if(l||p){let u=a.match(l?c:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:i+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});M(o,t)}function et(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),s=0,a="";for(let p of r){if(t>=s&&t<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let c=Math.max(0,t-10),d=Math.min(i.length,n+10),l=i.slice(c,d);if(l.includes("**")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(l.includes("_")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(l.includes("`")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&i.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function P(o){if(!o||o.disabled||o.readOnly)return;y("toggleBold","Starting"),q(o,"Before");let e=_(L.bold),t=K(o,e);me(t),M(o,t),q(o,"After")}function z(o){if(!o||o.disabled||o.readOnly)return;let e=_(L.italic),t=K(o,e);M(o,t)}function Y(o){if(!o||o.disabled||o.readOnly)return;let e=_(L.code),t=K(o,e);M(o,t)}function N(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=_(L.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=o.selectionStart;o.value=o.value.slice(0,s)+e.text+o.value.slice(s),o.selectionStart=s,o.selectionEnd=s+e.text.length}let r=K(o,n);M(o,r)}function R(o){if(!o||o.disabled||o.readOnly)return;let e=_(L.bulletList);ve(o,e)}function j(o){if(!o||o.disabled||o.readOnly)return;let e=_(L.numberedList);ve(o,e)}function ee(o){if(!o||o.disabled||o.readOnly)return;y("toggleQuote","Starting"),q(o,"Initial");let e=_(L.quote),t=W(o,n=>ge(n,e),{prefix:e.prefix});me(t),M(o,t),q(o,"Final")}function ye(o){if(!o||o.disabled||o.readOnly)return;let e=_(L.taskList),t=W(o,n=>ge(n,e),{prefix:e.prefix});M(o,t)}function te(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),y("insertHeader","============ START ============"),y("insertHeader",`Level: ${e}, Toggle: ${t}`),y("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=_(L[n]||L.header1);y("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,s=o.selectionStart,a=o.selectionEnd,c=s;for(;c>0&&r[c-1]!==`
`;)c--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(c,d);y("insertHeader",`Current line (before): "${l}"`);let p=l.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;y("insertHeader","Existing header check:"),y("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),y("insertHeader",`  - Existing level: ${h}`),y("insertHeader",`  - Existing prefix length: ${u}`),y("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;y("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let m=W(o,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);y("insertHeader",`Line in operation: "${v}"`);let b=v.replace(/^#{1,6}\s*/,"");y("insertHeader",`Cleaned line: "${b}"`);let k;return f?(y("insertHeader","ACTION: Toggling OFF - removing header"),k=b):h>0?(y("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=i.prefix+b):(y("insertHeader","ACTION: Adding new header"),k=i.prefix+b),y("insertHeader",`New line: "${k}"`),{text:k,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:i.prefix,adjustSelection:(g,v,b,k)=>{if(y("insertHeader","Adjusting selection:"),y("insertHeader",`  - isRemoving param: ${g}`),y("insertHeader",`  - shouldToggleOff: ${f}`),y("insertHeader",`  - selStart: ${v}, selEnd: ${b}`),y("insertHeader",`  - lineStartPos: ${k}`),f){let H=Math.max(v-u,k);return y("insertHeader",`  - Removing header, adjusting by -${u}`),{start:H,end:v===b?H:Math.max(b-u,k)}}else if(u>0){let H=i.prefix.length-u;return y("insertHeader",`  - Replacing header, adjusting by ${H}`),{start:v+H,end:b+H}}else return y("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:v+i.prefix.length,end:b+i.prefix.length}}});y("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),y("insertHeader","============ END ============"),M(o,m)}function ne(o){te(o,1,!0)}function ie(o){te(o,2,!0)}function oe(o){te(o,3,!0)}function be(o){return et(o)}var F=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":P(t);break;case"toggleItalic":z(t);break;case"insertLink":N(t);break;case"toggleBulletList":R(t);break;case"toggleNumberedList":j(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var $={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},we={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ke={solar:$,cave:we,light:$,dark:we};function A(o){return typeof o=="string"?{...ke[o]||ke.solar,name:o}:o}function I(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
`)}function xe(o,e={}){return{...o,colors:{...o.colors,...e}}}function Z(o={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:s={}}=o,a=Object.keys(s).length>0?`
  ...
  `:"",c=r&&r.colors?I(r.colors):"";return`
...
</svg>`;var Be=`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" fill="none"></path>
  <circle cx="12" cy="12" r="3" fill="none"></circle>
</svg>`;var Ie=["bold","italic","strikethrough","code","link","h1","h2","h3","bulletList","orderedList","quote","viewMode"],J=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.buttonConfig=t.buttonConfig||null,this.customButtons=t.customToolbarButtons||[],this.hideButtons=t.hideButtons||[],this.buttonOrder=t.buttonOrder||null,this.buttonRegistry=this.buildButtonRegistry()}buildButtonRegistry(){let e=new Map;return this.customButtons.forEach(t=>{Ie.includes(t.name)&&(console.warn(`Custom button "${t.name}" conflicts with built-in button. Using "custom-${t.name}" instead.`),t.name=`custom-${t.name}`)}),Ie.forEach(t=>{this.hideButtons.includes(t)||e.set(t,{type:"builtin",name:t,...this.getBuiltinButtonConfig(t)})}),this.customButtons.forEach(t=>{e.set(t.name,{type:"custom",...t})}),e}getBuiltinButtonConfig(e){return{bold:{icon:Se,title:"Bold (Ctrl+B)",action:n=>{P(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},italic:{icon:Le,title:"Italic (Ctrl+I)",action:n=>{z(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},strikethrough:{icon:void 0||'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 4H9a3 3 0 0 0 0 6h11a3 3 0 0 0 0-6h-1M8 20h7M4 12h16"/></svg>',title:"Strikethrough",action:n=>{void 0&&(void 0)(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},code:{icon:Ae,title:"Code (Ctrl+`)",action:n=>{Y(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},link:{icon:_e,title:"Insert Link (Ctrl+K)",action:n=>{N(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},h1:{icon:Ee,title:"Heading 1",action:n=>{ne(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},h2:{icon:Ce,title:"Heading 2",action:n=>{ie(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},h3:{icon:Te,title:"Heading 3",action:n=>{oe(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},bulletList:{icon:He,title:"Bullet List",action:n=>{R(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},orderedList:{icon:Me,title:"Numbered List",action:n=>{j(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},quote:{icon:$e,title:"Quote",action:n=>{ee(n.textarea),n.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}},viewMode:{icon:Be,title:"View mode",type:"dropdown",dropdownItems:[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],action:(n,i)=>{switch(i.id){case"plain":n.showPlainTextarea();break;case"preview":n.showPreviewMode();break;case"normal":default:n.showNormalEditMode();break}}}}[e]||{}}sanitizeSVG(e){if(typeof e!="string")throw new Error("Icon must be a string");let t=e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/on\w+\s*=\s*"[^"]*"/gi,"").replace(/on\w+\s*=\s*'[^']*'/gi,"").replace(/javascript:/gi,"").replace(/data:text\/html/gi,"");return t.trim().startsWith("<svg")||console.warn("Icon should start with <svg> tag"),t}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Text formatting"),this.buttonConfig?this.createOldStyleButtons(this.buttonConfig):(this.getButtonsToCreate().forEach(i=>{let r=this.createButton(i);this.buttons[i.name]=r,this.positionButton(r,i)}),this.initializeCustomButtonStates());let e=this.editor.element.querySelector(".overtype-container"),t=this.editor.element.querySelector(".overtype-wrapper");return e&&t&&e.insertBefore(this.container,t),this.container}createOldStyleButtons(e){e.forEach(t=>{if(t.separator){let n=document.createElement("div");n.className="overtype-toolbar-separator",n.setAttribute("role","separator"),this.container.appendChild(n)}else{let n=this.createOldStyleButton(t);this.buttons[t.name]=n,this.container.appendChild(n)}})}createOldStyleButton(e){let t=document.createElement("button");return t.className="overtype-toolbar-button",t.type="button",t.title=e.title,t.setAttribute("aria-label",e.title),t.setAttribute("data-action",e.action),t.setAttribute("data-button",e.name),t.innerHTML=e.icon,e.hasDropdown&&(t.classList.add("has-dropdown"),e.name==="viewMode"&&(this.viewModeButton=t)),t.addEventListener("click",n=>{n.preventDefault(),this.handleOldAction(e.action,t)}),t}async handleOldAction(e,t){let n=this.editor.textarea;if(n){if(e==="toggle-view-menu"){this.toggleViewDropdown(t);return}n.focus();try{switch(e){case"toggleBold":P(n);break;case"toggleItalic":z(n);break;case"insertH1":ne(n);break;case"insertH2":ie(n);break;case"insertH3":oe(n);break;case"insertLink":N(n);break;case"toggleCode":Y(n);break;case"toggleBulletList":R(n);break;case"toggleNumberedList":j(n);break;case"toggleQuote":ee(n);break;case"toggleTaskList":ye(n);break}n.dispatchEvent(new Event("input",{bubbles:!0}))}catch(i){console.error("Error loading markdown-actions:",i)}}}toggleViewDropdown(e){let t={name:"viewMode",type:"dropdown",dropdownItems:[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],action:(n,i)=>{switch(i.id){case"plain":n.showPlainTextarea();break;case"preview":n.showPreviewMode();break;case"normal":default:n.showNormalEditMode();break}}};this.toggleDropdown(e,t)}getButtonsToCreate(){if(this.buttonOrder){let e=[];return this.buttonOrder.forEach(t=>{let n=this.buttonRegistry.get(t);n?e.push(n):console.warn(`Button "${t}" in buttonOrder not found in registry`)}),this.buttonRegistry.forEach((t,n)=>{this.buttonOrder.includes(n)||e.push(t)}),e}else return Array.from(this.buttonRegistry.values())}createButton(e){let t=document.createElement("button");t.className="overtype-toolbar-button",t.type="button",t.setAttribute("data-button",e.name),t.title=e.title,t.setAttribute("aria-label",e.title),e.type==="custom"?(t.innerHTML=this.sanitizeSVG(e.icon),t.dataset.custom="true"):(t.innerHTML=e.icon,t.dataset.builtin="true"),(e.type==="dropdown"||e.dropdownItems)&&(t.classList.add("has-dropdown"),t.dataset.dropdown="true");let n=i=>{if(i.preventDefault(),e.type==="dropdown"||e.dropdownItems){this.toggleDropdown(t,e);return}this.editor.textarea&&this.editor.textarea.focus();try{e.type==="custom"?e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:r=>this.editor.setValue(r),event:i}):e.action(this.editor)}catch(r){console.error(`Button "${e.name}" error:`,r),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:r}})),t.classList.add("error"),setTimeout(()=>t.classList.remove("error"),300)}};return t.addEventListener("click",n),t._clickHandler=n,typeof e.isEnabled=="function"&&(t._isEnabled=e.isEnabled,t._buttonConfig=e),t}positionButton(e,t){if(!t.position||t.position==="end")this.container.appendChild(e);else if(t.position==="start")this.container.insertBefore(e,this.container.firstChild);else if(t.position.startsWith("after:")){let n=t.position.substring(6),i=this.container.querySelector(`[data-button="${n}"]`);i&&i.nextSibling?this.container.insertBefore(e,i.nextSibling):i?this.container.appendChild(e):(console.warn(`Position target "${n}" not found, appending to end`),this.container.appendChild(e))}else this.container.appendChild(e)}toggleDropdown(e,t){var s;let n=document.querySelector(".overtype-dropdown-menu");if(n&&(n.remove(),(s=document.querySelector(".dropdown-active"))==null||s.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)),e.classList.contains("dropdown-active")){e.classList.remove("dropdown-active");return}let i=this.createDropdown(e,t),r=e.getBoundingClientRect();i.style.top=`${r.bottom+4}px`,i.style.left=`${r.left}px`,document.body.appendChild(i),e.classList.add("dropdown-active"),this.handleDocumentClick=a=>{!e.contains(a.target)&&!i.contains(a.target)&&(i.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createDropdown(e,t){let n=document.createElement("div");n.className="overtype-dropdown-menu";let i=t.dropdownItems||[];if(t.name==="viewMode"){let r=this.editor.container.dataset.mode||"normal";i.forEach(s=>{let a=document.createElement("button");a.className="overtype-dropdown-item",a.type="button";let c=document.createElement("span");c.className="overtype-dropdown-check",c.textContent=r===s.id?s.icon:"";let d=document.createElement("span");d.textContent=s.label,a.appendChild(c),a.appendChild(d),r===s.id&&a.classList.add("active"),a.addEventListener("click",l=>{l.stopPropagation(),t.action(this.editor,s),n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),n.appendChild(a)})}else i.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",r.icon){let c=document.createElement("span");c.className="overtype-dropdown-icon",c.textContent=r.icon,s.appendChild(c)}let a=document.createElement("span");a.textContent=r.label,s.appendChild(a),s.addEventListener("click",c=>{var d;c.stopPropagation();try{t.type==="custom"?t.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:l=>this.editor.setValue(l),item:r,event:c}):t.action(this.editor,r)}catch(l){console.error(`Dropdown item "${r.id}" error:`,l),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:t.name,item:r,error:l}}))}n.remove(),(d=document.querySelector(".dropdown-active"))==null||d.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),n.appendChild(s)});return n}updateButtonState(e){if(e._isEnabled&&e._buttonConfig){let t=e._isEnabled(this.editor);e.disabled=!t,e.classList.toggle("disabled",!t)}}initializeCustomButtonStates(){var e;this.updateCustomButtonStates=this.debounce(()=>{Object.values(this.buttons).forEach(t=>{t.dataset.custom==="true"&&this.updateButtonState(t)})},100),(e=this.editor.textarea)==null||e.addEventListener("input",()=>{this.updateCustomButtonStates()})}debounce(e,t){let n,i=function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)};return i.cancel=()=>clearTimeout(n),i}async updateButtonStates(){let e=this.editor.textarea;if(e){try{let t=be(e);Object.entries(this.buttons).forEach(([n,i])=>{if(i.dataset.builtin!=="true")return;let r=!1;switch(n){case"bold":r=t.includes("bold");break;case"italic":r=t.includes("italic");break;case"code":r=!1;break;case"bulletList":r=t.includes("bullet-list");break;case"orderedList":r=t.includes("numbered-list");break;case"quote":r=t.includes("quote");break;case"h1":r=t.includes("header");break;case"h2":r=t.includes("header-2");break;case"h3":r=t.includes("header-3");break}i.classList.toggle("active",r),i.setAttribute("aria-pressed",r.toString())})}catch(t){}this.updateCustomButtonStates&&this.updateCustomButtonStates()}}destroy(){var e;this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(t=>{t._clickHandler&&(t.removeEventListener("click",t._clickHandler),delete t._clickHandler),t._isEnabled&&delete t._isEnabled,t._buttonConfig&&delete t._buttonConfig}),(e=this.updateCustomButtonStates)!=null&&e.cancel&&this.updateCustomButtonStates.cancel(),this.container.remove(),this.container=null,this.buttons={},this.buttonRegistry.clear())}};var G=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.init()}init(){typeof CSS<"u"&&CSS.supports&&CSS.supports("position-anchor: --x")&&CSS.supports("position-area: center")&&(this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",t=>{(t.key.includes("Arrow")||t.key==="Home"||t.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>this.hide()),this.tooltip.addEventListener("mouseenter",()=>this.cancelHide()),this.tooltip.addEventListener("mouseleave",()=>this.scheduleHide()))}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip";let e=document.createElement("style");e.textContent=`
