...
`;)d++;i.selectionStart=a,i.selectionEnd=d}else it(i);let c=e(i);if(t.adjustSelection){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(l,n,o,a);c.selectionStart=p.start,c.selectionEnd=p.end}else if(t.prefix){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=c.selectionStart):(c.selectionStart=n+t.prefix.length,c.selectionEnd=c.selectionStart):l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=Math.max(o-t.prefix.length,a)):(c.selectionStart=n+t.prefix.length,c.selectionEnd=o+t.prefix.length)}return c}function ke(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:c,prefixSpace:d,scanFor:l,surroundWithNewlines:p,trimFirst:u}=e,h=i.selectionStart,f=i.selectionEnd,m=i.value.slice(i.selectionStart,i.selectionEnd),g=Xe(m)&&s&&s.length>0?`${s}
`:o,v=Xe(m)&&a&&a.length>0?`
${a}`:r;if(d){let k=i.value[i.selectionStart-1];i.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(g=` ${g}`)}m=Li(i,g,v,e.multiline);let b=i.selectionStart,w=i.selectionEnd,S=c&&c.length>0&&v.indexOf(c)>-1&&m.length>0;if(p){let k=Re(i);t=k.newlinesToAppend,n=k.newlinesToPrepend,g=t+o,v+=n}if(m.startsWith(g)&&m.endsWith(v)){let k=m.slice(g.length,m.length-v.length);if(h===f){let L=h-g.length;L=Math.max(L,b),L=Math.min(L,b+k.length),b=w=L}else w=b+k.length;return{text:k,selectionStart:b,selectionEnd:w}}else if(S)if(l&&l.length>0&&m.match(l)){v=v.replace(c,m);let k=g+v;return b=w=b+g.length,{text:k,selectionStart:b,selectionEnd:w}}else{let k=g+m+v;return b=b+g.length+m.length+v.indexOf(c),w=b+c.length,{text:k,selectionStart:b,selectionEnd:w}}else{let k=g+m+v;b=h+g.length,w=f+g.length;let L=m.match(/^\s*|\s*$/g);if(u&&L){let me=L[0]||"",Y=L[1]||"";k=me+g+m.trim()+v+Y,b+=me.length,w-=Y.length}return{text:k,selectionStart:b,selectionEnd:w}}}function nt(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,c=r.split(`
...
`),o){let{newlinesToAppend:l,newlinesToPrepend:p}=Re(i);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function Ye(i){let e=i.split(`
`),t=/^\d+\.\s+/,n=e.every(r=>t.test(r)),o=e;return n&&(o=e.map(r=>r.replace(t,""))),{text:o.join(`
`),processed:n}}function et(i){let e=i.split(`
`),t="- ",n=e.every(r=>r.startsWith(t)),o=e;return n&&(o=e.map(r=>r.slice(t.length))),{text:o.join(`
`),processed:n}}function re(i,e){return e?"- ":`${i+1}. `}function Ei(i,e){let t,n,o;return i.orderedList?(t=Ye(e),n=et(t.text),o=n.text):(t=et(e),n=Ye(t.text),o=n.text),[t,n,o]}function Ti(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;it(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,c]=Ei(e,r),d=c.split(`
`).map((m,g)=>`${re(g,e.unorderedList)}${m}`),l=d.reduce((m,g,v)=>m+re(v,e.unorderedList).length,0),p=d.reduce((m,g,v)=>m+re(v,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-re(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-l),{text:c,selectionStart:n,selectionEnd:o};let{newlinesToAppend:u,newlinesToPrepend:h}=Re(i),f=u+d.join(`
`)+h;return t?(n=Math.max(n+re(0,e.unorderedList).length+u.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+u.length,0),o=i.selectionEnd+u.length+l-p):(n=Math.max(i.selectionStart+u.length,0),o=i.selectionEnd+u.length+l),{text:f,selectionStart:n,selectionEnd:o}}function ot(i,e){let t=xe(i,n=>Ti(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),u=e.orderedList&&l||e.unorderedList&&p;if(o===r)if(u){let h=a.match(e.orderedList?c:d),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(l||p){let h=a.match(l?c:d),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:o+h}}else if(u){let h=a.match(e.orderedList?c:d),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(l||p){let h=a.match(l?c:d),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:r+h}}}});j(i,t)}function _i(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let p of r){if(t>=s&&t<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let c=Math.max(0,t-10),d=Math.min(o.length,n+10),l=o.slice(c,d);if(l.includes("**")){let p=o.slice(Math.max(0,t-100),t),u=o.slice(n,Math.min(o.length,n+100)),h=p.lastIndexOf("**"),f=u.indexOf("**");h!==-1&&f!==-1&&e.push("bold")}if(l.includes("_")){let p=o.slice(Math.max(0,t-100),t),u=o.slice(n,Math.min(o.length,n+100)),h=p.lastIndexOf("_"),f=u.indexOf("_");h!==-1&&f!==-1&&e.push("italic")}if(l.includes("`")){let p=o.slice(Math.max(0,t-100),t),u=o.slice(n,Math.min(o.length,n+100));p.includes("`")&&u.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let p=o.slice(Math.max(0,t-100),t),u=o.slice(n,Math.min(o.length,n+100)),h=p.lastIndexOf("["),f=u.indexOf("]");h!==-1&&f!==-1&&o.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function rt(i){if(!i||i.disabled||i.readOnly)return;x("toggleBold","Starting"),be(i,"Before");let e=F(R.bold),t=ke(i,e);tt(t),j(i,t),be(i,"After")}function st(i){if(!i||i.disabled||i.readOnly)return;let e=F(R.italic),t=ke(i,e);j(i,t)}function at(i){if(!i||i.disabled||i.readOnly)return;let e=F(R.code),t=ke(i,e);j(i,t)}function lt(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=F(R.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=ke(i,n);j(i,r)}function ct(i){if(!i||i.disabled||i.readOnly)return;let e=F(R.bulletList);ot(i,e)}function pt(i){if(!i||i.disabled||i.readOnly)return;let e=F(R.numberedList);ot(i,e)}function dt(i){if(!i||i.disabled||i.readOnly)return;x("toggleQuote","Starting"),be(i,"Initial");let e=F(R.quote),t=xe(i,n=>nt(n,e),{prefix:e.prefix});tt(t),j(i,t),be(i,"Final")}function Ie(i){if(!i||i.disabled||i.readOnly)return;let e=F(R.taskList),t=xe(i,n=>nt(n,e),{prefix:e.prefix});j(i,t)}function Be(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${t}`),x("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=F(R[n]||R.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,c=s;for(;c>0&&r[c-1]!==`
`;)c--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(c,d);x("insertHeader",`Current line (before): "${l}"`);let p=l.match(/^(#{1,6})\s*/),u=p?p[1].length:0,h=p?p[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${u}`),x("insertHeader",`  - Existing prefix length: ${h}`),x("insertHeader",`  - Target level: ${e}`);let f=t&&u===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${u}, level=${e})`);let m=xe(i,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);x("insertHeader",`Line in operation: "${v}"`);let b=v.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${b}"`);let w;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),w=b):u>0?(x("insertHeader",`ACTION: Replacing H${u} with H${e}`),w=o.prefix+b):(x("insertHeader","ACTION: Adding new header"),w=o.prefix+b),x("insertHeader",`New line: "${w}"`),{text:w,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,v,b,w)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${g}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${v}, selEnd: ${b}`),x("insertHeader",`  - lineStartPos: ${w}`),f){let S=Math.max(v-h,w);return x("insertHeader",`  - Removing header, adjusting by -${h}`),{start:S,end:v===b?S:Math.max(b-h,w)}}else if(h>0){let S=o.prefix.length-h;return x("insertHeader",`  - Replacing header, adjusting by ${S}`),{start:v+S,end:b+S}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:v+o.prefix.length,end:b+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),j(i,m)}function ht(i){Be(i,1,!0)}function ut(i){Be(i,2,!0)}function ft(i){Be(i,3,!0)}function mt(i){return _i(i)}var Se=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let t=this.createSeparator();this.container.appendChild(t)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let t=document.createElement("button");return t.className="overtype-toolbar-button",t.type="button",t.setAttribute("data-button",e.name),t.title=e.title||"",t.setAttribute("aria-label",e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(t.classList.add("has-dropdown"),t.dataset.dropdown="true",t.addEventListener("click",n=>{n.preventDefault(),this.toggleViewModeDropdown(t)}),t):(t._clickHandler=n=>{n.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,n)},t.addEventListener("click",t._clickHandler),t)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:t=>this.editor.setValue(t),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:t}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){let t=document.querySelector(".overtype-dropdown-menu");if(t){t.remove(),e.classList.remove("dropdown-active");return}e.classList.add("dropdown-active");let n=this.createViewModeDropdown(e),o=e.getBoundingClientRect();n.style.position="absolute",n.style.top=`${o.bottom+5}px`,n.style.left=`${o.left}px`,document.body.appendChild(n),this.handleDocumentClick=r=>{!n.contains(r.target)&&!e.contains(r.target)&&(n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createViewModeDropdown(e){let t=document.createElement("div");t.className="overtype-dropdown-menu";let n=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return n.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.textContent=r.label,r.id===o){s.classList.add("active"),s.setAttribute("aria-current","true");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}t.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),t.appendChild(s)}),t}updateButtonStates(){var e;try{let t=((e=mt)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([n,o])=>{if(n==="viewMode")return;let r=!1;switch(n){case"bold":r=t.includes("bold");break;case"italic":r=t.includes("italic");break;case"code":r=!1;break;case"bulletList":r=t.includes("bullet-list");break;case"orderedList":r=t.includes("numbered-list");break;case"taskList":r=t.includes("task-list");break;case"quote":r=t.includes("quote");break;case"h1":r=t.includes("header");break;case"h2":r=t.includes("header-2");break;case"h3":r=t.includes("header-3");break}o.classList.toggle("active",r),o.setAttribute("aria-pressed",r.toString())})}catch(t){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var ae=Math.min,U=Math.max,le=Math.round;var M=i=>({x:i,y:i}),Ci={left:"right",right:"left",bottom:"top",top:"bottom"},Ai={start:"end",end:"start"};function ze(i,e,t){return U(i,ae(e,t))}function ce(i,e){return typeof i=="function"?i(e):i}function W(i){return i.split("-")[0]}function pe(i){return i.split("-")[1]}function Fe(i){return i==="x"?"y":"x"}function Ne(i){return i==="y"?"height":"width"}var Hi=new Set(["top","bottom"]);function N(i){return Hi.has(W(i))?"y":"x"}function De(i){return Fe(N(i))}function bt(i,e,t){t===void 0&&(t=!1);let n=pe(i),o=De(i),r=Ne(o),s=o==="x"?n===(t?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=se(s)),[s,se(s)]}function wt(i){let e=se(i);return[Le(i),e,Le(e)]}function Le(i){return i.replace(/start|end/g,e=>Ai[e])}var vt=["left","right"],yt=["right","left"],Oi=["top","bottom"],Mi=["bottom","top"];function Pi(i,e,t){switch(i){case"top":case"bottom":return t?e?yt:vt:e?vt:yt;case"left":case"right":return e?Oi:Mi;default:return[]}}function xt(i,e,t,n){let o=pe(i),r=Pi(W(i),t==="start",n);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(Le)))),r}function se(i){return i.replace(/left|right|bottom|top/g,e=>Ci[e])}function $i(i){return{top:0,right:0,bottom:0,left:0,...i}}function kt(i){return typeof i!="number"?$i(i):{top:i,right:i,bottom:i,left:i}}function G(i){let{x:e,y:t,width:n,height:o}=i;return{width:n,height:o,top:t,left:e,right:e+n,bottom:t+o,x:e,y:t}}function St(i,e,t){let{reference:n,floating:o}=i,r=N(e),s=De(e),a=Ne(s),c=W(e),d=r==="y",l=n.x+n.width/2-o.width/2,p=n.y+n.height/2-o.height/2,u=n[a]/2-o[a]/2,h;switch(c){case"top":h={x:l,y:n.y-o.height};break;case"bottom":h={x:l,y:n.y+n.height};break;case"right":h={x:n.x+n.width,y:p};break;case"left":h={x:n.x-o.width,y:p};break;default:h={x:n.x,y:n.y}}switch(pe(e)){case"start":h[s]-=u*(t&&d?-1:1);break;case"end":h[s]+=u*(t&&d?-1:1);break}return h}async function Lt(i,e){var t;e===void 0&&(e={});let{x:n,y:o,platform:r,rects:s,elements:a,strategy:c}=i,{boundary:d="clippingAncestors",rootBoundary:l="viewport",elementContext:p="floating",altBoundary:u=!1,padding:h=0}=ce(e,i),f=kt(h),g=a[u?p==="floating"?"reference":"floating":p],v=G(await r.getClippingRect({element:(t=await(r.isElement==null?void 0:r.isElement(g)))==null||t?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:d,rootBoundary:l,strategy:c})),b=p==="floating"?{x:n,y:o,width:s.floating.width,height:s.floating.height}:s.reference,w=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(w))?await(r.getScale==null?void 0:r.getScale(w))||{x:1,y:1}:{x:1,y:1},k=G(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:b,offsetParent:w,strategy:c}):b);return{top:(v.top-k.top+f.top)/S.y,bottom:(k.bottom-v.bottom+f.bottom)/S.y,left:(v.left-k.left+f.left)/S.x,right:(k.right-v.right+f.right)/S.x}}var Et=async(i,e,t)=>{let{placement:n="bottom",strategy:o="absolute",middleware:r=[],platform:s}=t,a=r.filter(Boolean),c=await(s.isRTL==null?void 0:s.isRTL(e)),d=await s.getElementRects({reference:i,floating:e,strategy:o}),{x:l,y:p}=St(d,n,c),u=n,h={},f=0;for(let g=0;g<a.length;g++){var m;let{name:v,fn:b}=a[g],{x:w,y:S,data:k,reset:L}=await b({x:l,y:p,initialPlacement:n,placement:u,strategy:o,middlewareData:h,rects:d,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:Lt},elements:{reference:i,floating:e}});l=w!=null?w:l,p=S!=null?S:p,h={...h,[v]:{...h[v],...k}},L&&f<=50&&(f++,typeof L=="object"&&(L.placement&&(u=L.placement),L.rects&&(d=L.rects===!0?await s.getElementRects({reference:i,floating:e,strategy:o}):L.rects),{x:l,y:p}=St(d,u,c)),g=-1)}return{x:l,y:p,placement:u,strategy:o,middlewareData:h}};var Tt=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(e){var t,n;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:c,elements:d}=e,{mainAxis:l=!0,crossAxis:p=!0,fallbackPlacements:u,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=ce(i,e);if((t=r.arrow)!=null&&t.alignmentOffset)return{};let v=W(o),b=N(a),w=W(a)===a,S=await(c.isRTL==null?void 0:c.isRTL(d.floating)),k=u||(w||!m?[se(a)]:wt(a)),L=f!=="none";!u&&L&&k.push(...xt(a,m,f,S));let me=[a,...k],Y=await c.detectOverflow(e,g),ge=[],ee=((n=r.flip)==null?void 0:n.overflows)||[];if(l&&ge.push(Y[v]),p){let K=bt(o,s,S);ge.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:ge}],!ge.every(K=>K<=0)){var je,Ue;let K=(((je=r.flip)==null?void 0:je.index)||0)+1,Pe=me[K];if(Pe&&(!(p==="alignment"?b!==N(Pe):!1)||ee.every(O=>N(O.placement)===b?O.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:Pe}};let ne=(Ue=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,O)=>Z.overflows[1]-O.overflows[1])[0])==null?void 0:Ue.placement;if(!ne)switch(h){case"bestFit":{var We;let Z=(We=ee.filter(O=>{if(L){let V=N(O.placement);return V===b||V==="y"}return!0}).map(O=>[O.placement,O.overflows.filter(V=>V>0).reduce((V,ci)=>V+ci,0)]).sort((O,V)=>O[1]-V[1])[0])==null?void 0:We[0];Z&&(ne=Z);break}case"initialPlacement":ne=a;break}if(o!==ne)return{reset:{placement:ne}}}return{}}}};var Ri=new Set(["left","top"]);async function Ii(i,e){let{placement:t,platform:n,elements:o}=i,r=await(n.isRTL==null?void 0:n.isRTL(o.floating)),s=W(t),a=pe(t),c=N(t)==="y",d=Ri.has(s)?-1:1,l=r&&c?-1:1,p=ce(e,i),{mainAxis:u,crossAxis:h,alignmentAxis:f}=typeof p=="number"?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return a&&typeof f=="number"&&(h=a==="end"?f*-1:f),c?{x:h*l,y:u*d}:{x:u*d,y:h*l}}var _t=function(i){return i===void 0&&(i=0),{name:"offset",options:i,async fn(e){var t,n;let{x:o,y:r,placement:s,middlewareData:a}=e,c=await Ii(e,i);return s===((t=a.offset)==null?void 0:t.placement)&&(n=a.arrow)!=null&&n.alignmentOffset?{}:{x:o+c.x,y:r+c.y,data:{...c,placement:s}}}}},Ct=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(e){let{x:t,y:n,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:c={fn:v=>{let{x:b,y:w}=v;return{x:b,y:w}}},...d}=ce(i,e),l={x:t,y:n},p=await r.detectOverflow(e,d),u=N(W(o)),h=Fe(u),f=l[h],m=l[u];if(s){let v=h==="y"?"top":"left",b=h==="y"?"bottom":"right",w=f+p[v],S=f-p[b];f=ze(w,f,S)}if(a){let v=u==="y"?"top":"left",b=u==="y"?"bottom":"right",w=m+p[v],S=m-p[b];m=ze(w,m,S)}let g=c.fn({...e,[h]:f,[u]:m});return{...g,data:{x:g.x-t,y:g.y-n,enabled:{[h]:s,[u]:a}}}}}};function Te(){return typeof window<"u"}function J(i){return Ht(i)?(i.nodeName||"").toLowerCase():"#document"}function C(i){var e;return(i==null||(e=i.ownerDocument)==null?void 0:e.defaultView)||window}function I(i){var e;return(e=(Ht(i)?i.ownerDocument:i.document)||window.document)==null?void 0:e.documentElement}function Ht(i){return Te()?i instanceof Node||i instanceof C(i).Node:!1}function A(i){return Te()?i instanceof Element||i instanceof C(i).Element:!1}function P(i){return Te()?i instanceof HTMLElement||i instanceof C(i).HTMLElement:!1}function At(i){return!Te()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof C(i).ShadowRoot}var Bi=new Set(["inline","contents"]);function te(i){let{overflow:e,overflowX:t,overflowY:n,display:o}=H(i);return/auto|scroll|overlay|hidden|clip/.test(e+n+t)&&!Bi.has(o)}var zi=new Set(["table","td","th"]);function Ot(i){return zi.has(J(i))}var Fi=[":popover-open",":modal"];function de(i){return Fi.some(e=>{try{return i.matches(e)}catch(t){return!1}})}var Ni=["transform","translate","scale","rotate","perspective"],Di=["transform","translate","scale","rotate","perspective","filter"],Vi=["paint","layout","strict","content"];function _e(i){let e=Ce(),t=A(i)?H(i):i;return Ni.some(n=>t[n]?t[n]!=="none":!1)||(t.containerType?t.containerType!=="normal":!1)||!e&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!e&&(t.filter?t.filter!=="none":!1)||Di.some(n=>(t.willChange||"").includes(n))||Vi.some(n=>(t.contain||"").includes(n))}function Mt(i){let e=D(i);for(;P(e)&&!X(e);){if(_e(e))return e;if(de(e))return null;e=D(e)}return null}function Ce(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var ji=new Set(["html","body","#document"]);function X(i){return ji.has(J(i))}function H(i){return C(i).getComputedStyle(i)}function he(i){return A(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function D(i){if(J(i)==="html")return i;let e=i.assignedSlot||i.parentNode||At(i)&&i.host||I(i);return At(e)?e.host:e}function Pt(i){let e=D(i);return X(e)?i.ownerDocument?i.ownerDocument.body:i.body:P(e)&&te(e)?e:Pt(e)}function Ee(i,e,t){var n;e===void 0&&(e=[]),t===void 0&&(t=!0);let o=Pt(i),r=o===((n=i.ownerDocument)==null?void 0:n.body),s=C(o);if(r){let a=Ae(s);return e.concat(s,s.visualViewport||[],te(o)?o:[],a&&t?Ee(a):[])}return e.concat(o,Ee(o,[],t))}function Ae(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function Bt(i){let e=H(i),t=parseFloat(e.width)||0,n=parseFloat(e.height)||0,o=P(i),r=o?i.offsetWidth:t,s=o?i.offsetHeight:n,a=le(t)!==r||le(n)!==s;return a&&(t=r,n=s),{width:t,height:n,$:a}}function zt(i){return A(i)?i:i.contextElement}function ie(i){let e=zt(i);if(!P(e))return M(1);let t=e.getBoundingClientRect(),{width:n,height:o,$:r}=Bt(e),s=(r?le(t.width):t.width)/n,a=(r?le(t.height):t.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var Ui=M(0);function Ft(i){let e=C(i);return!Ce()||!e.visualViewport?Ui:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Wi(i,e,t){return e===void 0&&(e=!1),!t||e&&t!==C(i)?!1:e}function ue(i,e,t,n){e===void 0&&(e=!1),t===void 0&&(t=!1);let o=i.getBoundingClientRect(),r=zt(i),s=M(1);e&&(n?A(n)&&(s=ie(n)):s=ie(i));let a=Wi(r,t,n)?Ft(r):M(0),c=(o.left+a.x)/s.x,d=(o.top+a.y)/s.y,l=o.width/s.x,p=o.height/s.y;if(r){let u=C(r),h=n&&A(n)?C(n):n,f=u,m=Ae(f);for(;m&&n&&h!==f;){let g=ie(m),v=m.getBoundingClientRect(),b=H(m),w=v.left+(m.clientLeft+parseFloat(b.paddingLeft))*g.x,S=v.top+(m.clientTop+parseFloat(b.paddingTop))*g.y;c*=g.x,d*=g.y,l*=g.x,p*=g.y,c+=w,d+=S,f=C(m),m=Ae(f)}}return G({width:l,height:p,x:c,y:d})}function He(i,e){let t=he(i).scrollLeft;return e?e.left+t:ue(I(i)).left+t}function Nt(i,e){let t=i.getBoundingClientRect(),n=t.left+e.scrollLeft-He(i,t),o=t.top+e.scrollTop;return{x:n,y:o}}function qi(i){let{elements:e,rect:t,offsetParent:n,strategy:o}=i,r=o==="fixed",s=I(n),a=e?de(e.floating):!1;if(n===s||a&&r)return t;let c={scrollLeft:0,scrollTop:0},d=M(1),l=M(0),p=P(n);if((p||!p&&!r)&&((J(n)!=="body"||te(s))&&(c=he(n)),P(n))){let h=ue(n);d=ie(n),l.x=h.x+n.clientLeft,l.y=h.y+n.clientTop}let u=s&&!p&&!r?Nt(s,c):M(0);return{width:t.width*d.x,height:t.height*d.y,x:t.x*d.x-c.scrollLeft*d.x+l.x+u.x,y:t.y*d.y-c.scrollTop*d.y+l.y+u.y}}function Ki(i){return Array.from(i.getClientRects())}function Zi(i){let e=I(i),t=he(i),n=i.ownerDocument.body,o=U(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=U(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),s=-t.scrollLeft+He(i),a=-t.scrollTop;return H(n).direction==="rtl"&&(s+=U(e.clientWidth,n.clientWidth)-o),{width:o,height:r,x:s,y:a}}var $t=25;function Qi(i,e){let t=C(i),n=I(i),o=t.visualViewport,r=n.clientWidth,s=n.clientHeight,a=0,c=0;if(o){r=o.width,s=o.height;let l=Ce();(!l||l&&e==="fixed")&&(a=o.offsetLeft,c=o.offsetTop)}let d=He(n);if(d<=0){let l=n.ownerDocument,p=l.body,u=getComputedStyle(p),h=l.compatMode==="CSS1Compat"&&parseFloat(u.marginLeft)+parseFloat(u.marginRight)||0,f=Math.abs(n.clientWidth-p.clientWidth-h);f<=$t&&(r-=f)}else d<=$t&&(r+=d);return{width:r,height:s,x:a,y:c}}var Gi=new Set(["absolute","fixed"]);function Ji(i,e){let t=ue(i,!0,e==="fixed"),n=t.top+i.clientTop,o=t.left+i.clientLeft,r=P(i)?ie(i):M(1),s=i.clientWidth*r.x,a=i.clientHeight*r.y,c=o*r.x,d=n*r.y;return{width:s,height:a,x:c,y:d}}function Rt(i,e,t){let n;if(e==="viewport")n=Qi(i,t);else if(e==="document")n=Zi(I(i));else if(A(e))n=Ji(e,t);else{let o=Ft(i);n={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return G(n)}function Dt(i,e){let t=D(i);return t===e||!A(t)||X(t)?!1:H(t).position==="fixed"||Dt(t,e)}function Xi(i,e){let t=e.get(i);if(t)return t;let n=Ee(i,[],!1).filter(a=>A(a)&&J(a)!=="body"),o=null,r=H(i).position==="fixed",s=r?D(i):i;for(;A(s)&&!X(s);){let a=H(s),c=_e(s);!c&&a.position==="fixed"&&(o=null),(r?!c&&!o:!c&&a.position==="static"&&!!o&&Gi.has(o.position)||te(s)&&!c&&Dt(i,s))?n=n.filter(l=>l!==s):o=a,s=D(s)}return e.set(i,n),n}function Yi(i){let{element:e,boundary:t,rootBoundary:n,strategy:o}=i,s=[...t==="clippingAncestors"?de(e)?[]:Xi(e,this._c):[].concat(t),n],a=s[0],c=s.reduce((d,l)=>{let p=Rt(e,l,o);return d.top=U(p.top,d.top),d.right=ae(p.right,d.right),d.bottom=ae(p.bottom,d.bottom),d.left=U(p.left,d.left),d},Rt(e,a,o));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function en(i){let{width:e,height:t}=Bt(i);return{width:e,height:t}}function tn(i,e,t){let n=P(e),o=I(e),r=t==="fixed",s=ue(i,!0,r,e),a={scrollLeft:0,scrollTop:0},c=M(0);function d(){c.x=He(o)}if(n||!n&&!r)if((J(e)!=="body"||te(o))&&(a=he(e)),n){let h=ue(e,!0,r,e);c.x=h.x+e.clientLeft,c.y=h.y+e.clientTop}else o&&d();r&&!n&&o&&d();let l=o&&!n&&!r?Nt(o,a):M(0),p=s.left+a.scrollLeft-c.x-l.x,u=s.top+a.scrollTop-c.y-l.y;return{x:p,y:u,width:s.width,height:s.height}}function Ve(i){return H(i).position==="static"}function It(i,e){if(!P(i)||H(i).position==="fixed")return null;if(e)return e(i);let t=i.offsetParent;return I(i)===t&&(t=t.ownerDocument.body),t}function Vt(i,e){let t=C(i);if(de(i))return t;if(!P(i)){let o=D(i);for(;o&&!X(o);){if(A(o)&&!Ve(o))return o;o=D(o)}return t}let n=It(i,e);for(;n&&Ot(n)&&Ve(n);)n=It(n,e);return n&&X(n)&&Ve(n)&&!_e(n)?t:n||Mt(i)||t}var nn=async function(i){let e=this.getOffsetParent||Vt,t=this.getDimensions,n=await t(i.floating);return{reference:tn(i.reference,await e(i.floating),i.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function on(i){return H(i).direction==="rtl"}var rn={convertOffsetParentRelativeRectToViewportRelativeRect:qi,getDocumentElement:I,getClippingRect:Yi,getOffsetParent:Vt,getElementRects:nn,getClientRects:Ki,getDimensions:en,getScale:ie,isElement:A,isRTL:on};var jt=_t;var Ut=Ct,Wt=Tt;var qt=(i,e,t)=>{let n=new Map,o={platform:rn,...t},r={...o.platform,_c:n};return Et(i,e,{...o,platform:r})};var Oe=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
