...
`),o=0,r=0,s=0;for(let h=0;h<n.length;h++){let u=n[h].length;if(o+u>=t){r=h,s=o;break}o+=u+1}let a=n[r],p=s+a.length,d=a.match(this.LIST_PATTERNS.checkbox);if(d)return{inList:!0,listType:"checkbox",indent:d[1],marker:"-",checked:d[2]==="x",content:d[3],lineStart:s,lineEnd:p,markerEndPos:s+d[1].length+d[2].length+5};let l=a.match(this.LIST_PATTERNS.bullet);if(l)return{inList:!0,listType:"bullet",indent:l[1],marker:l[2],content:l[3],lineStart:s,lineEnd:p,markerEndPos:s+l[1].length+l[2].length+1};let c=a.match(this.LIST_PATTERNS.numbered);return c?{inList:!0,listType:"numbered",indent:c[1],marker:parseInt(c[2]),content:c[3],lineStart:s,lineEnd:p,markerEndPos:s+c[1].length+c[2].length+2}:{inList:!1,listType:null,indent:"",marker:null,content:a,lineStart:s,lineEnd:p,markerEndPos:s}}static createNewListItem(e){switch(e.listType){case"bullet":return`${e.indent}${e.marker} `;case"numbered":return`${e.indent}${e.marker+1}. `;case"checkbox":return`${e.indent}- [ ] `;default:return""}}static renumberLists(e){let t=e.split(`
`),n=new Map,o=!1;return t.map(s=>{let a=s.match(this.LIST_PATTERNS.numbered);if(a){let p=a[1],d=p.length,l=a[3];o||n.clear();let c=(n.get(d)||0)+1;n.set(d,c);for(let[h]of n)h>d&&n.delete(h);return o=!0,`${p}${c}. ${l}`}else return(s.trim()===""||!s.match(/^\s/))&&(o=!1,n.clear()),s}).join(`
`)}};T(L,"linkIndex",0),T(L,"codeHighlighter",null),T(L,"LIST_PATTERNS",{bullet:/^(\s*)([-*+])\s+(.*)$/,numbered:/^(\s*)(\d+)\.\s+(.*)$/,checkbox:/^(\s*)-\s+\[([ x])\]\s+(.*)$/});var We=Object.defineProperty,se=Object.getOwnPropertySymbols,Ke=Object.prototype.hasOwnProperty,Ze=Object.prototype.propertyIsEnumerable,ae=(i,e,t)=>e in i?We(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,le=(i,e)=>{for(var t in e||(e={}))Ke.call(e,t)&&ae(i,t,e[t]);if(se)for(var t of se(e))Ze.call(e,t)&&ae(i,t,e[t]);return i},E={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function Je(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function A(i){return le(le({},Je()),i)}var V=!1;function Ge(){return V}function y(i,e,t){V&&(console.group(`\u{1F50D} ${i}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function R(i,e){if(!V)return;let t=i.value.slice(i.selectionStart,i.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=i.value.slice(Math.max(0,i.selectionStart-10),i.selectionStart),o=i.value.slice(i.selectionEnd,Math.min(i.value.length,i.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(o)),console.groupEnd()}function he(i){V&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(i.text)),console.log("New selection:",`${i.selectionStart}-${i.selectionEnd}`),console.groupEnd())}var _=null;function $(i,{text:e,selectionStart:t,selectionEnd:n}){let o=Ge();o&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),i.focus();let r=i.selectionStart,s=i.selectionEnd,a=i.value.slice(0,r),p=i.value.slice(s);o&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(p.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(i.value.slice(r,s))));let d=i.value,l=r!==s;if(_===null||_===!0){i.contentEditable="true";try{_=document.execCommand("insertText",!1,e),o&&console.log("execCommand returned:",_,"for text with",e.split(`
`).length,"lines")}catch(c){_=!1,o&&console.log("execCommand threw error:",c)}i.contentEditable="false"}if(o&&(console.log("canInsertText before:",_),console.log("execCommand result:",_)),_){let c=a+e+p,h=i.value;o&&(console.log("Expected length:",c.length),console.log("Actual length:",h.length)),h!==c&&o&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(c.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!_)if(o&&console.log("Using manual insertion"),i.value===d){o&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(c){}i.value=a+e+p;try{document.execCommand("ms-endUndoUnit")}catch(c){}i.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else o&&console.log("Value was changed by execCommand, skipping manual insertion");o&&console.log("Setting selection range:",t,n),t!=null&&n!=null?i.setSelectionRange(t,n):i.setSelectionRange(r,i.selectionEnd),o&&(console.log("Final value length:",i.value.length),console.groupEnd())}function ce(i){return i.trim().split(`
`).length>1}function Qe(i,e){let t=e;for(;i[t]&&i[t-1]!=null&&!i[t-1].match(/\s/);)t--;return t}function Xe(i,e,t){let n=e,o=t?/\n/:/\s/;for(;i[n]&&!i[n].match(o);)n++;return n}function ue(i){let e=i.value.split(`
`),t=0;for(let n=0;n<e.length;n++){let o=e[n].length+1;i.selectionStart>=t&&i.selectionStart<t+o&&(i.selectionStart=t),i.selectionEnd>=t&&i.selectionEnd<t+o&&(n===e.length-1?i.selectionEnd=Math.min(t+e[n].length,i.value.length):i.selectionEnd=t+o-1),t+=o}}function Ye(i,e,t,n=!1){if(i.selectionStart===i.selectionEnd)i.selectionStart=Qe(i.value,i.selectionStart),i.selectionEnd=Xe(i.value,i.selectionEnd,n);else{let o=i.selectionStart-e.length,r=i.selectionEnd+t.length,s=i.value.slice(o,i.selectionStart)===e,a=i.value.slice(i.selectionEnd,r)===t;s&&a&&(i.selectionStart=o,i.selectionEnd=r)}return i.value.slice(i.selectionStart,i.selectionEnd)}function Y(i){let e=i.value.slice(0,i.selectionStart),t=i.value.slice(i.selectionEnd),n=e.match(/\n*$/),o=t.match(/^\n*/),r=n?n[0].length:0,s=o?o[0].length:0,a="",p="";return e.match(/\S/)&&r<2&&(a=`
`.repeat(2-r)),t.match(/\S/)&&s<2&&(p=`
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:p}}function F(i,e,t={}){let n=i.selectionStart,o=i.selectionEnd,r=n===o,s=i.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let d=n;for(;d<s.length&&s[d]!==`
`;)d++;i.selectionStart=a,i.selectionEnd=d}else ue(i);let p=e(i);if(t.adjustSelection){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),c=t.adjustSelection(l,n,o,a);p.selectionStart=c.start,p.selectionEnd=c.end}else if(t.prefix){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?l?(p.selectionStart=Math.max(n-t.prefix.length,a),p.selectionEnd=p.selectionStart):(p.selectionStart=n+t.prefix.length,p.selectionEnd=p.selectionStart):l?(p.selectionStart=Math.max(n-t.prefix.length,a),p.selectionEnd=Math.max(o-t.prefix.length,a)):(p.selectionStart=n+t.prefix.length,p.selectionEnd=o+t.prefix.length)}return p}function D(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:p,prefixSpace:d,scanFor:l,surroundWithNewlines:c,trimFirst:h}=e,u=i.selectionStart,f=i.selectionEnd,m=i.value.slice(i.selectionStart,i.selectionEnd),g=ce(m)&&s&&s.length>0?`${s}
`:o,v=ce(m)&&a&&a.length>0?`
${a}`:r;if(d){let S=i.value[i.selectionStart-1];i.selectionStart!==0&&S!=null&&!S.match(/\s/)&&(g=` ${g}`)}m=Ye(i,g,v,e.multiline);let b=i.selectionStart,k=i.selectionEnd,M=p&&p.length>0&&v.indexOf(p)>-1&&m.length>0;if(c){let S=Y(i);t=S.newlinesToAppend,n=S.newlinesToPrepend,g=t+o,v+=n}if(m.startsWith(g)&&m.endsWith(v)){let S=m.slice(g.length,m.length-v.length);if(u===f){let C=u-g.length;C=Math.max(C,b),C=Math.min(C,b+S.length),b=k=C}else k=b+S.length;return{text:S,selectionStart:b,selectionEnd:k}}else if(M)if(l&&l.length>0&&m.match(l)){v=v.replace(p,m);let S=g+v;return b=k=b+g.length,{text:S,selectionStart:b,selectionEnd:k}}else{let S=g+m+v;return b=b+g.length+m.length+v.indexOf(p),k=b+p.length,{text:S,selectionStart:b,selectionEnd:k}}else{let S=g+m+v;b=u+g.length,k=f+g.length;let C=m.match(/^\s*|\s*$/g);if(h&&C){let oe=C[0]||"",re=C[1]||"";S=oe+g+m.trim()+v+re,b+=oe.length,k-=re.length}return{text:S,selectionStart:b,selectionEnd:k}}}function me(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,p=r.split(`
...
`),o){let{newlinesToAppend:l,newlinesToPrepend:c}=Y(i);s+=l.length,a=s+r.length,r=l+r+c}return{text:r,selectionStart:s,selectionEnd:a}}function pe(i){let e=i.split(`
`),t=/^\d+\.\s+/,n=e.every(r=>t.test(r)),o=e;return n&&(o=e.map(r=>r.replace(t,""))),{text:o.join(`
`),processed:n}}function de(i){let e=i.split(`
`),t="- ",n=e.every(r=>r.startsWith(t)),o=e;return n&&(o=e.map(r=>r.slice(t.length))),{text:o.join(`
`),processed:n}}function O(i,e){return e?"- ":`${i+1}. `}function et(i,e){let t,n,o;return i.orderedList?(t=pe(e),n=de(t.text),o=n.text):(t=de(e),n=pe(t.text),o=n.text),[t,n,o]}function tt(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;ue(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,p]=et(e,r),d=p.split(`
`).map((m,g)=>`${O(g,e.unorderedList)}${m}`),l=d.reduce((m,g,v)=>m+O(v,e.unorderedList).length,0),c=d.reduce((m,g,v)=>m+O(v,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-O(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-l),{text:p,selectionStart:n,selectionEnd:o};let{newlinesToAppend:h,newlinesToPrepend:u}=Y(i),f=h+d.join(`
`)+u;return t?(n=Math.max(n+O(0,e.unorderedList).length+h.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+l-c):(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+l),{text:f,selectionStart:n,selectionEnd:o}}function fe(i,e){let t=F(i,n=>tt(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),p=/^\d+\.\s+/,d=/^- /,l=p.test(a),c=d.test(a),h=e.orderedList&&l||e.unorderedList&&c;if(o===r)if(h){let u=a.match(e.orderedList?p:d),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(l||c){let u=a.match(l?p:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:o+u}}else if(h){let u=a.match(e.orderedList?p:d),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(l||c){let u=a.match(l?p:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:r+u}}}});$(i,t)}function nt(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let c of r){if(t>=s&&t<=s+c.length){a=c;break}s+=c.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let p=Math.max(0,t-10),d=Math.min(o.length,n+10),l=o.slice(p,d);if(l.includes("**")){let c=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=c.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(l.includes("_")){let c=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=c.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(l.includes("`")){let c=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100));c.includes("`")&&h.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let c=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=c.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&o.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function q(i){if(!i||i.disabled||i.readOnly)return;y("toggleBold","Starting"),R(i,"Before");let e=A(E.bold),t=D(i,e);he(t),$(i,t),R(i,"After")}function U(i){if(!i||i.disabled||i.readOnly)return;let e=A(E.italic),t=D(i,e);$(i,t)}function ge(i){if(!i||i.disabled||i.readOnly)return;let e=A(E.code),t=D(i,e);$(i,t)}function W(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=A(E.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=D(i,n);$(i,r)}function K(i){if(!i||i.disabled||i.readOnly)return;let e=A(E.bulletList);fe(i,e)}function Z(i){if(!i||i.disabled||i.readOnly)return;let e=A(E.numberedList);fe(i,e)}function ve(i){if(!i||i.disabled||i.readOnly)return;y("toggleQuote","Starting"),R(i,"Initial");let e=A(E.quote),t=F(i,n=>me(n,e),{prefix:e.prefix});he(t),$(i,t),R(i,"Final")}function ee(i){if(!i||i.disabled||i.readOnly)return;let e=A(E.taskList),t=F(i,n=>me(n,e),{prefix:e.prefix});$(i,t)}function te(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),y("insertHeader","============ START ============"),y("insertHeader",`Level: ${e}, Toggle: ${t}`),y("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=A(E[n]||E.header1);y("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,p=s;for(;p>0&&r[p-1]!==`
`;)p--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(p,d);y("insertHeader",`Current line (before): "${l}"`);let c=l.match(/^(#{1,6})\s*/),h=c?c[1].length:0,u=c?c[0].length:0;y("insertHeader","Existing header check:"),y("insertHeader",`  - Match: ${c?`"${c[0]}"`:"none"}`),y("insertHeader",`  - Existing level: ${h}`),y("insertHeader",`  - Existing prefix length: ${u}`),y("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;y("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let m=F(i,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);y("insertHeader",`Line in operation: "${v}"`);let b=v.replace(/^#{1,6}\s*/,"");y("insertHeader",`Cleaned line: "${b}"`);let k;return f?(y("insertHeader","ACTION: Toggling OFF - removing header"),k=b):h>0?(y("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=o.prefix+b):(y("insertHeader","ACTION: Adding new header"),k=o.prefix+b),y("insertHeader",`New line: "${k}"`),{text:k,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,v,b,k)=>{if(y("insertHeader","Adjusting selection:"),y("insertHeader",`  - isRemoving param: ${g}`),y("insertHeader",`  - shouldToggleOff: ${f}`),y("insertHeader",`  - selStart: ${v}, selEnd: ${b}`),y("insertHeader",`  - lineStartPos: ${k}`),f){let M=Math.max(v-u,k);return y("insertHeader",`  - Removing header, adjusting by -${u}`),{start:M,end:v===b?M:Math.max(b-u,k)}}else if(u>0){let M=o.prefix.length-u;return y("insertHeader",`  - Replacing header, adjusting by ${M}`),{start:v+M,end:b+M}}else return y("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:v+o.prefix.length,end:b+o.prefix.length}}});y("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),y("insertHeader","============ END ============"),$(i,m)}function ye(i){te(i,1,!0)}function be(i){te(i,2,!0)}function we(i){te(i,3,!0)}function ke(i){return nt(i)}var N=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let o=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(o="toggleBold");break;case"i":e.shiftKey||(o="toggleItalic");break;case"k":e.shiftKey||(o="insertLink");break;case"7":e.shiftKey&&(o="toggleNumberedList");break;case"8":e.shiftKey&&(o="toggleBulletList");break}return o?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(o):this.handleAction(o),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":q(t);break;case"toggleItalic":U(t);break;case"insertLink":W(t);break;case"toggleBulletList":K(t);break;case"toggleNumberedList":Z(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var I={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},xe={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},Se={solar:I,cave:xe,light:I,dark:xe};function H(i){return typeof i=="string"?{...Se[i]||Se.solar,name:i}:i}function P(i){let e=[];for(let[t,n]of Object.entries(i)){let o=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${o}: ${n};`)}return e.join(`
`)}function Le(i,e={}){return{...i,colors:{...i.colors,...e}}}function J(i={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=i,a=Object.keys(s).length>0?`
