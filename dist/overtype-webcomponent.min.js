...
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:c}}function j(i,e,t={}){let n=i.selectionStart,o=i.selectionEnd,r=n===o,s=i.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let d=n;for(;d<s.length&&s[d]!==`
`;)d++;i.selectionStart=a,i.selectionEnd=d}else le(i);let c=e(i);if(t.adjustSelection){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(l,n,o,a);c.selectionStart=p.start,c.selectionEnd=p.end}else if(t.prefix){let l=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=c.selectionStart):(c.selectionStart=n+t.prefix.length,c.selectionEnd=c.selectionStart):l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=Math.max(o-t.prefix.length,a)):(c.selectionStart=n+t.prefix.length,c.selectionEnd=o+t.prefix.length)}return c}function V(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:c,prefixSpace:d,scanFor:l,surroundWithNewlines:p,trimFirst:h}=e,u=i.selectionStart,m=i.selectionEnd,f=i.value.slice(i.selectionStart,i.selectionEnd),g=oe(f)&&s&&s.length>0?`${s}
`:o,v=oe(f)&&a&&a.length>0?`
${a}`:r;if(d){let x=i.value[i.selectionStart-1];i.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(g=` ${g}`)}f=Qe(i,g,v,e.multiline);let b=i.selectionStart,k=i.selectionEnd,H=c&&c.length>0&&v.indexOf(c)>-1&&f.length>0;if(p){let x=G(i);t=x.newlinesToAppend,n=x.newlinesToPrepend,g=t+o,v+=n}if(f.startsWith(g)&&f.endsWith(v)){let x=f.slice(g.length,f.length-v.length);if(u===m){let C=u-g.length;C=Math.max(C,b),C=Math.min(C,b+x.length),b=k=C}else k=b+x.length;return{text:x,selectionStart:b,selectionEnd:k}}else if(H)if(l&&l.length>0&&f.match(l)){v=v.replace(c,f);let x=g+v;return b=k=b+g.length,{text:x,selectionStart:b,selectionEnd:k}}else{let x=g+f+v;return b=b+g.length+f.length+v.indexOf(c),k=b+c.length,{text:x,selectionStart:b,selectionEnd:k}}else{let x=g+f+v;b=u+g.length,k=m+g.length;let C=f.match(/^\s*|\s*$/g);if(h&&C){let Y=C[0]||"",ee=C[1]||"";x=Y+g+f.trim()+v+ee,b+=Y.length,k-=ee.length}return{text:x,selectionStart:b,selectionEnd:k}}}function ce(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,c=r.split(`
...
`),o){let{newlinesToAppend:l,newlinesToPrepend:p}=G(i);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function re(i){let e=i.split(`
...
`),processed:n}}function z(i,e){return e?"- ":`${i+1}. `}function Ge(i,e){let t,n,o;return i.orderedList?(t=re(e),n=se(t.text),o=n.text):(t=se(e),n=re(t.text),o=n.text),[t,n,o]}function Xe(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;le(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,c]=Ge(e,r),d=c.split(`
`).map((f,g)=>`${z(g,e.unorderedList)}${f}`),l=d.reduce((f,g,v)=>f+z(v,e.unorderedList).length,0),p=d.reduce((f,g,v)=>f+z(v,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-z(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-l),{text:c,selectionStart:n,selectionEnd:o};let{newlinesToAppend:h,newlinesToPrepend:u}=G(i),m=h+d.join(`
`)+u;return t?(n=Math.max(n+z(0,e.unorderedList).length+h.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+l-p):(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+l),{text:m,selectionStart:n,selectionEnd:o}}function pe(i,e){let t=j(i,n=>Xe(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),h=e.orderedList&&l||e.unorderedList&&p;if(o===r)if(h){let u=a.match(e.orderedList?c:d),m=u?u[0].length:0;return{start:Math.max(o-m,s),end:Math.max(o-m,s)}}else if(l||p){let u=a.match(l?c:d),m=u?u[0].length:0,g=(e.unorderedList?2:3)-m;return{start:o+g,end:o+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:o+u}}else if(h){let u=a.match(e.orderedList?c:d),m=u?u[0].length:0;return{start:Math.max(o-m,s),end:Math.max(r-m,s)}}else if(l||p){let u=a.match(l?c:d),m=u?u[0].length:0,g=(e.unorderedList?2:3)-m;return{start:o+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:r+u}}}});M(i,t)}function Ye(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let p of r){if(t>=s&&t<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let c=Math.max(0,t-10),d=Math.min(o.length,n+10),l=o.slice(c,d);if(l.includes("**")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("**"),m=h.indexOf("**");u!==-1&&m!==-1&&e.push("bold")}if(l.includes("_")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("_"),m=h.indexOf("_");u!==-1&&m!==-1&&e.push("italic")}if(l.includes("`")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("["),m=h.indexOf("]");u!==-1&&m!==-1&&o.slice(n+m+1,n+m+10).startsWith("(")&&e.push("link")}return e}function F(i){if(!i||i.disabled||i.readOnly)return;y("toggleBold","Starting"),N(i,"Before");let e=_(L.bold),t=V(i,e);ae(t),M(i,t),N(i,"After")}function D(i){if(!i||i.disabled||i.readOnly)return;let e=_(L.italic),t=V(i,e);M(i,t)}function de(i){if(!i||i.disabled||i.readOnly)return;let e=_(L.code),t=V(i,e);M(i,t)}function q(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=_(L.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=V(i,n);M(i,r)}function U(i){if(!i||i.disabled||i.readOnly)return;let e=_(L.bulletList);pe(i,e)}function W(i){if(!i||i.disabled||i.readOnly)return;let e=_(L.numberedList);pe(i,e)}function he(i){if(!i||i.disabled||i.readOnly)return;y("toggleQuote","Starting"),N(i,"Initial");let e=_(L.quote),t=j(i,n=>ce(n,e),{prefix:e.prefix});ae(t),M(i,t),N(i,"Final")}function ue(i){if(!i||i.disabled||i.readOnly)return;let e=_(L.taskList),t=j(i,n=>ce(n,e),{prefix:e.prefix});M(i,t)}function X(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),y("insertHeader","============ START ============"),y("insertHeader",`Level: ${e}, Toggle: ${t}`),y("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=_(L[n]||L.header1);y("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,c=s;for(;c>0&&r[c-1]!==`
`;)c--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(c,d);y("insertHeader",`Current line (before): "${l}"`);let p=l.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;y("insertHeader","Existing header check:"),y("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),y("insertHeader",`  - Existing level: ${h}`),y("insertHeader",`  - Existing prefix length: ${u}`),y("insertHeader",`  - Target level: ${e}`);let m=t&&h===e;y("insertHeader",`Should toggle OFF: ${m} (toggle=${t}, existingLevel=${h}, level=${e})`);let f=j(i,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);y("insertHeader",`Line in operation: "${v}"`);let b=v.replace(/^#{1,6}\s*/,"");y("insertHeader",`Cleaned line: "${b}"`);let k;return m?(y("insertHeader","ACTION: Toggling OFF - removing header"),k=b):h>0?(y("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=o.prefix+b):(y("insertHeader","ACTION: Adding new header"),k=o.prefix+b),y("insertHeader",`New line: "${k}"`),{text:k,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,v,b,k)=>{if(y("insertHeader","Adjusting selection:"),y("insertHeader",`  - isRemoving param: ${g}`),y("insertHeader",`  - shouldToggleOff: ${m}`),y("insertHeader",`  - selStart: ${v}, selEnd: ${b}`),y("insertHeader",`  - lineStartPos: ${k}`),m){let H=Math.max(v-u,k);return y("insertHeader",`  - Removing header, adjusting by -${u}`),{start:H,end:v===b?H:Math.max(b-u,k)}}else if(u>0){let H=o.prefix.length-u;return y("insertHeader",`  - Replacing header, adjusting by ${H}`),{start:v+H,end:b+H}}else return y("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:v+o.prefix.length,end:b+o.prefix.length}}});y("insertHeader",`Final result: text="${f.text}", cursor=${f.selectionStart}-${f.selectionEnd}`),y("insertHeader","============ END ============"),M(i,f)}function me(i){X(i,1,!0)}function fe(i){X(i,2,!0)}function ge(i){X(i,3,!0)}function ve(i){return Ye(i)}var B=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let o=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(o="toggleBold");break;case"i":e.shiftKey||(o="toggleItalic");break;case"k":e.shiftKey||(o="insertLink");break;case"7":e.shiftKey&&(o="toggleNumberedList");break;case"8":e.shiftKey&&(o="toggleBulletList");break}return o?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(o):this.handleAction(o),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":F(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var $={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},be={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},we={solar:$,cave:be,light:$,dark:be};function A(i){return typeof i=="string"?{...we[i]||we.solar,name:i}:i}function P(i){let e=[];for(let[t,n]of Object.entries(i)){let o=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${o}: ${n};`)}return e.join(`
`)}function ke(i,e={}){return{...i,colors:{...i.colors,...e}}}function K(i={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=i,a=Object.keys(s).length>0?`
  ...
  `:"",c=r&&r.colors?P(r.colors):"";return`
