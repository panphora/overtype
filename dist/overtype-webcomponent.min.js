...
`)}function pt(i,e={},t={}){return{...i,colors:{...i.colors,...e},previewColors:{...i.previewColors,...t}}}function Se(i={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=i,a=Object.keys(s).length>0?`
  ...
  `}var de={};lt(de,{applyCustomFormat:()=>Et,default:()=>Bi,expandSelection:()=>_t,getActiveFormats:()=>Re,getDebugMode:()=>Je,hasFormat:()=>Lt,insertHeader:()=>ce,insertLink:()=>Ce,preserveSelection:()=>xt,setDebugMode:()=>vt,setUndoMethod:()=>wt,toggleBold:()=>Ee,toggleBulletList:()=>Ie,toggleCode:()=>Te,toggleH1:()=>Oe,toggleH2:()=>$e,toggleH3:()=>Pe,toggleItalic:()=>Ae,toggleNumberedList:()=>Me,toggleQuote:()=>He,toggleTaskList:()=>le});var Ei=Object.defineProperty,ht=Object.getOwnPropertySymbols,Ai=Object.prototype.hasOwnProperty,Ti=Object.prototype.propertyIsEnumerable,ut=(i,e,t)=>e in i?Ei(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,ft=(i,e)=>{for(var t in e||(e={}))Ai.call(e,t)&&ut(i,t,e[t]);if(ht)for(var t of ht(e))Ti.call(e,t)&&ut(i,t,e[t]);return i},R={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function Ci(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function B(i){return ft(ft({},Ci()),i)}var ae=!1;function vt(i){ae=i}function Je(){return ae}function x(i,e,t){ae&&(console.group(`\u{1F50D} ${i}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function Le(i,e){if(!ae)return;let t=i.value.slice(i.selectionStart,i.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=i.value.slice(Math.max(0,i.selectionStart-10),i.selectionStart),o=i.value.slice(i.selectionEnd,Math.min(i.value.length,i.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(o)),console.groupEnd()}function yt(i){ae&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(i.text)),console.log("New selection:",`${i.selectionStart}-${i.selectionEnd}`),console.groupEnd())}var C=null;function z(i,{text:e,selectionStart:t,selectionEnd:n}){let o=Je();o&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),i.focus();let r=i.selectionStart,s=i.selectionEnd,a=i.value.slice(0,r),l=i.value.slice(s);o&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(l.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(i.value.slice(r,s))));let d=i.value,c=r!==s;if(C===null||C===!0){i.contentEditable="true";try{C=document.execCommand("insertText",!1,e),o&&console.log("execCommand returned:",C,"for text with",e.split(`
`).length,"lines")}catch(p){C=!1,o&&console.log("execCommand threw error:",p)}i.contentEditable="false"}if(o&&(console.log("canInsertText before:",C),console.log("execCommand result:",C)),C){let p=a+e+l,h=i.value;o&&(console.log("Expected length:",p.length),console.log("Actual length:",h.length)),h!==p&&o&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(p.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!C)if(o&&console.log("Using manual insertion"),i.value===d){o&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(p){}i.value=a+e+l;try{document.execCommand("ms-endUndoUnit")}catch(p){}i.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else o&&console.log("Value was changed by execCommand, skipping manual insertion");o&&console.log("Setting selection range:",t,n),t!=null&&n!=null?i.setSelectionRange(t,n):i.setSelectionRange(r,i.selectionEnd),o&&(console.log("Final value length:",i.value.length),console.groupEnd())}function wt(i){switch(i){case"native":C=!0;break;case"manual":C=!1;break;case"auto":C=null;break}}function Qe(i){return i.trim().split(`
`).length>1}function Ii(i,e){let t=e;for(;i[t]&&i[t-1]!=null&&!i[t-1].match(/\s/);)t--;return t}function Mi(i,e,t){let n=e,o=t?/\n/:/\s/;for(;i[n]&&!i[n].match(o);)n++;return n}function bt(i){let e=i.value.split(`
`),t=0;for(let n=0;n<e.length;n++){let o=e[n].length+1;i.selectionStart>=t&&i.selectionStart<t+o&&(i.selectionStart=t),i.selectionEnd>=t&&i.selectionEnd<t+o&&(n===e.length-1?i.selectionEnd=Math.min(t+e[n].length,i.value.length):i.selectionEnd=t+o-1),t+=o}}function Hi(i,e,t,n=!1){if(i.selectionStart===i.selectionEnd)i.selectionStart=Ii(i.value,i.selectionStart),i.selectionEnd=Mi(i.value,i.selectionEnd,n);else{let o=i.selectionStart-e.length,r=i.selectionEnd+t.length,s=i.value.slice(o,i.selectionStart)===e,a=i.value.slice(i.selectionEnd,r)===t;s&&a&&(i.selectionStart=o,i.selectionEnd=r)}return i.value.slice(i.selectionStart,i.selectionEnd)}function Xe(i){let e=i.value.slice(0,i.selectionStart),t=i.value.slice(i.selectionEnd),n=e.match(/\n*$/),o=t.match(/^\n*/),r=n?n[0].length:0,s=o?o[0].length:0,a="",l="";return e.match(/\S/)&&r<2&&(a=`
`.repeat(2-r)),t.match(/\S/)&&s<2&&(l=`
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:l}}function xt(i,e){let t=i.selectionStart,n=i.selectionEnd,o=i.scrollTop;e(),i.selectionStart=t,i.selectionEnd=n,i.scrollTop=o}function _e(i,e,t={}){let n=i.selectionStart,o=i.selectionEnd,r=n===o,s=i.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let d=n;for(;d<s.length&&s[d]!==`
`;)d++;i.selectionStart=a,i.selectionEnd=d}else bt(i);let l=e(i);if(t.adjustSelection){let c=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(c,n,o,a);l.selectionStart=p.start,l.selectionEnd=p.end}else if(t.prefix){let c=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?c?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=n+t.prefix.length,l.selectionEnd=l.selectionStart):c?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=Math.max(o-t.prefix.length,a)):(l.selectionStart=n+t.prefix.length,l.selectionEnd=o+t.prefix.length)}return l}function te(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:d,scanFor:c,surroundWithNewlines:p,trimFirst:h}=e,u=i.selectionStart,f=i.selectionEnd,m=i.value.slice(i.selectionStart,i.selectionEnd),g=Qe(m)&&s&&s.length>0?`${s}
`:o,y=Qe(m)&&a&&a.length>0?`
${a}`:r;if(d){let k=i.value[i.selectionStart-1];i.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(g=` ${g}`)}m=Hi(i,g,y,e.multiline);let w=i.selectionStart,b=i.selectionEnd,S=l&&l.length>0&&y.indexOf(l)>-1&&m.length>0;if(p){let k=Xe(i);t=k.newlinesToAppend,n=k.newlinesToPrepend,g=t+o,y+=n}if(m.startsWith(g)&&m.endsWith(y)){let k=m.slice(g.length,m.length-y.length);if(u===f){let _=u-g.length;_=Math.max(_,w),_=Math.min(_,w+k.length),w=b=_}else b=w+k.length;return{text:k,selectionStart:w,selectionEnd:b}}else if(S)if(c&&c.length>0&&m.match(c)){y=y.replace(l,m);let k=g+y;return w=b=w+g.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+y;return w=w+g.length+m.length+y.indexOf(l),b=w+l.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+y;w=u+g.length,b=f+g.length;let _=m.match(/^\s*|\s*$/g);if(h&&_){let be=_[0]||"",Y=_[1]||"";k=be+g+m.trim()+y+Y,w+=be.length,b-=Y.length}return{text:k,selectionStart:w,selectionEnd:b}}}function Ge(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,l=r.split(`
`);if(l.every(c=>c.startsWith(t)&&(!n||c.endsWith(n))))r=l.map(c=>{let p=c.slice(t.length);return n&&(p=p.slice(0,p.length-n.length)),p}).join(`
`),a=s+r.length;else if(r=l.map(c=>t+c+(n||"")).join(`
`),o){let{newlinesToAppend:c,newlinesToPrepend:p}=Xe(i);s+=c.length,a=s+r.length,r=c+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function mt(i){let e=i.split(`
`),t=/^\d+\.\s+/,n=e.every(r=>t.test(r)),o=e;return n&&(o=e.map(r=>r.replace(t,""))),{text:o.join(`
`),processed:n}}function gt(i){let e=i.split(`
`),t="- ",n=e.every(r=>r.startsWith(t)),o=e;return n&&(o=e.map(r=>r.slice(t.length))),{text:o.join(`
`),processed:n}}function se(i,e){return e?"- ":`${i+1}. `}function Oi(i,e){let t,n,o;return i.orderedList?(t=mt(e),n=gt(t.text),o=n.text):(t=gt(e),n=mt(t.text),o=n.text),[t,n,o]}function $i(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;bt(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,l]=Oi(e,r),d=l.split(`
`).map((m,g)=>`${se(g,e.unorderedList)}${m}`),c=d.reduce((m,g,y)=>m+se(y,e.unorderedList).length,0),p=d.reduce((m,g,y)=>m+se(y,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-se(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-c),{text:l,selectionStart:n,selectionEnd:o};let{newlinesToAppend:h,newlinesToPrepend:u}=Xe(i),f=h+d.join(`
`)+u;return t?(n=Math.max(n+se(0,e.unorderedList).length+h.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+c-p):(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+c),{text:f,selectionStart:n,selectionEnd:o}}function kt(i,e){let t=_e(i,n=>$i(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),l=/^\d+\.\s+/,d=/^- /,c=l.test(a),p=d.test(a),h=e.orderedList&&c||e.unorderedList&&p;if(o===r)if(h){let u=a.match(e.orderedList?l:d),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(c||p){let u=a.match(c?l:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:o+u}}else if(h){let u=a.match(e.orderedList?l:d),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(c||p){let u=a.match(c?l:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:r+u}}}});z(i,t)}function St(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let p of r){if(t>=s&&t<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,t-10),d=Math.min(o.length,n+10),c=o.slice(l,d);if(c.includes("**")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(c.includes("_")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(c.includes("`")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(c.includes("[")&&c.includes("]")){let p=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=p.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&o.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function Pi(i,e){return St(i).includes(e)}function Ri(i,e={}){if(!i)return;let{toWord:t,toLine:n,toFormat:o}=e,{selectionStart:r,selectionEnd:s,value:a}=i;if(n){let l=a.split(`
`),d=0,c=0,p=0;for(let h of l){if(r>=p&&r<=p+h.length){d=p,c=p+h.length;break}p+=h.length+1}i.selectionStart=d,i.selectionEnd=c}else if(t&&r===s){let l=r,d=s;for(;l>0&&!/\s/.test(a[l-1]);)l--;for(;d<a.length&&!/\s/.test(a[d]);)d++;i.selectionStart=l,i.selectionEnd=d}}function Ee(i){if(!i||i.disabled||i.readOnly)return;x("toggleBold","Starting"),Le(i,"Before");let e=B(R.bold),t=te(i,e);yt(t),z(i,t),Le(i,"After")}function Ae(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.italic),t=te(i,e);z(i,t)}function Te(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.code),t=te(i,e);z(i,t)}function Ce(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=B(R.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=te(i,n);z(i,r)}function Ie(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.bulletList);kt(i,e)}function Me(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.numberedList);kt(i,e)}function He(i){if(!i||i.disabled||i.readOnly)return;x("toggleQuote","Starting"),Le(i,"Initial");let e=B(R.quote),t=_e(i,n=>Ge(n,e),{prefix:e.prefix});yt(t),z(i,t),Le(i,"Final")}function le(i){if(!i||i.disabled||i.readOnly)return;let e=B(R.taskList),t=_e(i,n=>Ge(n,e),{prefix:e.prefix});z(i,t)}function ce(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${t}`),x("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=B(R[n]||R.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let c=r.slice(l,d);x("insertHeader",`Current line (before): "${c}"`);let p=c.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${h}`),x("insertHeader",`  - Existing prefix length: ${u}`),x("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let m=_e(i,g=>{let y=g.value.slice(g.selectionStart,g.selectionEnd);x("insertHeader",`Line in operation: "${y}"`);let w=y.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${w}"`);let b;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),b=w):h>0?(x("insertHeader",`ACTION: Replacing H${h} with H${e}`),b=o.prefix+w):(x("insertHeader","ACTION: Adding new header"),b=o.prefix+w),x("insertHeader",`New line: "${b}"`),{text:b,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,y,w,b)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${g}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${y}, selEnd: ${w}`),x("insertHeader",`  - lineStartPos: ${b}`),f){let S=Math.max(y-u,b);return x("insertHeader",`  - Removing header, adjusting by -${u}`),{start:S,end:y===w?S:Math.max(w-u,b)}}else if(u>0){let S=o.prefix.length-u;return x("insertHeader",`  - Replacing header, adjusting by ${S}`),{start:y+S,end:w+S}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:y+o.prefix.length,end:w+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),z(i,m)}function Oe(i){ce(i,1,!0)}function $e(i){ce(i,2,!0)}function Pe(i){ce(i,3,!0)}function Re(i){return St(i)}function Lt(i,e){return Pi(i,e)}function _t(i,e={}){Ri(i,e)}function Et(i,e){if(!i||i.disabled||i.readOnly)return;let t=B(e),n;if(t.multiline){let o=i.value.slice(i.selectionStart,i.selectionEnd);Qe(o)?n=Ge(i,t):n=te(i,t)}else n=te(i,t);z(i,n)}var Bi={toggleBold:Ee,toggleItalic:Ae,toggleCode:Te,insertLink:Ce,toggleBulletList:Ie,toggleNumberedList:Me,toggleQuote:He,toggleTaskList:le,insertHeader:ce,toggleH1:Oe,toggleH2:$e,toggleH3:Pe,getActiveFormats:Re,hasFormat:Lt,expandSelection:_t,applyCustomFormat:Et,preserveSelection:xt,setUndoMethod:wt,setDebugMode:vt,getDebugMode:Je};var Be=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.currentItemIndex=0,this.handleDocumentClick=null,this.activeDropdown=null,this.activeDropdownButton=null,this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.id=this.getInstanceElementId("toolbar"),this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.container.setAttribute("aria-controls",this.editor.textarea.id),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let t=this.createSeparator();this.container.appendChild(t)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.setupRovingTabIndex(),this.updateButtonStates(),this.editor.container.insertBefore(this.container,this.editor.wrapper)}getInstanceElementId(e){return`overtype-${this.editor.instanceId}-${e}`}setupRovingTabIndex(){this.getToolbarItems().length!==0&&(this.currentItemIndex=this.getValidItemIndex(this.currentItemIndex),this.updateTabIndexes(),this.container.addEventListener("keydown",t=>{this.onToolbarKeydown(t)}),this.container.addEventListener("focusin",t=>{this.onToolbarFocusin(t)}))}getToolbarItems(){return this.container?Array.from(this.container.querySelectorAll(".overtype-toolbar-button")):[]}onToolbarKeydown(e){let t=this.getToolbarItems();if(t.includes(e.target))switch(e.key){case"ArrowRight":e.preventDefault(),this.focusItem(this.currentItemIndex+1);break;case"ArrowLeft":e.preventDefault(),this.focusItem(this.currentItemIndex-1);break;case"Home":e.preventDefault(),this.focusItem(0);break;case"End":e.preventDefault(),this.focusItem(t.length-1);break}}onToolbarFocusin(e){let t=this.getToolbarItems().indexOf(e.target);t!==-1&&(this.currentItemIndex=t,this.updateTabIndexes())}focusItem(e){let t=this.getToolbarItems();t.length!==0&&(this.currentItemIndex=this.getValidItemIndex(e,t),this.updateTabIndexes(),t[this.currentItemIndex].focus())}getValidItemIndex(e,t=this.getToolbarItems()){let n=t.length;return n===0?0:e<0?n-1:e>=n?0:e}updateTabIndexes(){this.getToolbarItems().forEach((e,t)=>{e.tabIndex=t===this.currentItemIndex?0:-1})}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let t=document.createElement("button");return t.className="overtype-toolbar-button",t.type="button",t.setAttribute("data-button",e.name),t.title=e.title||"",t.setAttribute("aria-label",e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(t.classList.add("has-dropdown"),t.dataset.dropdown="true",t.setAttribute("aria-haspopup","menu"),t.setAttribute("aria-expanded","false"),t._clickHandler=n=>{n.preventDefault(),this.toggleViewModeDropdown(t)},t._keydownHandler=n=>{if(!["ArrowDown","ArrowUp","Enter"," "].includes(n.key))return;n.preventDefault();let o=n.key==="ArrowUp"?"last":"current";this.openViewModeDropdown(t,o)},t.addEventListener("click",t._clickHandler),t.addEventListener("keydown",t._keydownHandler),t):(t._clickHandler=n=>{n.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,n)},t.addEventListener("click",t._clickHandler),t)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:t=>this.editor.setValue(t),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:t}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){if(this.activeDropdown){this.closeViewModeDropdown(e);return}this.openViewModeDropdown(e)}openViewModeDropdown(e,t=null){this.closeViewModeDropdown(e),e.classList.add("dropdown-active");let n=this.createViewModeDropdown(e),o=e.getBoundingClientRect();n.style.position="absolute",n.style.top=`${o.bottom+5}px`,n.style.left=`${o.left}px`,document.body.appendChild(n),this.activeDropdown=n,this.activeDropdownButton=e,e.setAttribute("aria-controls",n.id),e.setAttribute("aria-expanded","true"),this.handleDocumentClick=r=>{!n.contains(r.target)&&!e.contains(r.target)&&this.closeViewModeDropdown(e)},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0),t&&this.focusViewModeMenuItem(n,t)}closeViewModeDropdown(e=this.activeDropdownButton,t=!1){this.activeDropdown&&(this.activeDropdown.remove(),this.activeDropdown=null),e&&(e.classList.remove("dropdown-active"),e.setAttribute("aria-expanded","false")),this.handleDocumentClick&&(document.removeEventListener("click",this.handleDocumentClick),this.handleDocumentClick=null),this.activeDropdownButton=null,t&&e&&e.focus()}createViewModeDropdown(e){let t=document.createElement("div");t.className="overtype-dropdown-menu",t.id=this.getInstanceElementId("toolbar-view-mode-menu"),t.setAttribute("role","menu"),t.setAttribute("aria-label","View mode"),t.addEventListener("keydown",r=>{this.onViewModeMenuKeydown(r,e)});let n=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return n.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.tabIndex=-1,s.setAttribute("role","menuitemradio"),s.setAttribute("aria-checked",String(r.id===o)),s.textContent=r.label,r.id===o){s.classList.add("active");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.setAttribute("aria-hidden","true"),a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}this.closeViewModeDropdown(e,!0)}),t.appendChild(s)}),t}onViewModeMenuKeydown(e,t){let o=this.getViewModeMenuItems().indexOf(e.target);if(o!==-1)switch(e.key){case"ArrowDown":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,o+1);break;case"ArrowUp":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,o-1);break;case"Home":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,"first");break;case"End":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,"last");break;case"Escape":e.preventDefault(),this.closeViewModeDropdown(t,!0);break}}focusViewModeMenuItem(e,t){let n=this.getViewModeMenuItems(e);if(n.length===0)return;let o=t;t==="first"?o=0:t==="last"?o=n.length-1:t==="current"&&(o=n.findIndex(r=>r.getAttribute("aria-checked")==="true")),o<0&&(o=n.length-1),o>=n.length&&(o=0),n[o].focus()}getViewModeMenuItems(e=this.activeDropdown){return e?Array.from(e.querySelectorAll('[role="menuitemradio"]')):[]}updateButtonStates(){var e;try{let t=((e=Re)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([n,o])=>{if(n==="viewMode")return;let r=this.toolbarButtons.find(a=>a.name===n);if(!(r!=null&&r.isActive))return;let s=!!r.isActive({editor:this.editor,activeFormats:t});o.classList.toggle("active",s),o.setAttribute("aria-pressed",s.toString())})}catch(t){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.activeDropdown?this.closeViewModeDropdown():this.handleDocumentClick&&(document.removeEventListener("click",this.handleDocumentClick),this.handleDocumentClick=null),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler),e._keydownHandler&&(e.removeEventListener("keydown",e._keydownHandler),delete e._keydownHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var he=Math.min,U=Math.max,ue=Math.round;var O=i=>({x:i,y:i}),Di={left:"right",right:"left",bottom:"top",top:"bottom"},Fi={start:"end",end:"start"};function Ye(i,e,t){return U(i,he(e,t))}function fe(i,e){return typeof i=="function"?i(e):i}function W(i){return i.split("-")[0]}function me(i){return i.split("-")[1]}function et(i){return i==="x"?"y":"x"}function tt(i){return i==="y"?"height":"width"}var zi=new Set(["top","bottom"]);function N(i){return zi.has(W(i))?"y":"x"}function it(i){return et(N(i))}function Ct(i,e,t){t===void 0&&(t=!1);let n=me(i),o=it(i),r=tt(o),s=o==="x"?n===(t?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=pe(s)),[s,pe(s)]}function It(i){let e=pe(i);return[De(i),e,De(e)]}function De(i){return i.replace(/start|end/g,e=>Fi[e])}var At=["left","right"],Tt=["right","left"],Ni=["top","bottom"],Vi=["bottom","top"];function ji(i,e,t){switch(i){case"top":case"bottom":return t?e?Tt:At:e?At:Tt;case"left":case"right":return e?Ni:Vi;default:return[]}}function Mt(i,e,t,n){let o=me(i),r=ji(W(i),t==="start",n);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(De)))),r}function pe(i){return i.replace(/left|right|bottom|top/g,e=>Di[e])}function Ui(i){return{top:0,right:0,bottom:0,left:0,...i}}function Ht(i){return typeof i!="number"?Ui(i):{top:i,right:i,bottom:i,left:i}}function J(i){let{x:e,y:t,width:n,height:o}=i;return{width:n,height:o,top:t,left:e,right:e+n,bottom:t+o,x:e,y:t}}function Ot(i,e,t){let{reference:n,floating:o}=i,r=N(e),s=it(e),a=tt(s),l=W(e),d=r==="y",c=n.x+n.width/2-o.width/2,p=n.y+n.height/2-o.height/2,h=n[a]/2-o[a]/2,u;switch(l){case"top":u={x:c,y:n.y-o.height};break;case"bottom":u={x:c,y:n.y+n.height};break;case"right":u={x:n.x+n.width,y:p};break;case"left":u={x:n.x-o.width,y:p};break;default:u={x:n.x,y:n.y}}switch(me(e)){case"start":u[s]-=h*(t&&d?-1:1);break;case"end":u[s]+=h*(t&&d?-1:1);break}return u}async function $t(i,e){var t;e===void 0&&(e={});let{x:n,y:o,platform:r,rects:s,elements:a,strategy:l}=i,{boundary:d="clippingAncestors",rootBoundary:c="viewport",elementContext:p="floating",altBoundary:h=!1,padding:u=0}=fe(e,i),f=Ht(u),g=a[h?p==="floating"?"reference":"floating":p],y=J(await r.getClippingRect({element:(t=await(r.isElement==null?void 0:r.isElement(g)))==null||t?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:d,rootBoundary:c,strategy:l})),w=p==="floating"?{x:n,y:o,width:s.floating.width,height:s.floating.height}:s.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},k=J(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:b,strategy:l}):w);return{top:(y.top-k.top+f.top)/S.y,bottom:(k.bottom-y.bottom+f.bottom)/S.y,left:(y.left-k.left+f.left)/S.x,right:(k.right-y.right+f.right)/S.x}}var Pt=async(i,e,t)=>{let{placement:n="bottom",strategy:o="absolute",middleware:r=[],platform:s}=t,a=r.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(e)),d=await s.getElementRects({reference:i,floating:e,strategy:o}),{x:c,y:p}=Ot(d,n,l),h=n,u={},f=0;for(let g=0;g<a.length;g++){var m;let{name:y,fn:w}=a[g],{x:b,y:S,data:k,reset:_}=await w({x:c,y:p,initialPlacement:n,placement:h,strategy:o,middlewareData:u,rects:d,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:$t},elements:{reference:i,floating:e}});c=b!=null?b:c,p=S!=null?S:p,u={...u,[y]:{...u[y],...k}},_&&f<=50&&(f++,typeof _=="object"&&(_.placement&&(h=_.placement),_.rects&&(d=_.rects===!0?await s.getElementRects({reference:i,floating:e,strategy:o}):_.rects),{x:c,y:p}=Ot(d,h,l)),g=-1)}return{x:c,y:p,placement:h,strategy:o,middlewareData:u}};var Rt=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(e){var t,n;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:l,elements:d}=e,{mainAxis:c=!0,crossAxis:p=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=fe(i,e);if((t=r.arrow)!=null&&t.alignmentOffset)return{};let y=W(o),w=N(a),b=W(a)===a,S=await(l.isRTL==null?void 0:l.isRTL(d.floating)),k=h||(b||!m?[pe(a)]:It(a)),_=f!=="none";!h&&_&&k.push(...Mt(a,m,f,S));let be=[a,...k],Y=await l.detectOverflow(e,g),xe=[],ee=((n=r.flip)==null?void 0:n.overflows)||[];if(c&&xe.push(Y[y]),p){let K=Ct(o,s,S);xe.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:xe}],!xe.every(K=>K<=0)){var rt,st;let K=(((rt=r.flip)==null?void 0:rt.index)||0)+1,Ke=be[K];if(Ke&&(!(p==="alignment"?w!==N(Ke):!1)||ee.every(H=>N(H.placement)===w?H.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:Ke}};let oe=(st=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,H)=>Z.overflows[1]-H.overflows[1])[0])==null?void 0:st.placement;if(!oe)switch(u){case"bestFit":{var at;let Z=(at=ee.filter(H=>{if(_){let j=N(H.placement);return j===w||j==="y"}return!0}).map(H=>[H.placement,H.overflows.filter(j=>j>0).reduce((j,wi)=>j+wi,0)]).sort((H,j)=>H[1]-j[1])[0])==null?void 0:at[0];Z&&(oe=Z);break}case"initialPlacement":oe=a;break}if(o!==oe)return{reset:{placement:oe}}}return{}}}};var Wi=new Set(["left","top"]);async function qi(i,e){let{placement:t,platform:n,elements:o}=i,r=await(n.isRTL==null?void 0:n.isRTL(o.floating)),s=W(t),a=me(t),l=N(t)==="y",d=Wi.has(s)?-1:1,c=r&&l?-1:1,p=fe(e,i),{mainAxis:h,crossAxis:u,alignmentAxis:f}=typeof p=="number"?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return a&&typeof f=="number"&&(u=a==="end"?f*-1:f),l?{x:u*c,y:h*d}:{x:h*d,y:u*c}}var Bt=function(i){return i===void 0&&(i=0),{name:"offset",options:i,async fn(e){var t,n;let{x:o,y:r,placement:s,middlewareData:a}=e,l=await qi(e,i);return s===((t=a.offset)==null?void 0:t.placement)&&(n=a.arrow)!=null&&n.alignmentOffset?{}:{x:o+l.x,y:r+l.y,data:{...l,placement:s}}}}},Dt=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(e){let{x:t,y:n,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:y=>{let{x:w,y:b}=y;return{x:w,y:b}}},...d}=fe(i,e),c={x:t,y:n},p=await r.detectOverflow(e,d),h=N(W(o)),u=et(h),f=c[u],m=c[h];if(s){let y=u==="y"?"top":"left",w=u==="y"?"bottom":"right",b=f+p[y],S=f-p[w];f=Ye(b,f,S)}if(a){let y=h==="y"?"top":"left",w=h==="y"?"bottom":"right",b=m+p[y],S=m-p[w];m=Ye(b,m,S)}let g=l.fn({...e,[u]:f,[h]:m});return{...g,data:{x:g.x-t,y:g.y-n,enabled:{[u]:s,[h]:a}}}}}};function ze(){return typeof window<"u"}function X(i){return zt(i)?(i.nodeName||"").toLowerCase():"#document"}function T(i){var e;return(i==null||(e=i.ownerDocument)==null?void 0:e.defaultView)||window}function D(i){var e;return(e=(zt(i)?i.ownerDocument:i.document)||window.document)==null?void 0:e.documentElement}function zt(i){return ze()?i instanceof Node||i instanceof T(i).Node:!1}function I(i){return ze()?i instanceof Element||i instanceof T(i).Element:!1}function $(i){return ze()?i instanceof HTMLElement||i instanceof T(i).HTMLElement:!1}function Ft(i){return!ze()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof T(i).ShadowRoot}var Ki=new Set(["inline","contents"]);function ie(i){let{overflow:e,overflowX:t,overflowY:n,display:o}=M(i);return/auto|scroll|overlay|hidden|clip/.test(e+n+t)&&!Ki.has(o)}var Zi=new Set(["table","td","th"]);function Nt(i){return Zi.has(X(i))}var Qi=[":popover-open",":modal"];function ge(i){return Qi.some(e=>{try{return i.matches(e)}catch(t){return!1}})}var Ji=["transform","translate","scale","rotate","perspective"],Xi=["transform","translate","scale","rotate","perspective","filter"],Gi=["paint","layout","strict","content"];function Ne(i){let e=Ve(),t=I(i)?M(i):i;return Ji.some(n=>t[n]?t[n]!=="none":!1)||(t.containerType?t.containerType!=="normal":!1)||!e&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!e&&(t.filter?t.filter!=="none":!1)||Xi.some(n=>(t.willChange||"").includes(n))||Gi.some(n=>(t.contain||"").includes(n))}function Vt(i){let e=V(i);for(;$(e)&&!G(e);){if(Ne(e))return e;if(ge(e))return null;e=V(e)}return null}function Ve(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Yi=new Set(["html","body","#document"]);function G(i){return Yi.has(X(i))}function M(i){return T(i).getComputedStyle(i)}function ve(i){return I(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function V(i){if(X(i)==="html")return i;let e=i.assignedSlot||i.parentNode||Ft(i)&&i.host||D(i);return Ft(e)?e.host:e}function jt(i){let e=V(i);return G(e)?i.ownerDocument?i.ownerDocument.body:i.body:$(e)&&ie(e)?e:jt(e)}function Fe(i,e,t){var n;e===void 0&&(e=[]),t===void 0&&(t=!0);let o=jt(i),r=o===((n=i.ownerDocument)==null?void 0:n.body),s=T(o);if(r){let a=je(s);return e.concat(s,s.visualViewport||[],ie(o)?o:[],a&&t?Fe(a):[])}return e.concat(o,Fe(o,[],t))}function je(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function Kt(i){let e=M(i),t=parseFloat(e.width)||0,n=parseFloat(e.height)||0,o=$(i),r=o?i.offsetWidth:t,s=o?i.offsetHeight:n,a=ue(t)!==r||ue(n)!==s;return a&&(t=r,n=s),{width:t,height:n,$:a}}function Zt(i){return I(i)?i:i.contextElement}function ne(i){let e=Zt(i);if(!$(e))return O(1);let t=e.getBoundingClientRect(),{width:n,height:o,$:r}=Kt(e),s=(r?ue(t.width):t.width)/n,a=(r?ue(t.height):t.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var en=O(0);function Qt(i){let e=T(i);return!Ve()||!e.visualViewport?en:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function tn(i,e,t){return e===void 0&&(e=!1),!t||e&&t!==T(i)?!1:e}function ye(i,e,t,n){e===void 0&&(e=!1),t===void 0&&(t=!1);let o=i.getBoundingClientRect(),r=Zt(i),s=O(1);e&&(n?I(n)&&(s=ne(n)):s=ne(i));let a=tn(r,t,n)?Qt(r):O(0),l=(o.left+a.x)/s.x,d=(o.top+a.y)/s.y,c=o.width/s.x,p=o.height/s.y;if(r){let h=T(r),u=n&&I(n)?T(n):n,f=h,m=je(f);for(;m&&n&&u!==f;){let g=ne(m),y=m.getBoundingClientRect(),w=M(m),b=y.left+(m.clientLeft+parseFloat(w.paddingLeft))*g.x,S=y.top+(m.clientTop+parseFloat(w.paddingTop))*g.y;l*=g.x,d*=g.y,c*=g.x,p*=g.y,l+=b,d+=S,f=T(m),m=je(f)}}return J({width:c,height:p,x:l,y:d})}function Ue(i,e){let t=ve(i).scrollLeft;return e?e.left+t:ye(D(i)).left+t}function Jt(i,e){let t=i.getBoundingClientRect(),n=t.left+e.scrollLeft-Ue(i,t),o=t.top+e.scrollTop;return{x:n,y:o}}function nn(i){let{elements:e,rect:t,offsetParent:n,strategy:o}=i,r=o==="fixed",s=D(n),a=e?ge(e.floating):!1;if(n===s||a&&r)return t;let l={scrollLeft:0,scrollTop:0},d=O(1),c=O(0),p=$(n);if((p||!p&&!r)&&((X(n)!=="body"||ie(s))&&(l=ve(n)),$(n))){let u=ye(n);d=ne(n),c.x=u.x+n.clientLeft,c.y=u.y+n.clientTop}let h=s&&!p&&!r?Jt(s,l):O(0);return{width:t.width*d.x,height:t.height*d.y,x:t.x*d.x-l.scrollLeft*d.x+c.x+h.x,y:t.y*d.y-l.scrollTop*d.y+c.y+h.y}}function on(i){return Array.from(i.getClientRects())}function rn(i){let e=D(i),t=ve(i),n=i.ownerDocument.body,o=U(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=U(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),s=-t.scrollLeft+Ue(i),a=-t.scrollTop;return M(n).direction==="rtl"&&(s+=U(e.clientWidth,n.clientWidth)-o),{width:o,height:r,x:s,y:a}}var Ut=25;function sn(i,e){let t=T(i),n=D(i),o=t.visualViewport,r=n.clientWidth,s=n.clientHeight,a=0,l=0;if(o){r=o.width,s=o.height;let c=Ve();(!c||c&&e==="fixed")&&(a=o.offsetLeft,l=o.offsetTop)}let d=Ue(n);if(d<=0){let c=n.ownerDocument,p=c.body,h=getComputedStyle(p),u=c.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,f=Math.abs(n.clientWidth-p.clientWidth-u);f<=Ut&&(r-=f)}else d<=Ut&&(r+=d);return{width:r,height:s,x:a,y:l}}var an=new Set(["absolute","fixed"]);function ln(i,e){let t=ye(i,!0,e==="fixed"),n=t.top+i.clientTop,o=t.left+i.clientLeft,r=$(i)?ne(i):O(1),s=i.clientWidth*r.x,a=i.clientHeight*r.y,l=o*r.x,d=n*r.y;return{width:s,height:a,x:l,y:d}}function Wt(i,e,t){let n;if(e==="viewport")n=sn(i,t);else if(e==="document")n=rn(D(i));else if(I(e))n=ln(e,t);else{let o=Qt(i);n={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return J(n)}function Xt(i,e){let t=V(i);return t===e||!I(t)||G(t)?!1:M(t).position==="fixed"||Xt(t,e)}function cn(i,e){let t=e.get(i);if(t)return t;let n=Fe(i,[],!1).filter(a=>I(a)&&X(a)!=="body"),o=null,r=M(i).position==="fixed",s=r?V(i):i;for(;I(s)&&!G(s);){let a=M(s),l=Ne(s);!l&&a.position==="fixed"&&(o=null),(r?!l&&!o:!l&&a.position==="static"&&!!o&&an.has(o.position)||ie(s)&&!l&&Xt(i,s))?n=n.filter(c=>c!==s):o=a,s=V(s)}return e.set(i,n),n}function dn(i){let{element:e,boundary:t,rootBoundary:n,strategy:o}=i,s=[...t==="clippingAncestors"?ge(e)?[]:cn(e,this._c):[].concat(t),n],a=s[0],l=s.reduce((d,c)=>{let p=Wt(e,c,o);return d.top=U(p.top,d.top),d.right=he(p.right,d.right),d.bottom=he(p.bottom,d.bottom),d.left=U(p.left,d.left),d},Wt(e,a,o));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function pn(i){let{width:e,height:t}=Kt(i);return{width:e,height:t}}function hn(i,e,t){let n=$(e),o=D(e),r=t==="fixed",s=ye(i,!0,r,e),a={scrollLeft:0,scrollTop:0},l=O(0);function d(){l.x=Ue(o)}if(n||!n&&!r)if((X(e)!=="body"||ie(o))&&(a=ve(e)),n){let u=ye(e,!0,r,e);l.x=u.x+e.clientLeft,l.y=u.y+e.clientTop}else o&&d();r&&!n&&o&&d();let c=o&&!n&&!r?Jt(o,a):O(0),p=s.left+a.scrollLeft-l.x-c.x,h=s.top+a.scrollTop-l.y-c.y;return{x:p,y:h,width:s.width,height:s.height}}function nt(i){return M(i).position==="static"}function qt(i,e){if(!$(i)||M(i).position==="fixed")return null;if(e)return e(i);let t=i.offsetParent;return D(i)===t&&(t=t.ownerDocument.body),t}function Gt(i,e){let t=T(i);if(ge(i))return t;if(!$(i)){let o=V(i);for(;o&&!G(o);){if(I(o)&&!nt(o))return o;o=V(o)}return t}let n=qt(i,e);for(;n&&Nt(n)&&nt(n);)n=qt(n,e);return n&&G(n)&&nt(n)&&!Ne(n)?t:n||Vt(i)||t}var un=async function(i){let e=this.getOffsetParent||Gt,t=this.getDimensions,n=await t(i.floating);return{reference:hn(i.reference,await e(i.floating),i.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function fn(i){return M(i).direction==="rtl"}var mn={convertOffsetParentRelativeRectToViewportRelativeRect:nn,getDocumentElement:D,getClippingRect:dn,getOffsetParent:Gt,getElementRects:un,getClientRects:on,getDimensions:pn,getScale:ne,isElement:I,isRTL:fn};var Yt=Bt;var ei=Dt,ti=Rt;var ii=(i,e,t)=>{let n=new Map,o={platform:mn,...t},r={...o.platform,_c:n};return Pt(i,e,{...o,platform:r})};var We=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
...
`).length-1}handleInput(e){this.updatePreview(),this._notifyChange()}handleFocus(e){this.options.onFocus&&this.options.onFocus(e,this)}handleBlur(e){this.options.onBlur&&this.options.onBlur(e,this)}handleKeydown(e){if(e.key==="Tab"){let n=this.textarea.selectionStart,o=this.textarea.selectionEnd,r=this.textarea.value;if(e.shiftKey&&n===o)return;if(e.preventDefault(),n!==o&&e.shiftKey){let s=r.substring(0,n),a=r.substring(n,o),l=r.substring(o),c=a.split(`
`).map(p=>p.replace(/^  /,"")).join(`
`);document.execCommand?(this.textarea.setSelectionRange(n,o),document.execCommand("insertText",!1,c)):(this.textarea.value=s+c+l,this.textarea.selectionStart=n,this.textarea.selectionEnd=n+c.length)}else if(n!==o){let s=r.substring(0,n),a=r.substring(n,o),l=r.substring(o),c=a.split(`
`).map(p=>"  "+p).join(`
`);document.execCommand?(this.textarea.setSelectionRange(n,o),document.execCommand("insertText",!1,c)):(this.textarea.value=s+c+l,this.textarea.selectionStart=n,this.textarea.selectionEnd=n+c.length)}else document.execCommand?document.execCommand("insertText",!1,"  "):(this.textarea.value=r.substring(0,n)+"  "+r.substring(o),this.textarea.selectionStart=this.textarea.selectionEnd=n+2);this.textarea.dispatchEvent(new Event("input",{bubbles:!0}));return}if(e.key==="Enter"&&!e.shiftKey&&!e.metaKey&&!e.ctrlKey&&this.options.smartLists&&this.handleSmartListContinuation()){e.preventDefault();return}!this.shortcuts.handleKeydown(e)&&this.options.onKeydown&&this.options.onKeydown(e,this)}handleSmartListContinuation(){let e=this.textarea,t=e.selectionStart,n=E.getListContext(e.value,t);return!n||!n.inList?!1:n.content.trim()===""&&t>=n.markerEndPos?(this.deleteListMarker(n),!0):(t>n.markerEndPos&&t<n.lineEnd?this.splitListItem(n,t):this.insertNewListItem(n),n.listType==="numbered"&&this.scheduleNumberedListUpdate(),!0)}deleteListMarker(e){this.textarea.setSelectionRange(e.lineStart,e.markerEndPos),document.execCommand("delete"),this.textarea.dispatchEvent(new Event("input",{bubbles:!0}))}insertNewListItem(e){let t=E.createNewListItem(e);document.execCommand("insertText",!1,`
