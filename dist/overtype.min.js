...
`).length,"lines")}catch(p){E=!1,i&&console.log("execCommand threw error:",p)}o.contentEditable="false"}if(i&&(console.log("canInsertText before:",E),console.log("execCommand result:",E)),E){let p=l+e+s,h=o.value;i&&(console.log("Expected length:",p.length),console.log("Actual length:",h.length)),h!==p&&i&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(p.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!E)if(i&&console.log("Using manual insertion"),o.value===c){i&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(p){}o.value=l+e+s;try{document.execCommand("ms-endUndoUnit")}catch(p){}o.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else i&&console.log("Value was changed by execCommand, skipping manual insertion");i&&console.log("Setting selection range:",t,n),t!=null&&n!=null?o.setSelectionRange(t,n):o.setSelectionRange(r,o.selectionEnd),i&&(console.log("Final value length:",o.value.length),console.groupEnd())}function ne(o){return o.trim().split(`
...
`.repeat(2-a)),{newlinesToAppend:l,newlinesToPrepend:s}}function R(o,e,t={}){let n=o.selectionStart,i=o.selectionEnd,r=n===i,a=o.value,l=n;for(;l>0&&a[l-1]!==`
`;)l--;if(r){let c=n;for(;c<a.length&&a[c]!==`
`;)c++;o.selectionStart=l,o.selectionEnd=c}else se(o);let s=e(o);if(t.adjustSelection){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(d,n,i,l);s.selectionStart=p.start,s.selectionEnd=p.end}else if(t.prefix){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix);r?d?(s.selectionStart=Math.max(n-t.prefix.length,l),s.selectionEnd=s.selectionStart):(s.selectionStart=n+t.prefix.length,s.selectionEnd=s.selectionStart):d?(s.selectionStart=Math.max(n-t.prefix.length,l),s.selectionEnd=Math.max(i-t.prefix.length,l)):(s.selectionStart=n+t.prefix.length,s.selectionEnd=i+t.prefix.length)}return s}function F(o,e){let t,n,{prefix:i,suffix:r,blockPrefix:a,blockSuffix:l,replaceNext:s,prefixSpace:c,scanFor:d,surroundWithNewlines:p,trimFirst:h}=e,u=o.selectionStart,f=o.selectionEnd,g=o.value.slice(o.selectionStart,o.selectionEnd),m=ne(g)&&a&&a.length>0?`${a}
`:i,b=ne(g)&&l&&l.length>0?`
${l}`:r;if(c){let x=o.value[o.selectionStart-1];o.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(m=` ${m}`)}g=Ke(o,m,b,e.multiline);let y=o.selectionStart,k=o.selectionEnd,M=s&&s.length>0&&b.indexOf(s)>-1&&g.length>0;if(p){let x=J(o);t=x.newlinesToAppend,n=x.newlinesToPrepend,m=t+i,b+=n}if(g.startsWith(m)&&g.endsWith(b)){let x=g.slice(m.length,g.length-b.length);if(u===f){let C=u-m.length;C=Math.max(C,y),C=Math.min(C,y+x.length),y=k=C}else k=y+x.length;return{text:x,selectionStart:y,selectionEnd:k}}else if(M)if(d&&d.length>0&&g.match(d)){b=b.replace(s,g);let x=m+b;return y=k=y+m.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=m+g+b;return y=y+m.length+g.length+b.indexOf(s),k=y+s.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=m+g+b;y=u+m.length,k=f+m.length;let C=g.match(/^\s*|\s*$/g);if(h&&C){let G=C[0]||"",X=C[1]||"";x=G+m+g.trim()+b+X,y+=G.length,k-=X.length}return{text:x,selectionStart:y,selectionEnd:k}}}function ae(o,e){let{prefix:t,suffix:n,surroundWithNewlines:i}=e,r=o.value.slice(o.selectionStart,o.selectionEnd),a=o.selectionStart,l=o.selectionEnd,s=r.split(`
...
`).map((g,m)=>`${P(m,e.unorderedList)}${g}`),d=c.reduce((g,m,b)=>g+P(b,e.unorderedList).length,0),p=c.reduce((g,m,b)=>g+P(b,!e.unorderedList).length,0);if(a.processed)return t?(n=Math.max(n-P(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-d),{text:s,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=J(o),f=h+c.join(`
`)+u;return t?(n=Math.max(n+P(0,e.unorderedList).length+h.length,0),i=n):l.processed?(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d-p):(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d),{text:f,selectionStart:n,selectionEnd:i}}function le(o,e){let t=R(o,n=>Je(n,e),{adjustSelection:(n,i,r,a)=>{let l=o.value.slice(a,o.selectionEnd),s=/^\d+\.\s+/,c=/^- /,d=s.test(l),p=c.test(l),h=e.orderedList&&d||e.unorderedList&&p;if(i===r)if(h){let u=l.match(e.orderedList?s:c),f=u?u[0].length:0;return{start:Math.max(i-f,a),end:Math.max(i-f,a)}}else if(d||p){let u=l.match(d?s:c),f=u?u[0].length:0,m=(e.unorderedList?2:3)-f;return{start:i+m,end:i+m}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=l.match(e.orderedList?s:c),f=u?u[0].length:0;return{start:Math.max(i-f,a),end:Math.max(r-f,a)}}else if(d||p){let u=l.match(d?s:c),f=u?u[0].length:0,m=(e.unorderedList?2:3)-f;return{start:i+m,end:r+m}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});I(o,t)}function Qe(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),a=0,l="";for(let p of r){if(t>=a&&t<=a+p.length){l=p;break}a+=p.length+1}l.startsWith("- ")&&(l.startsWith("- [ ] ")||l.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(l)&&e.push("numbered-list"),l.startsWith("> ")&&e.push("quote"),l.startsWith("# ")&&e.push("header"),l.startsWith("## ")&&e.push("header-2"),l.startsWith("### ")&&e.push("header-3");let s=Math.max(0,t-10),c=Math.min(i.length,n+10),d=i.slice(s,c);if(d.includes("**")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(d.includes("_")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(d.includes("`")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(d.includes("[")&&d.includes("]")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&i.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function V(o){if(!o||o.disabled||o.readOnly)return;v("toggleBold","Starting"),z(o,"Before");let e=T(S.bold),t=F(o,e);re(t),I(o,t),z(o,"After")}function D(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.italic),t=F(o,e);I(o,t)}function ce(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.code),t=F(o,e);I(o,t)}function q(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=T(S.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let a=o.selectionStart;o.value=o.value.slice(0,a)+e.text+o.value.slice(a),o.selectionStart=a,o.selectionEnd=a+e.text.length}let r=F(o,n);I(o,r)}function U(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.bulletList);le(o,e)}function W(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.numberedList);le(o,e)}function pe(o){if(!o||o.disabled||o.readOnly)return;v("toggleQuote","Starting"),z(o,"Initial");let e=T(S.quote),t=R(o,n=>ae(n,e),{prefix:e.prefix});re(t),I(o,t),z(o,"Final")}function de(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.taskList),t=R(o,n=>ae(n,e),{prefix:e.prefix});I(o,t)}function Q(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),v("insertHeader","============ START ============"),v("insertHeader",`Level: ${e}, Toggle: ${t}`),v("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=T(S[n]||S.header1);v("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,a=o.selectionStart,l=o.selectionEnd,s=a;for(;s>0&&r[s-1]!==`
`;)s--;let c=l;for(;c<r.length&&r[c]!==`
`;)c++;let d=r.slice(s,c);v("insertHeader",`Current line (before): "${d}"`);let p=d.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;v("insertHeader","Existing header check:"),v("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),v("insertHeader",`  - Existing level: ${h}`),v("insertHeader",`  - Existing prefix length: ${u}`),v("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;v("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let g=R(o,m=>{let b=m.value.slice(m.selectionStart,m.selectionEnd);v("insertHeader",`Line in operation: "${b}"`);let y=b.replace(/^#{1,6}\s*/,"");v("insertHeader",`Cleaned line: "${y}"`);let k;return f?(v("insertHeader","ACTION: Toggling OFF - removing header"),k=y):h>0?(v("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=i.prefix+y):(v("insertHeader","ACTION: Adding new header"),k=i.prefix+y),v("insertHeader",`New line: "${k}"`),{text:k,selectionStart:m.selectionStart,selectionEnd:m.selectionEnd}},{prefix:i.prefix,adjustSelection:(m,b,y,k)=>{if(v("insertHeader","Adjusting selection:"),v("insertHeader",`  - isRemoving param: ${m}`),v("insertHeader",`  - shouldToggleOff: ${f}`),v("insertHeader",`  - selStart: ${b}, selEnd: ${y}`),v("insertHeader",`  - lineStartPos: ${k}`),f){let M=Math.max(b-u,k);return v("insertHeader",`  - Removing header, adjusting by -${u}`),{start:M,end:b===y?M:Math.max(y-u,k)}}else if(u>0){let M=i.prefix.length-u;return v("insertHeader",`  - Replacing header, adjusting by ${M}`),{start:b+M,end:y+M}}else return v("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:b+i.prefix.length,end:y+i.prefix.length}}});v("insertHeader",`Final result: text="${g.text}", cursor=${g.selectionStart}-${g.selectionEnd}`),v("insertHeader","============ END ============"),I(o,g)}function he(o){Q(o,1,!0)}function ue(o){Q(o,2,!0)}function me(o){Q(o,3,!0)}function fe(o){return Qe(o)}var N=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var $={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:$,cave:ve,light:$,dark:ve};function B(o){return typeof o=="string"?{...ye[o]||ye.solar,name:o}:o}function _(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
`)}function be(o,e={}){return{...o,colors:{...o.colors,...e}}}function we(o={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:a={}}=o,l=Object.keys(a).length>0?`
  ...
  `:"",s=r&&r.colors?_(r.colors):"";return`
