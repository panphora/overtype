...
`)}function G(o,e={}){return{...o,colors:{...o.colors,...e}}}function ne(o={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:s={}}=o,a=Object.keys(s).length>0?`
  ...
  `:"",c=r&&r.colors?_(r.colors):"";return`
...
`),i){let{newlinesToAppend:l,newlinesToPrepend:p}=Z(o);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function ae(o){let e=o.split(`
...
`),processed:n}}function F(o,e){return e?"- ":`${o+1}. `}function tt(o,e){let t,n,i;return o.orderedList?(t=ae(e),n=le(t.text),i=n.text):(t=le(e),n=ae(t.text),i=n.text),[t,n,i]}function nt(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;pe(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,a,c]=tt(e,r),d=c.split(`
`).map((f,v)=>`${F(v,e.unorderedList)}${f}`),l=d.reduce((f,v,y)=>f+F(y,e.unorderedList).length,0),p=d.reduce((f,v,y)=>f+F(y,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-F(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-l),{text:c,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:m}=Z(o),g=h+d.join(`
