...
`),i=0,r=0,s=0;for(let h=0;h<n.length;h++){let u=n[h].length;if(i+u>=t){r=h,s=i;break}i+=u+1}let a=n[r],l=s+a.length,p=a.match(this.LIST_PATTERNS.checkbox);if(p)return{inList:!0,listType:"checkbox",indent:p[1],marker:"-",checked:p[2]==="x",content:p[3],lineStart:s,lineEnd:l,markerEndPos:s+p[1].length+p[2].length+5};let d=a.match(this.LIST_PATTERNS.bullet);if(d)return{inList:!0,listType:"bullet",indent:d[1],marker:d[2],content:d[3],lineStart:s,lineEnd:l,markerEndPos:s+d[1].length+d[2].length+1};let c=a.match(this.LIST_PATTERNS.numbered);return c?{inList:!0,listType:"numbered",indent:c[1],marker:parseInt(c[2]),content:c[3],lineStart:s,lineEnd:l,markerEndPos:s+c[1].length+c[2].length+2}:{inList:!1,listType:null,indent:"",marker:null,content:a,lineStart:s,lineEnd:l,markerEndPos:s}}static createNewListItem(e){switch(e.listType){case"bullet":return`${e.indent}${e.marker} `;case"numbered":return`${e.indent}${e.marker+1}. `;case"checkbox":return`${e.indent}- [ ] `;default:return""}}static renumberLists(e){let t=e.split(`
`),n=new Map,i=!1;return t.map(s=>{let a=s.match(this.LIST_PATTERNS.numbered);if(a){let l=a[1],p=l.length,d=a[3];i||n.clear();let c=(n.get(p)||0)+1;n.set(p,c);for(let[h]of n)h>p&&n.delete(h);return i=!0,`${l}${c}. ${d}`}else return(s.trim()===""||!s.match(/^\s/))&&(i=!1,n.clear()),s}).join(`
`)}};$(L,"linkIndex",0),$(L,"LIST_PATTERNS",{bullet:/^(\s*)([-*+])\s+(.*)$/,numbered:/^(\s*)(\d+)\.\s+(.*)$/,checkbox:/^(\s*)-\s+\[([ x])\]\s+(.*)$/});var Re=Object.defineProperty,Y=Object.getOwnPropertySymbols,Fe=Object.prototype.hasOwnProperty,Ve=Object.prototype.propertyIsEnumerable,ee=(o,e,t)=>e in o?Re(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t,te=(o,e)=>{for(var t in e||(e={}))Fe.call(e,t)&&ee(o,t,e[t]);if(Y)for(var t of Y(e))Ve.call(e,t)&&ee(o,t,e[t]);return o},S={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function De(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function E(o){return te(te({},De()),o)}var _=!1;function qe(){return _}function v(o,e,t){_&&(console.group(`\u{1F50D} ${o}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function j(o,e){if(!_)return;let t=o.value.slice(o.selectionStart,o.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${o.selectionStart}-${o.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=o.value.slice(Math.max(0,o.selectionStart-10),o.selectionStart),i=o.value.slice(o.selectionEnd,Math.min(o.value.length,o.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(i)),console.groupEnd()}function re(o){_&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(o.text)),console.log("New selection:",`${o.selectionStart}-${o.selectionEnd}`),console.groupEnd())}var T=null;function H(o,{text:e,selectionStart:t,selectionEnd:n}){let i=qe();i&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${o.selectionStart}-${o.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),o.focus();let r=o.selectionStart,s=o.selectionEnd,a=o.value.slice(0,r),l=o.value.slice(s);i&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(l.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(o.value.slice(r,s))));let p=o.value,d=r!==s;if(T===null||T===!0){o.contentEditable="true";try{T=document.execCommand("insertText",!1,e),i&&console.log("execCommand returned:",T,"for text with",e.split(`
`).length,"lines")}catch(c){T=!1,i&&console.log("execCommand threw error:",c)}o.contentEditable="false"}if(i&&(console.log("canInsertText before:",T),console.log("execCommand result:",T)),T){let c=a+e+l,h=o.value;i&&(console.log("Expected length:",c.length),console.log("Actual length:",h.length)),h!==c&&i&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(c.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!T)if(i&&console.log("Using manual insertion"),o.value===p){i&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(c){}o.value=a+e+l;try{document.execCommand("ms-endUndoUnit")}catch(c){}o.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else i&&console.log("Value was changed by execCommand, skipping manual insertion");i&&console.log("Setting selection range:",t,n),t!=null&&n!=null?o.setSelectionRange(t,n):o.setSelectionRange(r,o.selectionEnd),i&&(console.log("Final value length:",o.value.length),console.groupEnd())}function ne(o){return o.trim().split(`
...
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:l}}function R(o,e,t={}){let n=o.selectionStart,i=o.selectionEnd,r=n===i,s=o.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let p=n;for(;p<s.length&&s[p]!==`
`;)p++;o.selectionStart=a,o.selectionEnd=p}else se(o);let l=e(o);if(t.adjustSelection){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix),c=t.adjustSelection(d,n,i,a);l.selectionStart=c.start,l.selectionEnd=c.end}else if(t.prefix){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix);r?d?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=n+t.prefix.length,l.selectionEnd=l.selectionStart):d?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=Math.max(i-t.prefix.length,a)):(l.selectionStart=n+t.prefix.length,l.selectionEnd=i+t.prefix.length)}return l}function F(o,e){let t,n,{prefix:i,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:p,scanFor:d,surroundWithNewlines:c,trimFirst:h}=e,u=o.selectionStart,m=o.selectionEnd,g=o.value.slice(o.selectionStart,o.selectionEnd),f=ne(g)&&s&&s.length>0?`${s}
`:i,b=ne(g)&&a&&a.length>0?`
${a}`:r;if(p){let x=o.value[o.selectionStart-1];o.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(f=` ${f}`)}g=Ke(o,f,b,e.multiline);let y=o.selectionStart,k=o.selectionEnd,M=l&&l.length>0&&b.indexOf(l)>-1&&g.length>0;if(c){let x=J(o);t=x.newlinesToAppend,n=x.newlinesToPrepend,f=t+i,b+=n}if(g.startsWith(f)&&g.endsWith(b)){let x=g.slice(f.length,g.length-b.length);if(u===m){let C=u-f.length;C=Math.max(C,y),C=Math.min(C,y+x.length),y=k=C}else k=y+x.length;return{text:x,selectionStart:y,selectionEnd:k}}else if(M)if(d&&d.length>0&&g.match(d)){b=b.replace(l,g);let x=f+b;return y=k=y+f.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+b;return y=y+f.length+g.length+b.indexOf(l),k=y+l.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+b;y=u+f.length,k=m+f.length;let C=g.match(/^\s*|\s*$/g);if(h&&C){let G=C[0]||"",X=C[1]||"";x=G+f+g.trim()+b+X,y+=G.length,k-=X.length}return{text:x,selectionStart:y,selectionEnd:k}}}function ae(o,e){let{prefix:t,suffix:n,surroundWithNewlines:i}=e,r=o.value.slice(o.selectionStart,o.selectionEnd),s=o.selectionStart,a=o.selectionEnd,l=r.split(`
...
`),i){let{newlinesToAppend:d,newlinesToPrepend:c}=J(o);s+=d.length,a=s+r.length,r=d+r+c}return{text:r,selectionStart:s,selectionEnd:a}}function oe(o){let e=o.split(`
...
`),processed:n}}function N(o,e){return e?"- ":`${o+1}. `}function Ze(o,e){let t,n,i;return o.orderedList?(t=oe(e),n=ie(t.text),i=n.text):(t=ie(e),n=oe(t.text),i=n.text),[t,n,i]}function Je(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;se(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,a,l]=Ze(e,r),p=l.split(`
`).map((g,f)=>`${N(f,e.unorderedList)}${g}`),d=p.reduce((g,f,b)=>g+N(b,e.unorderedList).length,0),c=p.reduce((g,f,b)=>g+N(b,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-N(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-d),{text:l,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=J(o),m=h+p.join(`
`)+u;return t?(n=Math.max(n+N(0,e.unorderedList).length+h.length,0),i=n):a.processed?(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d-c):(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d),{text:m,selectionStart:n,selectionEnd:i}}function le(o,e){let t=R(o,n=>Je(n,e),{adjustSelection:(n,i,r,s)=>{let a=o.value.slice(s,o.selectionEnd),l=/^\d+\.\s+/,p=/^- /,d=l.test(a),c=p.test(a),h=e.orderedList&&d||e.unorderedList&&c;if(i===r)if(h){let u=a.match(e.orderedList?l:p),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(i-m,s)}}else if(d||c){let u=a.match(d?l:p),m=u?u[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:i+f}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=a.match(e.orderedList?l:p),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(r-m,s)}}else if(d||c){let u=a.match(d?l:p),m=u?u[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:r+f}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});H(o,t)}function Qe(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),s=0,a="";for(let c of r){if(t>=s&&t<=s+c.length){a=c;break}s+=c.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,t-10),p=Math.min(i.length,n+10),d=i.slice(l,p);if(d.includes("**")){let c=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=c.lastIndexOf("**"),m=h.indexOf("**");u!==-1&&m!==-1&&e.push("bold")}if(d.includes("_")){let c=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=c.lastIndexOf("_"),m=h.indexOf("_");u!==-1&&m!==-1&&e.push("italic")}if(d.includes("`")){let c=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100));c.includes("`")&&h.includes("`")&&e.push("code")}if(d.includes("[")&&d.includes("]")){let c=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=c.lastIndexOf("["),m=h.indexOf("]");u!==-1&&m!==-1&&i.slice(n+m+1,n+m+10).startsWith("(")&&e.push("link")}return e}function V(o){if(!o||o.disabled||o.readOnly)return;v("toggleBold","Starting"),j(o,"Before");let e=E(S.bold),t=F(o,e);re(t),H(o,t),j(o,"After")}function D(o){if(!o||o.disabled||o.readOnly)return;let e=E(S.italic),t=F(o,e);H(o,t)}function ce(o){if(!o||o.disabled||o.readOnly)return;let e=E(S.code),t=F(o,e);H(o,t)}function q(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=E(S.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=o.selectionStart;o.value=o.value.slice(0,s)+e.text+o.value.slice(s),o.selectionStart=s,o.selectionEnd=s+e.text.length}let r=F(o,n);H(o,r)}function U(o){if(!o||o.disabled||o.readOnly)return;let e=E(S.bulletList);le(o,e)}function W(o){if(!o||o.disabled||o.readOnly)return;let e=E(S.numberedList);le(o,e)}function pe(o){if(!o||o.disabled||o.readOnly)return;v("toggleQuote","Starting"),j(o,"Initial");let e=E(S.quote),t=R(o,n=>ae(n,e),{prefix:e.prefix});re(t),H(o,t),j(o,"Final")}function de(o){if(!o||o.disabled||o.readOnly)return;let e=E(S.taskList),t=R(o,n=>ae(n,e),{prefix:e.prefix});H(o,t)}function Q(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),v("insertHeader","============ START ============"),v("insertHeader",`Level: ${e}, Toggle: ${t}`),v("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=E(S[n]||S.header1);v("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,s=o.selectionStart,a=o.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let p=a;for(;p<r.length&&r[p]!==`
`;)p++;let d=r.slice(l,p);v("insertHeader",`Current line (before): "${d}"`);let c=d.match(/^(#{1,6})\s*/),h=c?c[1].length:0,u=c?c[0].length:0;v("insertHeader","Existing header check:"),v("insertHeader",`  - Match: ${c?`"${c[0]}"`:"none"}`),v("insertHeader",`  - Existing level: ${h}`),v("insertHeader",`  - Existing prefix length: ${u}`),v("insertHeader",`  - Target level: ${e}`);let m=t&&h===e;v("insertHeader",`Should toggle OFF: ${m} (toggle=${t}, existingLevel=${h}, level=${e})`);let g=R(o,f=>{let b=f.value.slice(f.selectionStart,f.selectionEnd);v("insertHeader",`Line in operation: "${b}"`);let y=b.replace(/^#{1,6}\s*/,"");v("insertHeader",`Cleaned line: "${y}"`);let k;return m?(v("insertHeader","ACTION: Toggling OFF - removing header"),k=y):h>0?(v("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=i.prefix+y):(v("insertHeader","ACTION: Adding new header"),k=i.prefix+y),v("insertHeader",`New line: "${k}"`),{text:k,selectionStart:f.selectionStart,selectionEnd:f.selectionEnd}},{prefix:i.prefix,adjustSelection:(f,b,y,k)=>{if(v("insertHeader","Adjusting selection:"),v("insertHeader",`  - isRemoving param: ${f}`),v("insertHeader",`  - shouldToggleOff: ${m}`),v("insertHeader",`  - selStart: ${b}, selEnd: ${y}`),v("insertHeader",`  - lineStartPos: ${k}`),m){let M=Math.max(b-u,k);return v("insertHeader",`  - Removing header, adjusting by -${u}`),{start:M,end:b===y?M:Math.max(y-u,k)}}else if(u>0){let M=i.prefix.length-u;return v("insertHeader",`  - Replacing header, adjusting by ${M}`),{start:b+M,end:y+M}}else return v("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:b+i.prefix.length,end:y+i.prefix.length}}});v("insertHeader",`Final result: text="${g.text}", cursor=${g.selectionStart}-${g.selectionEnd}`),v("insertHeader","============ END ============"),H(o,g)}function he(o){Q(o,1,!0)}function ue(o){Q(o,2,!0)}function me(o){Q(o,3,!0)}function fe(o){return Qe(o)}var O=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var I={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:I,cave:ve,light:I,dark:ve};function P(o){return typeof o=="string"?{...ye[o]||ye.solar,name:o}:o}function B(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
