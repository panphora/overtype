...
`;)d++;t.selectionStart=a,t.selectionEnd=d}else tt(t);let c=e(t);if(n.adjustSelection){let l=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix),p=n.adjustSelection(l,o,i,a);c.selectionStart=p.start,c.selectionEnd=p.end}else if(n.prefix){let l=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix);r?l?(c.selectionStart=Math.max(o-n.prefix.length,a),c.selectionEnd=c.selectionStart):(c.selectionStart=o+n.prefix.length,c.selectionEnd=c.selectionStart):l?(c.selectionStart=Math.max(o-n.prefix.length,a),c.selectionEnd=Math.max(i-n.prefix.length,a)):(c.selectionStart=o+n.prefix.length,c.selectionEnd=i+n.prefix.length)}return c}function xe(t,e){let n,o,{prefix:i,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:c,prefixSpace:d,scanFor:l,surroundWithNewlines:p,trimFirst:h}=e,u=t.selectionStart,f=t.selectionEnd,m=t.value.slice(t.selectionStart,t.selectionEnd),g=Je(m)&&s&&s.length>0?`${s}
`:i,v=Je(m)&&a&&a.length>0?`
${a}`:r;if(d){let k=t.value[t.selectionStart-1];t.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(g=` ${g}`)}m=kn(t,g,v,e.multiline);let w=t.selectionStart,b=t.selectionEnd,L=c&&c.length>0&&v.indexOf(c)>-1&&m.length>0;if(p){let k=$e(t);n=k.newlinesToAppend,o=k.newlinesToPrepend,g=n+i,v+=o}if(m.startsWith(g)&&m.endsWith(v)){let k=m.slice(g.length,m.length-v.length);if(u===f){let S=u-g.length;S=Math.max(S,w),S=Math.min(S,w+k.length),w=b=S}else b=w+k.length;return{text:k,selectionStart:w,selectionEnd:b}}else if(L)if(l&&l.length>0&&m.match(l)){v=v.replace(c,m);let k=g+v;return w=b=w+g.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+v;return w=w+g.length+m.length+v.indexOf(c),b=w+c.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+v;w=u+g.length,b=f+g.length;let S=m.match(/^\s*|\s*$/g);if(h&&S){let me=S[0]||"",Y=S[1]||"";k=me+g+m.trim()+v+Y,w+=me.length,b-=Y.length}return{text:k,selectionStart:w,selectionEnd:b}}}function nt(t,e){let{prefix:n,suffix:o,surroundWithNewlines:i}=e,r=t.value.slice(t.selectionStart,t.selectionEnd),s=t.selectionStart,a=t.selectionEnd,c=r.split(`
...
`),i){let{newlinesToAppend:l,newlinesToPrepend:p}=$e(t);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function Xe(t){let e=t.split(`
`),n=/^\d+\.\s+/,o=e.every(r=>n.test(r)),i=e;return o&&(i=e.map(r=>r.replace(n,""))),{text:i.join(`
`),processed:o}}function Ye(t){let e=t.split(`
`),n="- ",o=e.every(r=>r.startsWith(n)),i=e;return o&&(i=e.map(r=>r.slice(n.length))),{text:i.join(`
`),processed:o}}function se(t,e){return e?"- ":`${t+1}. `}function Ln(t,e){let n,o,i;return t.orderedList?(n=Xe(e),o=Ye(n.text),i=o.text):(n=Ye(e),o=Xe(n.text),i=o.text),[n,o,i]}function Sn(t,e){let n=t.selectionStart===t.selectionEnd,o=t.selectionStart,i=t.selectionEnd;tt(t);let r=t.value.slice(t.selectionStart,t.selectionEnd),[s,a,c]=Ln(e,r),d=c.split(`
`).map((m,g)=>`${se(g,e.unorderedList)}${m}`),l=d.reduce((m,g,v)=>m+se(v,e.unorderedList).length,0),p=d.reduce((m,g,v)=>m+se(v,!e.unorderedList).length,0);if(s.processed)return n?(o=Math.max(o-se(0,e.unorderedList).length,0),i=o):(o=t.selectionStart,i=t.selectionEnd-l),{text:c,selectionStart:o,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=$e(t),f=h+d.join(`
`)+u;return n?(o=Math.max(o+se(0,e.unorderedList).length+h.length,0),i=o):a.processed?(o=Math.max(t.selectionStart+h.length,0),i=t.selectionEnd+h.length+l-p):(o=Math.max(t.selectionStart+h.length,0),i=t.selectionEnd+h.length+l),{text:f,selectionStart:o,selectionEnd:i}}function ot(t,e){let n=be(t,o=>Sn(o,e),{adjustSelection:(o,i,r,s)=>{let a=t.value.slice(s,t.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),h=e.orderedList&&l||e.unorderedList&&p;if(i===r)if(h){let u=a.match(e.orderedList?c:d),f=u?u[0].length:0;return{start:Math.max(i-f,s),end:Math.max(i-f,s)}}else if(l||p){let u=a.match(l?c:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:i+g,end:i+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=a.match(e.orderedList?c:d),f=u?u[0].length:0;return{start:Math.max(i-f,s),end:Math.max(r-f,s)}}else if(l||p){let u=a.match(l?c:d),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:i+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});W(t,n)}function En(t){if(!t)return[];let e=[],{selectionStart:n,selectionEnd:o,value:i}=t,r=i.split(`
`),s=0,a="";for(let p of r){if(n>=s&&n<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let c=Math.max(0,n-10),d=Math.min(i.length,o+10),l=i.slice(c,d);if(l.includes("**")){let p=i.slice(Math.max(0,n-100),n),h=i.slice(o,Math.min(i.length,o+100)),u=p.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(l.includes("_")){let p=i.slice(Math.max(0,n-100),n),h=i.slice(o,Math.min(i.length,o+100)),u=p.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(l.includes("`")){let p=i.slice(Math.max(0,n-100),n),h=i.slice(o,Math.min(i.length,o+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let p=i.slice(Math.max(0,n-100),n),h=i.slice(o,Math.min(i.length,o+100)),u=p.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&i.slice(o+f+1,o+f+10).startsWith("(")&&e.push("link")}return e}function it(t){if(!t||t.disabled||t.readOnly)return;x("toggleBold","Starting"),ye(t,"Before");let e=_(R.bold),n=xe(t,e);et(n),W(t,n),ye(t,"After")}function rt(t){if(!t||t.disabled||t.readOnly)return;let e=_(R.italic),n=xe(t,e);W(t,n)}function st(t){if(!t||t.disabled||t.readOnly)return;let e=_(R.code),n=xe(t,e);W(t,n)}function at(t,e={}){if(!t||t.disabled||t.readOnly)return;let n=t.value.slice(t.selectionStart,t.selectionEnd),o=_(R.link);if(n&&n.match(/^https?:\/\//)&&!e.url?(o.suffix=`](${n})`,o.replaceNext=""):e.url&&(o.suffix=`](${e.url})`,o.replaceNext=""),e.text&&!n){let s=t.selectionStart;t.value=t.value.slice(0,s)+e.text+t.value.slice(s),t.selectionStart=s,t.selectionEnd=s+e.text.length}let r=xe(t,o);W(t,r)}function lt(t){if(!t||t.disabled||t.readOnly)return;let e=_(R.bulletList);ot(t,e)}function ct(t){if(!t||t.disabled||t.readOnly)return;let e=_(R.numberedList);ot(t,e)}function pt(t){if(!t||t.disabled||t.readOnly)return;x("toggleQuote","Starting"),ye(t,"Initial");let e=_(R.quote),n=be(t,o=>nt(o,e),{prefix:e.prefix});et(n),W(t,n),ye(t,"Final")}function Re(t){if(!t||t.disabled||t.readOnly)return;let e=_(R.taskList),n=be(t,o=>nt(o,e),{prefix:e.prefix});W(t,n)}function Be(t,e=1,n=!1){if(!t||t.disabled||t.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${n}`),x("insertHeader",`Initial cursor: ${t.selectionStart}-${t.selectionEnd}`);let o=`header${e===1?"1":e}`,i=_(R[o]||R.header1);x("insertHeader",`Style prefix: "${i.prefix}"`);let r=t.value,s=t.selectionStart,a=t.selectionEnd,c=s;for(;c>0&&r[c-1]!==`
`;)c--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(c,d);x("insertHeader",`Current line (before): "${l}"`);let p=l.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${h}`),x("insertHeader",`  - Existing prefix length: ${u}`),x("insertHeader",`  - Target level: ${e}`);let f=n&&h===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${n}, existingLevel=${h}, level=${e})`);let m=be(t,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);x("insertHeader",`Line in operation: "${v}"`);let w=v.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${w}"`);let b;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),b=w):h>0?(x("insertHeader",`ACTION: Replacing H${h} with H${e}`),b=i.prefix+w):(x("insertHeader","ACTION: Adding new header"),b=i.prefix+w),x("insertHeader",`New line: "${b}"`),{text:b,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:i.prefix,adjustSelection:(g,v,w,b)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${g}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${v}, selEnd: ${w}`),x("insertHeader",`  - lineStartPos: ${b}`),f){let L=Math.max(v-u,b);return x("insertHeader",`  - Removing header, adjusting by -${u}`),{start:L,end:v===w?L:Math.max(w-u,b)}}else if(u>0){let L=i.prefix.length-u;return x("insertHeader",`  - Replacing header, adjusting by ${L}`),{start:v+L,end:w+L}}else return x("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:v+i.prefix.length,end:w+i.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),W(t,m)}function dt(t){Be(t,1,!0)}function ut(t){Be(t,2,!0)}function ht(t){Be(t,3,!0)}function ft(t){return En(t)}var ke=class{constructor(e,n={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=n.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let n=this.createSeparator();this.container.appendChild(n)}else{let n=this.createButton(e);this.buttons[e.name]=n,this.container.appendChild(n)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let n=document.createElement("button");return n.className="overtype-toolbar-button",n.type="button",n.setAttribute("data-button",e.name),n.title=e.title||"",n.setAttribute("aria-label",e.title||e.name),n.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(n.classList.add("has-dropdown"),n.dataset.dropdown="true",n.addEventListener("click",o=>{o.preventDefault(),this.toggleViewModeDropdown(n)}),n):(n._clickHandler=o=>{o.preventDefault();let i=e.actionId||e.name;this.editor.performAction(i,o)},n.addEventListener("click",n._clickHandler),n)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:n=>this.editor.setValue(n),event:null}),!0}catch(n){return console.error(`Action "${e.name}" error:`,n),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:n}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){let n=document.querySelector(".overtype-dropdown-menu");if(n){n.remove(),e.classList.remove("dropdown-active");return}e.classList.add("dropdown-active");let o=this.createViewModeDropdown(e),i=e.getBoundingClientRect();o.style.position="absolute",o.style.top=`${i.bottom+5}px`,o.style.left=`${i.left}px`,document.body.appendChild(o),this.handleDocumentClick=r=>{!o.contains(r.target)&&!e.contains(r.target)&&(o.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createViewModeDropdown(e){let n=document.createElement("div");n.className="overtype-dropdown-menu";let o=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],i=this.editor.container.dataset.mode||"normal";return o.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.textContent=r.label,r.id===i){s.classList.add("active"),s.setAttribute("aria-current","true");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),n.appendChild(s)}),n}updateButtonStates(){var e;try{let n=((e=ft)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([o,i])=>{if(o==="viewMode")return;let r=!1;switch(o){case"bold":r=n.includes("bold");break;case"italic":r=n.includes("italic");break;case"code":r=!1;break;case"bulletList":r=n.includes("bullet-list");break;case"orderedList":r=n.includes("numbered-list");break;case"taskList":r=n.includes("task-list");break;case"quote":r=n.includes("quote");break;case"h1":r=n.includes("header");break;case"h2":r=n.includes("header-2");break;case"h3":r=n.includes("header-3");break}i.classList.toggle("active",r),i.setAttribute("aria-pressed",r.toString())})}catch(n){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var le=Math.min,q=Math.max,ce=Math.round;var P=t=>({x:t,y:t}),Tn={left:"right",right:"left",bottom:"top",top:"bottom"},Cn={start:"end",end:"start"};function Ie(t,e,n){return q(t,le(e,n))}function pe(t,e){return typeof t=="function"?t(e):t}function U(t){return t.split("-")[0]}function de(t){return t.split("-")[1]}function Ne(t){return t==="x"?"y":"x"}function _e(t){return t==="y"?"height":"width"}var An=new Set(["top","bottom"]);function z(t){return An.has(U(t))?"y":"x"}function ze(t){return Ne(z(t))}function yt(t,e,n){n===void 0&&(n=!1);let o=de(t),i=ze(t),r=_e(i),s=i==="x"?o===(n?"end":"start")?"right":"left":o==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=ae(s)),[s,ae(s)]}function wt(t){let e=ae(t);return[Le(t),e,Le(e)]}function Le(t){return t.replace(/start|end/g,e=>Cn[e])}var gt=["left","right"],vt=["right","left"],Mn=["top","bottom"],On=["bottom","top"];function Hn(t,e,n){switch(t){case"top":case"bottom":return n?e?vt:gt:e?gt:vt;case"left":case"right":return e?Mn:On;default:return[]}}function bt(t,e,n,o){let i=de(t),r=Hn(U(t),n==="start",o);return i&&(r=r.map(s=>s+"-"+i),e&&(r=r.concat(r.map(Le)))),r}function ae(t){return t.replace(/left|right|bottom|top/g,e=>Tn[e])}function Pn(t){return{top:0,right:0,bottom:0,left:0,...t}}function xt(t){return typeof t!="number"?Pn(t):{top:t,right:t,bottom:t,left:t}}function G(t){let{x:e,y:n,width:o,height:i}=t;return{width:o,height:i,top:n,left:e,right:e+o,bottom:n+i,x:e,y:n}}function kt(t,e,n){let{reference:o,floating:i}=t,r=z(e),s=ze(e),a=_e(s),c=U(e),d=r==="y",l=o.x+o.width/2-i.width/2,p=o.y+o.height/2-i.height/2,h=o[a]/2-i[a]/2,u;switch(c){case"top":u={x:l,y:o.y-i.height};break;case"bottom":u={x:l,y:o.y+o.height};break;case"right":u={x:o.x+o.width,y:p};break;case"left":u={x:o.x-i.width,y:p};break;default:u={x:o.x,y:o.y}}switch(de(e)){case"start":u[s]-=h*(n&&d?-1:1);break;case"end":u[s]+=h*(n&&d?-1:1);break}return u}async function Lt(t,e){var n;e===void 0&&(e={});let{x:o,y:i,platform:r,rects:s,elements:a,strategy:c}=t,{boundary:d="clippingAncestors",rootBoundary:l="viewport",elementContext:p="floating",altBoundary:h=!1,padding:u=0}=pe(e,t),f=xt(u),g=a[h?p==="floating"?"reference":"floating":p],v=G(await r.getClippingRect({element:(n=await(r.isElement==null?void 0:r.isElement(g)))==null||n?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:d,rootBoundary:l,strategy:c})),w=p==="floating"?{x:o,y:i,width:s.floating.width,height:s.floating.height}:s.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),L=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},k=G(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:b,strategy:c}):w);return{top:(v.top-k.top+f.top)/L.y,bottom:(k.bottom-v.bottom+f.bottom)/L.y,left:(v.left-k.left+f.left)/L.x,right:(k.right-v.right+f.right)/L.x}}var St=async(t,e,n)=>{let{placement:o="bottom",strategy:i="absolute",middleware:r=[],platform:s}=n,a=r.filter(Boolean),c=await(s.isRTL==null?void 0:s.isRTL(e)),d=await s.getElementRects({reference:t,floating:e,strategy:i}),{x:l,y:p}=kt(d,o,c),h=o,u={},f=0;for(let g=0;g<a.length;g++){var m;let{name:v,fn:w}=a[g],{x:b,y:L,data:k,reset:S}=await w({x:l,y:p,initialPlacement:o,placement:h,strategy:i,middlewareData:u,rects:d,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:Lt},elements:{reference:t,floating:e}});l=b!=null?b:l,p=L!=null?L:p,u={...u,[v]:{...u[v],...k}},S&&f<=50&&(f++,typeof S=="object"&&(S.placement&&(h=S.placement),S.rects&&(d=S.rects===!0?await s.getElementRects({reference:t,floating:e,strategy:i}):S.rects),{x:l,y:p}=kt(d,h,c)),g=-1)}return{x:l,y:p,placement:h,strategy:i,middlewareData:u}};var Et=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var n,o;let{placement:i,middlewareData:r,rects:s,initialPlacement:a,platform:c,elements:d}=e,{mainAxis:l=!0,crossAxis:p=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=pe(t,e);if((n=r.arrow)!=null&&n.alignmentOffset)return{};let v=U(i),w=z(a),b=U(a)===a,L=await(c.isRTL==null?void 0:c.isRTL(d.floating)),k=h||(b||!m?[ae(a)]:wt(a)),S=f!=="none";!h&&S&&k.push(...bt(a,m,f,L));let me=[a,...k],Y=await c.detectOverflow(e,g),ge=[],ee=((o=r.flip)==null?void 0:o.overflows)||[];if(l&&ge.push(Y[v]),p){let K=yt(i,s,L);ge.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:i,overflows:ge}],!ge.every(K=>K<=0)){var De,je;let K=(((De=r.flip)==null?void 0:De.index)||0)+1,He=me[K];if(He&&(!(p==="alignment"?w!==z(He):!1)||ee.every(H=>z(H.placement)===w?H.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:He}};let ie=(je=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,H)=>Z.overflows[1]-H.overflows[1])[0])==null?void 0:je.placement;if(!ie)switch(u){case"bestFit":{var Ve;let Z=(Ve=ee.filter(H=>{if(S){let j=z(H.placement);return j===w||j==="y"}return!0}).map(H=>[H.placement,H.overflows.filter(j=>j>0).reduce((j,an)=>j+an,0)]).sort((H,j)=>H[1]-j[1])[0])==null?void 0:Ve[0];Z&&(ie=Z);break}case"initialPlacement":ie=a;break}if(i!==ie)return{reset:{placement:ie}}}return{}}}};var $n=new Set(["left","top"]);async function Rn(t,e){let{placement:n,platform:o,elements:i}=t,r=await(o.isRTL==null?void 0:o.isRTL(i.floating)),s=U(n),a=de(n),c=z(n)==="y",d=$n.has(s)?-1:1,l=r&&c?-1:1,p=pe(e,t),{mainAxis:h,crossAxis:u,alignmentAxis:f}=typeof p=="number"?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return a&&typeof f=="number"&&(u=a==="end"?f*-1:f),c?{x:u*l,y:h*d}:{x:h*d,y:u*l}}var Tt=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var n,o;let{x:i,y:r,placement:s,middlewareData:a}=e,c=await Rn(e,t);return s===((n=a.offset)==null?void 0:n.placement)&&(o=a.arrow)!=null&&o.alignmentOffset?{}:{x:i+c.x,y:r+c.y,data:{...c,placement:s}}}}},Ct=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:n,y:o,placement:i,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:c={fn:v=>{let{x:w,y:b}=v;return{x:w,y:b}}},...d}=pe(t,e),l={x:n,y:o},p=await r.detectOverflow(e,d),h=z(U(i)),u=Ne(h),f=l[u],m=l[h];if(s){let v=u==="y"?"top":"left",w=u==="y"?"bottom":"right",b=f+p[v],L=f-p[w];f=Ie(b,f,L)}if(a){let v=h==="y"?"top":"left",w=h==="y"?"bottom":"right",b=m+p[v],L=m-p[w];m=Ie(b,m,L)}let g=c.fn({...e,[u]:f,[h]:m});return{...g,data:{x:g.x-n,y:g.y-o,enabled:{[u]:s,[h]:a}}}}}};function Ee(){return typeof window<"u"}function J(t){return Mt(t)?(t.nodeName||"").toLowerCase():"#document"}function A(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function B(t){var e;return(e=(Mt(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function Mt(t){return Ee()?t instanceof Node||t instanceof A(t).Node:!1}function M(t){return Ee()?t instanceof Element||t instanceof A(t).Element:!1}function $(t){return Ee()?t instanceof HTMLElement||t instanceof A(t).HTMLElement:!1}function At(t){return!Ee()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof A(t).ShadowRoot}var Bn=new Set(["inline","contents"]);function te(t){let{overflow:e,overflowX:n,overflowY:o,display:i}=O(t);return/auto|scroll|overlay|hidden|clip/.test(e+o+n)&&!Bn.has(i)}var In=new Set(["table","td","th"]);function Ot(t){return In.has(J(t))}var Nn=[":popover-open",":modal"];function ue(t){return Nn.some(e=>{try{return t.matches(e)}catch(n){return!1}})}var _n=["transform","translate","scale","rotate","perspective"],zn=["transform","translate","scale","rotate","perspective","filter"],Fn=["paint","layout","strict","content"];function Te(t){let e=Ce(),n=M(t)?O(t):t;return _n.some(o=>n[o]?n[o]!=="none":!1)||(n.containerType?n.containerType!=="normal":!1)||!e&&(n.backdropFilter?n.backdropFilter!=="none":!1)||!e&&(n.filter?n.filter!=="none":!1)||zn.some(o=>(n.willChange||"").includes(o))||Fn.some(o=>(n.contain||"").includes(o))}function Ht(t){let e=F(t);for(;$(e)&&!X(e);){if(Te(e))return e;if(ue(e))return null;e=F(e)}return null}function Ce(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Dn=new Set(["html","body","#document"]);function X(t){return Dn.has(J(t))}function O(t){return A(t).getComputedStyle(t)}function he(t){return M(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function F(t){if(J(t)==="html")return t;let e=t.assignedSlot||t.parentNode||At(t)&&t.host||B(t);return At(e)?e.host:e}function Pt(t){let e=F(t);return X(e)?t.ownerDocument?t.ownerDocument.body:t.body:$(e)&&te(e)?e:Pt(e)}function Se(t,e,n){var o;e===void 0&&(e=[]),n===void 0&&(n=!0);let i=Pt(t),r=i===((o=t.ownerDocument)==null?void 0:o.body),s=A(i);if(r){let a=Ae(s);return e.concat(s,s.visualViewport||[],te(i)?i:[],a&&n?Se(a):[])}return e.concat(i,Se(i,[],n))}function Ae(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function It(t){let e=O(t),n=parseFloat(e.width)||0,o=parseFloat(e.height)||0,i=$(t),r=i?t.offsetWidth:n,s=i?t.offsetHeight:o,a=ce(n)!==r||ce(o)!==s;return a&&(n=r,o=s),{width:n,height:o,$:a}}function Nt(t){return M(t)?t:t.contextElement}function ne(t){let e=Nt(t);if(!$(e))return P(1);let n=e.getBoundingClientRect(),{width:o,height:i,$:r}=It(e),s=(r?ce(n.width):n.width)/o,a=(r?ce(n.height):n.height)/i;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var jn=P(0);function _t(t){let e=A(t);return!Ce()||!e.visualViewport?jn:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Vn(t,e,n){return e===void 0&&(e=!1),!n||e&&n!==A(t)?!1:e}function fe(t,e,n,o){e===void 0&&(e=!1),n===void 0&&(n=!1);let i=t.getBoundingClientRect(),r=Nt(t),s=P(1);e&&(o?M(o)&&(s=ne(o)):s=ne(t));let a=Vn(r,n,o)?_t(r):P(0),c=(i.left+a.x)/s.x,d=(i.top+a.y)/s.y,l=i.width/s.x,p=i.height/s.y;if(r){let h=A(r),u=o&&M(o)?A(o):o,f=h,m=Ae(f);for(;m&&o&&u!==f;){let g=ne(m),v=m.getBoundingClientRect(),w=O(m),b=v.left+(m.clientLeft+parseFloat(w.paddingLeft))*g.x,L=v.top+(m.clientTop+parseFloat(w.paddingTop))*g.y;c*=g.x,d*=g.y,l*=g.x,p*=g.y,c+=b,d+=L,f=A(m),m=Ae(f)}}return G({width:l,height:p,x:c,y:d})}function Me(t,e){let n=he(t).scrollLeft;return e?e.left+n:fe(B(t)).left+n}function zt(t,e){let n=t.getBoundingClientRect(),o=n.left+e.scrollLeft-Me(t,n),i=n.top+e.scrollTop;return{x:o,y:i}}function Wn(t){let{elements:e,rect:n,offsetParent:o,strategy:i}=t,r=i==="fixed",s=B(o),a=e?ue(e.floating):!1;if(o===s||a&&r)return n;let c={scrollLeft:0,scrollTop:0},d=P(1),l=P(0),p=$(o);if((p||!p&&!r)&&((J(o)!=="body"||te(s))&&(c=he(o)),$(o))){let u=fe(o);d=ne(o),l.x=u.x+o.clientLeft,l.y=u.y+o.clientTop}let h=s&&!p&&!r?zt(s,c):P(0);return{width:n.width*d.x,height:n.height*d.y,x:n.x*d.x-c.scrollLeft*d.x+l.x+h.x,y:n.y*d.y-c.scrollTop*d.y+l.y+h.y}}function qn(t){return Array.from(t.getClientRects())}function Un(t){let e=B(t),n=he(t),o=t.ownerDocument.body,i=q(e.scrollWidth,e.clientWidth,o.scrollWidth,o.clientWidth),r=q(e.scrollHeight,e.clientHeight,o.scrollHeight,o.clientHeight),s=-n.scrollLeft+Me(t),a=-n.scrollTop;return O(o).direction==="rtl"&&(s+=q(e.clientWidth,o.clientWidth)-i),{width:i,height:r,x:s,y:a}}var $t=25;function Kn(t,e){let n=A(t),o=B(t),i=n.visualViewport,r=o.clientWidth,s=o.clientHeight,a=0,c=0;if(i){r=i.width,s=i.height;let l=Ce();(!l||l&&e==="fixed")&&(a=i.offsetLeft,c=i.offsetTop)}let d=Me(o);if(d<=0){let l=o.ownerDocument,p=l.body,h=getComputedStyle(p),u=l.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,f=Math.abs(o.clientWidth-p.clientWidth-u);f<=$t&&(r-=f)}else d<=$t&&(r+=d);return{width:r,height:s,x:a,y:c}}var Zn=new Set(["absolute","fixed"]);function Qn(t,e){let n=fe(t,!0,e==="fixed"),o=n.top+t.clientTop,i=n.left+t.clientLeft,r=$(t)?ne(t):P(1),s=t.clientWidth*r.x,a=t.clientHeight*r.y,c=i*r.x,d=o*r.y;return{width:s,height:a,x:c,y:d}}function Rt(t,e,n){let o;if(e==="viewport")o=Kn(t,n);else if(e==="document")o=Un(B(t));else if(M(e))o=Qn(e,n);else{let i=_t(t);o={x:e.x-i.x,y:e.y-i.y,width:e.width,height:e.height}}return G(o)}function Ft(t,e){let n=F(t);return n===e||!M(n)||X(n)?!1:O(n).position==="fixed"||Ft(n,e)}function Gn(t,e){let n=e.get(t);if(n)return n;let o=Se(t,[],!1).filter(a=>M(a)&&J(a)!=="body"),i=null,r=O(t).position==="fixed",s=r?F(t):t;for(;M(s)&&!X(s);){let a=O(s),c=Te(s);!c&&a.position==="fixed"&&(i=null),(r?!c&&!i:!c&&a.position==="static"&&!!i&&Zn.has(i.position)||te(s)&&!c&&Ft(t,s))?o=o.filter(l=>l!==s):i=a,s=F(s)}return e.set(t,o),o}function Jn(t){let{element:e,boundary:n,rootBoundary:o,strategy:i}=t,s=[...n==="clippingAncestors"?ue(e)?[]:Gn(e,this._c):[].concat(n),o],a=s[0],c=s.reduce((d,l)=>{let p=Rt(e,l,i);return d.top=q(p.top,d.top),d.right=le(p.right,d.right),d.bottom=le(p.bottom,d.bottom),d.left=q(p.left,d.left),d},Rt(e,a,i));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function Xn(t){let{width:e,height:n}=It(t);return{width:e,height:n}}function Yn(t,e,n){let o=$(e),i=B(e),r=n==="fixed",s=fe(t,!0,r,e),a={scrollLeft:0,scrollTop:0},c=P(0);function d(){c.x=Me(i)}if(o||!o&&!r)if((J(e)!=="body"||te(i))&&(a=he(e)),o){let u=fe(e,!0,r,e);c.x=u.x+e.clientLeft,c.y=u.y+e.clientTop}else i&&d();r&&!o&&i&&d();let l=i&&!o&&!r?zt(i,a):P(0),p=s.left+a.scrollLeft-c.x-l.x,h=s.top+a.scrollTop-c.y-l.y;return{x:p,y:h,width:s.width,height:s.height}}function Fe(t){return O(t).position==="static"}function Bt(t,e){if(!$(t)||O(t).position==="fixed")return null;if(e)return e(t);let n=t.offsetParent;return B(t)===n&&(n=n.ownerDocument.body),n}function Dt(t,e){let n=A(t);if(ue(t))return n;if(!$(t)){let i=F(t);for(;i&&!X(i);){if(M(i)&&!Fe(i))return i;i=F(i)}return n}let o=Bt(t,e);for(;o&&Ot(o)&&Fe(o);)o=Bt(o,e);return o&&X(o)&&Fe(o)&&!Te(o)?n:o||Ht(t)||n}var eo=async function(t){let e=this.getOffsetParent||Dt,n=this.getDimensions,o=await n(t.floating);return{reference:Yn(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function to(t){return O(t).direction==="rtl"}var no={convertOffsetParentRelativeRectToViewportRelativeRect:Wn,getDocumentElement:B,getClippingRect:Jn,getOffsetParent:Dt,getElementRects:eo,getClientRects:qn,getDimensions:Xn,getScale:ne,isElement:M,isRTL:to};var jt=Tt;var Vt=Ct,Wt=Et;var qt=(t,e,n)=>{let o=new Map,i={platform:no,...n},r={...i.platform,_c:o};return St(t,e,{...i,platform:r})};var Oe=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
