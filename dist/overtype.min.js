...
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:c}}function R(o,e,t={}){let n=o.selectionStart,i=o.selectionEnd,r=n===i,s=o.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let d=n;for(;d<s.length&&s[d]!==`
`;)d++;o.selectionStart=a,o.selectionEnd=d}else se(o);let c=e(o);if(t.adjustSelection){let l=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(l,n,i,a);c.selectionStart=p.start,c.selectionEnd=p.end}else if(t.prefix){let l=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix);r?l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=c.selectionStart):(c.selectionStart=n+t.prefix.length,c.selectionEnd=c.selectionStart):l?(c.selectionStart=Math.max(n-t.prefix.length,a),c.selectionEnd=Math.max(i-t.prefix.length,a)):(c.selectionStart=n+t.prefix.length,c.selectionEnd=i+t.prefix.length)}return c}function F(o,e){let t,n,{prefix:i,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:c,prefixSpace:d,scanFor:l,surroundWithNewlines:p,trimFirst:h}=e,u=o.selectionStart,m=o.selectionEnd,f=o.value.slice(o.selectionStart,o.selectionEnd),g=ne(f)&&s&&s.length>0?`${s}
`:i,v=ne(f)&&a&&a.length>0?`
${a}`:r;if(d){let x=o.value[o.selectionStart-1];o.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(g=` ${g}`)}f=Ke(o,g,v,e.multiline);let b=o.selectionStart,k=o.selectionEnd,M=c&&c.length>0&&v.indexOf(c)>-1&&f.length>0;if(p){let x=J(o);t=x.newlinesToAppend,n=x.newlinesToPrepend,g=t+i,v+=n}if(f.startsWith(g)&&f.endsWith(v)){let x=f.slice(g.length,f.length-v.length);if(u===m){let C=u-g.length;C=Math.max(C,b),C=Math.min(C,b+x.length),b=k=C}else k=b+x.length;return{text:x,selectionStart:b,selectionEnd:k}}else if(M)if(l&&l.length>0&&f.match(l)){v=v.replace(c,f);let x=g+v;return b=k=b+g.length,{text:x,selectionStart:b,selectionEnd:k}}else{let x=g+f+v;return b=b+g.length+f.length+v.indexOf(c),k=b+c.length,{text:x,selectionStart:b,selectionEnd:k}}else{let x=g+f+v;b=u+g.length,k=m+g.length;let C=f.match(/^\s*|\s*$/g);if(h&&C){let G=C[0]||"",X=C[1]||"";x=G+g+f.trim()+v+X,b+=G.length,k-=X.length}return{text:x,selectionStart:b,selectionEnd:k}}}function ae(o,e){let{prefix:t,suffix:n,surroundWithNewlines:i}=e,r=o.value.slice(o.selectionStart,o.selectionEnd),s=o.selectionStart,a=o.selectionEnd,c=r.split(`
...
`),i){let{newlinesToAppend:l,newlinesToPrepend:p}=J(o);s+=l.length,a=s+r.length,r=l+r+p}return{text:r,selectionStart:s,selectionEnd:a}}function oe(o){let e=o.split(`
...
`),processed:n}}function N(o,e){return e?"- ":`${o+1}. `}function Ze(o,e){let t,n,i;return o.orderedList?(t=oe(e),n=ie(t.text),i=n.text):(t=ie(e),n=oe(t.text),i=n.text),[t,n,i]}function Je(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;se(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,a,c]=Ze(e,r),d=c.split(`
`).map((f,g)=>`${N(g,e.unorderedList)}${f}`),l=d.reduce((f,g,v)=>f+N(v,e.unorderedList).length,0),p=d.reduce((f,g,v)=>f+N(v,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-N(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-l),{text:c,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=J(o),m=h+d.join(`
`)+u;return t?(n=Math.max(n+N(0,e.unorderedList).length+h.length,0),i=n):a.processed?(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+l-p):(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+l),{text:m,selectionStart:n,selectionEnd:i}}function le(o,e){let t=R(o,n=>Je(n,e),{adjustSelection:(n,i,r,s)=>{let a=o.value.slice(s,o.selectionEnd),c=/^\d+\.\s+/,d=/^- /,l=c.test(a),p=d.test(a),h=e.orderedList&&l||e.unorderedList&&p;if(i===r)if(h){let u=a.match(e.orderedList?c:d),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(i-m,s)}}else if(l||p){let u=a.match(l?c:d),m=u?u[0].length:0,g=(e.unorderedList?2:3)-m;return{start:i+g,end:i+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=a.match(e.orderedList?c:d),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(r-m,s)}}else if(l||p){let u=a.match(l?c:d),m=u?u[0].length:0,g=(e.unorderedList?2:3)-m;return{start:i+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});$(o,t)}function Qe(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),s=0,a="";for(let p of r){if(t>=s&&t<=s+p.length){a=p;break}s+=p.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let c=Math.max(0,t-10),d=Math.min(i.length,n+10),l=i.slice(c,d);if(l.includes("**")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("**"),m=h.indexOf("**");u!==-1&&m!==-1&&e.push("bold")}if(l.includes("_")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("_"),m=h.indexOf("_");u!==-1&&m!==-1&&e.push("italic")}if(l.includes("`")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(l.includes("[")&&l.includes("]")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("["),m=h.indexOf("]");u!==-1&&m!==-1&&i.slice(n+m+1,n+m+10).startsWith("(")&&e.push("link")}return e}function V(o){if(!o||o.disabled||o.readOnly)return;y("toggleBold","Starting"),z(o,"Before");let e=A(S.bold),t=F(o,e);re(t),$(o,t),z(o,"After")}function D(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.italic),t=F(o,e);$(o,t)}function ce(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.code),t=F(o,e);$(o,t)}function q(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=A(S.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=o.selectionStart;o.value=o.value.slice(0,s)+e.text+o.value.slice(s),o.selectionStart=s,o.selectionEnd=s+e.text.length}let r=F(o,n);$(o,r)}function U(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.bulletList);le(o,e)}function W(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.numberedList);le(o,e)}function pe(o){if(!o||o.disabled||o.readOnly)return;y("toggleQuote","Starting"),z(o,"Initial");let e=A(S.quote),t=R(o,n=>ae(n,e),{prefix:e.prefix});re(t),$(o,t),z(o,"Final")}function de(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.taskList),t=R(o,n=>ae(n,e),{prefix:e.prefix});$(o,t)}function Q(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),y("insertHeader","============ START ============"),y("insertHeader",`Level: ${e}, Toggle: ${t}`),y("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=A(S[n]||S.header1);y("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,s=o.selectionStart,a=o.selectionEnd,c=s;for(;c>0&&r[c-1]!==`
`;)c--;let d=a;for(;d<r.length&&r[d]!==`
`;)d++;let l=r.slice(c,d);y("insertHeader",`Current line (before): "${l}"`);let p=l.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;y("insertHeader","Existing header check:"),y("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),y("insertHeader",`  - Existing level: ${h}`),y("insertHeader",`  - Existing prefix length: ${u}`),y("insertHeader",`  - Target level: ${e}`);let m=t&&h===e;y("insertHeader",`Should toggle OFF: ${m} (toggle=${t}, existingLevel=${h}, level=${e})`);let f=R(o,g=>{let v=g.value.slice(g.selectionStart,g.selectionEnd);y("insertHeader",`Line in operation: "${v}"`);let b=v.replace(/^#{1,6}\s*/,"");y("insertHeader",`Cleaned line: "${b}"`);let k;return m?(y("insertHeader","ACTION: Toggling OFF - removing header"),k=b):h>0?(y("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=i.prefix+b):(y("insertHeader","ACTION: Adding new header"),k=i.prefix+b),y("insertHeader",`New line: "${k}"`),{text:k,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:i.prefix,adjustSelection:(g,v,b,k)=>{if(y("insertHeader","Adjusting selection:"),y("insertHeader",`  - isRemoving param: ${g}`),y("insertHeader",`  - shouldToggleOff: ${m}`),y("insertHeader",`  - selStart: ${v}, selEnd: ${b}`),y("insertHeader",`  - lineStartPos: ${k}`),m){let M=Math.max(v-u,k);return y("insertHeader",`  - Removing header, adjusting by -${u}`),{start:M,end:v===b?M:Math.max(b-u,k)}}else if(u>0){let M=i.prefix.length-u;return y("insertHeader",`  - Replacing header, adjusting by ${M}`),{start:v+M,end:b+M}}else return y("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:v+i.prefix.length,end:b+i.prefix.length}}});y("insertHeader",`Final result: text="${f.text}", cursor=${f.selectionStart}-${f.selectionEnd}`),y("insertHeader","============ END ============"),$(o,f)}function he(o){Q(o,1,!0)}function ue(o){Q(o,2,!0)}function me(o){Q(o,3,!0)}function fe(o){return Qe(o)}var _=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var I={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:I,cave:ve,light:I,dark:ve};function P(o){return typeof o=="string"?{...ye[o]||ye.solar,name:o}:o}function B(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
