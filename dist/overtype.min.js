...
`)}function ct(t,e={},n={}){return{...t,colors:{...t.colors,...e},previewColors:{...t.previewColors,...n}}}function pt(t={}){let{fontSize:e="14px",lineHeight:n=1.6,fontFamily:i='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=t,a=Object.keys(s).length>0?`
  ...
  `}var ne={};st(ne,{applyCustomFormat:()=>Et,default:()=>On,expandSelection:()=>St,getActiveFormats:()=>Oe,getDebugMode:()=>Ze,hasFormat:()=>Lt,insertHeader:()=>de,insertLink:()=>Ce,preserveSelection:()=>bt,setDebugMode:()=>gt,setUndoMethod:()=>yt,toggleBold:()=>Ee,toggleBulletList:()=>Ie,toggleCode:()=>Ae,toggleH1:()=>He,toggleH2:()=>$e,toggleH3:()=>Pe,toggleItalic:()=>Te,toggleNumberedList:()=>Me,toggleQuote:()=>_e,toggleTaskList:()=>pe});var Sn=Object.defineProperty,dt=Object.getOwnPropertySymbols,En=Object.prototype.hasOwnProperty,Tn=Object.prototype.propertyIsEnumerable,ut=(t,e,n)=>e in t?Sn(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,ht=(t,e)=>{for(var n in e||(e={}))En.call(e,n)&&ut(t,n,e[n]);if(dt)for(var n of dt(e))Tn.call(e,n)&&ut(t,n,e[n]);return t},O={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function An(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function R(t){return ht(ht({},An()),t)}var ce=!1;function gt(t){ce=t}function Ze(){return ce}function x(t,e,n){ce&&(console.group(`\u{1F50D} ${t}`),console.log(e),n&&console.log("Data:",n),console.groupEnd())}function Le(t,e){if(!ce)return;let n=t.value.slice(t.selectionStart,t.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${t.selectionStart}-${t.selectionEnd}`),console.log("Selected text:",JSON.stringify(n)),console.log("Length:",n.length);let i=t.value.slice(Math.max(0,t.selectionStart-10),t.selectionStart),o=t.value.slice(t.selectionEnd,Math.min(t.value.length,t.selectionEnd+10));console.log("Context:",JSON.stringify(i)+"[SELECTION]"+JSON.stringify(o)),console.groupEnd()}function vt(t){ce&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(t.text)),console.log("New selection:",`${t.selectionStart}-${t.selectionEnd}`),console.groupEnd())}var I=null;function F(t,{text:e,selectionStart:n,selectionEnd:i}){let o=Ze();o&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${t.selectionStart}-${t.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",n,"-",i)),t.focus();let r=t.selectionStart,s=t.selectionEnd,a=t.value.slice(0,r),l=t.value.slice(s);o&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(l.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(t.value.slice(r,s))));let p=t.value,c=r!==s;if(I===null||I===!0){t.contentEditable="true";try{I=document.execCommand("insertText",!1,e),o&&console.log("execCommand returned:",I,"for text with",e.split(`
`).length,"lines")}catch(d){I=!1,o&&console.log("execCommand threw error:",d)}t.contentEditable="false"}if(o&&(console.log("canInsertText before:",I),console.log("execCommand result:",I)),I){let d=a+e+l,u=t.value;o&&(console.log("Expected length:",d.length),console.log("Actual length:",u.length)),u!==d&&o&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(d.slice(0,100))),console.log("Actual:",JSON.stringify(u.slice(0,100))))}if(!I)if(o&&console.log("Using manual insertion"),t.value===p){o&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(d){}t.value=a+e+l;try{document.execCommand("ms-endUndoUnit")}catch(d){}t.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else o&&console.log("Value was changed by execCommand, skipping manual insertion");o&&console.log("Setting selection range:",n,i),n!=null&&i!=null?t.setSelectionRange(n,i):t.setSelectionRange(r,t.selectionEnd),o&&(console.log("Final value length:",t.value.length),console.groupEnd())}function yt(t){switch(t){case"native":I=!0;break;case"manual":I=!1;break;case"auto":I=null;break}}function Ke(t){return t.trim().split(`
`).length>1}function Cn(t,e){let n=e;for(;t[n]&&t[n-1]!=null&&!t[n-1].match(/\s/);)n--;return n}function In(t,e,n){let i=e,o=n?/\n/:/\s/;for(;t[i]&&!t[i].match(o);)i++;return i}function wt(t){let e=t.value.split(`
`),n=0;for(let i=0;i<e.length;i++){let o=e[i].length+1;t.selectionStart>=n&&t.selectionStart<n+o&&(t.selectionStart=n),t.selectionEnd>=n&&t.selectionEnd<n+o&&(i===e.length-1?t.selectionEnd=Math.min(n+e[i].length,t.value.length):t.selectionEnd=n+o-1),n+=o}}function Mn(t,e,n,i=!1){if(t.selectionStart===t.selectionEnd)t.selectionStart=Cn(t.value,t.selectionStart),t.selectionEnd=In(t.value,t.selectionEnd,i);else{let o=t.selectionStart-e.length,r=t.selectionEnd+n.length,s=t.value.slice(o,t.selectionStart)===e,a=t.value.slice(t.selectionEnd,r)===n;s&&a&&(t.selectionStart=o,t.selectionEnd=r)}return t.value.slice(t.selectionStart,t.selectionEnd)}function Qe(t){let e=t.value.slice(0,t.selectionStart),n=t.value.slice(t.selectionEnd),i=e.match(/\n*$/),o=n.match(/^\n*/),r=i?i[0].length:0,s=o?o[0].length:0,a="",l="";return e.match(/\S/)&&r<2&&(a=`
`.repeat(2-r)),n.match(/\S/)&&s<2&&(l=`
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:l}}function bt(t,e){let n=t.selectionStart,i=t.selectionEnd,o=t.scrollTop;e(),t.selectionStart=n,t.selectionEnd=i,t.scrollTop=o}function Se(t,e,n={}){let i=t.selectionStart,o=t.selectionEnd,r=i===o,s=t.value,a=i;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let p=i;for(;p<s.length&&s[p]!==`
`;)p++;t.selectionStart=a,t.selectionEnd=p}else wt(t);let l=e(t);if(n.adjustSelection){let c=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix),d=n.adjustSelection(c,i,o,a);l.selectionStart=d.start,l.selectionEnd=d.end}else if(n.prefix){let c=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix);r?c?(l.selectionStart=Math.max(i-n.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=i+n.prefix.length,l.selectionEnd=l.selectionStart):c?(l.selectionStart=Math.max(i-n.prefix.length,a),l.selectionEnd=Math.max(o-n.prefix.length,a)):(l.selectionStart=i+n.prefix.length,l.selectionEnd=o+n.prefix.length)}return l}function te(t,e){let n,i,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:p,scanFor:c,surroundWithNewlines:d,trimFirst:u}=e,h=t.selectionStart,f=t.selectionEnd,m=t.value.slice(t.selectionStart,t.selectionEnd),g=Ke(m)&&s&&s.length>0?`${s}
`:o,y=Ke(m)&&a&&a.length>0?`
${a}`:r;if(p){let k=t.value[t.selectionStart-1];t.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(g=` ${g}`)}m=Mn(t,g,y,e.multiline);let w=t.selectionStart,b=t.selectionEnd,L=l&&l.length>0&&y.indexOf(l)>-1&&m.length>0;if(d){let k=Qe(t);n=k.newlinesToAppend,i=k.newlinesToPrepend,g=n+o,y+=i}if(m.startsWith(g)&&m.endsWith(y)){let k=m.slice(g.length,m.length-y.length);if(h===f){let E=h-g.length;E=Math.max(E,w),E=Math.min(E,w+k.length),w=b=E}else b=w+k.length;return{text:k,selectionStart:w,selectionEnd:b}}else if(L)if(c&&c.length>0&&m.match(c)){y=y.replace(l,m);let k=g+y;return w=b=w+g.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+y;return w=w+g.length+m.length+y.indexOf(l),b=w+l.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=g+m+y;w=h+g.length,b=f+g.length;let E=m.match(/^\s*|\s*$/g);if(u&&E){let be=E[0]||"",Y=E[1]||"";k=be+g+m.trim()+y+Y,w+=be.length,b-=Y.length}return{text:k,selectionStart:w,selectionEnd:b}}}function Je(t,e){let{prefix:n,suffix:i,surroundWithNewlines:o}=e,r=t.value.slice(t.selectionStart,t.selectionEnd),s=t.selectionStart,a=t.selectionEnd,l=r.split(`
`);if(l.every(c=>c.startsWith(n)&&(!i||c.endsWith(i))))r=l.map(c=>{let d=c.slice(n.length);return i&&(d=d.slice(0,d.length-i.length)),d}).join(`
`),a=s+r.length;else if(r=l.map(c=>n+c+(i||"")).join(`
`),o){let{newlinesToAppend:c,newlinesToPrepend:d}=Qe(t);s+=c.length,a=s+r.length,r=c+r+d}return{text:r,selectionStart:s,selectionEnd:a}}function ft(t){let e=t.split(`
`),n=/^\d+\.\s+/,i=e.every(r=>n.test(r)),o=e;return i&&(o=e.map(r=>r.replace(n,""))),{text:o.join(`
`),processed:i}}function mt(t){let e=t.split(`
`),n="- ",i=e.every(r=>r.startsWith(n)),o=e;return i&&(o=e.map(r=>r.slice(n.length))),{text:o.join(`
`),processed:i}}function le(t,e){return e?"- ":`${t+1}. `}function _n(t,e){let n,i,o;return t.orderedList?(n=ft(e),i=mt(n.text),o=i.text):(n=mt(e),i=ft(n.text),o=i.text),[n,i,o]}function Hn(t,e){let n=t.selectionStart===t.selectionEnd,i=t.selectionStart,o=t.selectionEnd;wt(t);let r=t.value.slice(t.selectionStart,t.selectionEnd),[s,a,l]=_n(e,r),p=l.split(`
`).map((m,g)=>`${le(g,e.unorderedList)}${m}`),c=p.reduce((m,g,y)=>m+le(y,e.unorderedList).length,0),d=p.reduce((m,g,y)=>m+le(y,!e.unorderedList).length,0);if(s.processed)return n?(i=Math.max(i-le(0,e.unorderedList).length,0),o=i):(i=t.selectionStart,o=t.selectionEnd-c),{text:l,selectionStart:i,selectionEnd:o};let{newlinesToAppend:u,newlinesToPrepend:h}=Qe(t),f=u+p.join(`
`)+h;return n?(i=Math.max(i+le(0,e.unorderedList).length+u.length,0),o=i):a.processed?(i=Math.max(t.selectionStart+u.length,0),o=t.selectionEnd+u.length+c-d):(i=Math.max(t.selectionStart+u.length,0),o=t.selectionEnd+u.length+c),{text:f,selectionStart:i,selectionEnd:o}}function xt(t,e){let n=Se(t,i=>Hn(i,e),{adjustSelection:(i,o,r,s)=>{let a=t.value.slice(s,t.selectionEnd),l=/^\d+\.\s+/,p=/^- /,c=l.test(a),d=p.test(a),u=e.orderedList&&c||e.unorderedList&&d;if(o===r)if(u){let h=a.match(e.orderedList?l:p),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(c||d){let h=a.match(c?l:p),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:o+h}}else if(u){let h=a.match(e.orderedList?l:p),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(c||d){let h=a.match(c?l:p),f=h?h[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let h=e.unorderedList?2:3;return{start:o+h,end:r+h}}}});F(t,n)}function kt(t){if(!t)return[];let e=[],{selectionStart:n,selectionEnd:i,value:o}=t,r=o.split(`
`),s=0,a="";for(let d of r){if(n>=s&&n<=s+d.length){a=d;break}s+=d.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,n-10),p=Math.min(o.length,i+10),c=o.slice(l,p);if(c.includes("**")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("**"),f=u.indexOf("**");h!==-1&&f!==-1&&e.push("bold")}if(c.includes("_")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("_"),f=u.indexOf("_");h!==-1&&f!==-1&&e.push("italic")}if(c.includes("`")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100));d.includes("`")&&u.includes("`")&&e.push("code")}if(c.includes("[")&&c.includes("]")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("["),f=u.indexOf("]");h!==-1&&f!==-1&&o.slice(i+f+1,i+f+10).startsWith("(")&&e.push("link")}return e}function $n(t,e){return kt(t).includes(e)}function Pn(t,e={}){if(!t)return;let{toWord:n,toLine:i,toFormat:o}=e,{selectionStart:r,selectionEnd:s,value:a}=t;if(i){let l=a.split(`
`),p=0,c=0,d=0;for(let u of l){if(r>=d&&r<=d+u.length){p=d,c=d+u.length;break}d+=u.length+1}t.selectionStart=p,t.selectionEnd=c}else if(n&&r===s){let l=r,p=s;for(;l>0&&!/\s/.test(a[l-1]);)l--;for(;p<a.length&&!/\s/.test(a[p]);)p++;t.selectionStart=l,t.selectionEnd=p}}function Ee(t){if(!t||t.disabled||t.readOnly)return;x("toggleBold","Starting"),Le(t,"Before");let e=R(O.bold),n=te(t,e);vt(n),F(t,n),Le(t,"After")}function Te(t){if(!t||t.disabled||t.readOnly)return;let e=R(O.italic),n=te(t,e);F(t,n)}function Ae(t){if(!t||t.disabled||t.readOnly)return;let e=R(O.code),n=te(t,e);F(t,n)}function Ce(t,e={}){if(!t||t.disabled||t.readOnly)return;let n=t.value.slice(t.selectionStart,t.selectionEnd),i=R(O.link);if(n&&n.match(/^https?:\/\//)&&!e.url?(i.suffix=`](${n})`,i.replaceNext=""):e.url&&(i.suffix=`](${e.url})`,i.replaceNext=""),e.text&&!n){let s=t.selectionStart;t.value=t.value.slice(0,s)+e.text+t.value.slice(s),t.selectionStart=s,t.selectionEnd=s+e.text.length}let r=te(t,i);F(t,r)}function Ie(t){if(!t||t.disabled||t.readOnly)return;let e=R(O.bulletList);xt(t,e)}function Me(t){if(!t||t.disabled||t.readOnly)return;let e=R(O.numberedList);xt(t,e)}function _e(t){if(!t||t.disabled||t.readOnly)return;x("toggleQuote","Starting"),Le(t,"Initial");let e=R(O.quote),n=Se(t,i=>Je(i,e),{prefix:e.prefix});vt(n),F(t,n),Le(t,"Final")}function pe(t){if(!t||t.disabled||t.readOnly)return;let e=R(O.taskList),n=Se(t,i=>Je(i,e),{prefix:e.prefix});F(t,n)}function de(t,e=1,n=!1){if(!t||t.disabled||t.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${n}`),x("insertHeader",`Initial cursor: ${t.selectionStart}-${t.selectionEnd}`);let i=`header${e===1?"1":e}`,o=R(O[i]||O.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=t.value,s=t.selectionStart,a=t.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let p=a;for(;p<r.length&&r[p]!==`
`;)p++;let c=r.slice(l,p);x("insertHeader",`Current line (before): "${c}"`);let d=c.match(/^(#{1,6})\s*/),u=d?d[1].length:0,h=d?d[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${d?`"${d[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${u}`),x("insertHeader",`  - Existing prefix length: ${h}`),x("insertHeader",`  - Target level: ${e}`);let f=n&&u===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${n}, existingLevel=${u}, level=${e})`);let m=Se(t,g=>{let y=g.value.slice(g.selectionStart,g.selectionEnd);x("insertHeader",`Line in operation: "${y}"`);let w=y.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${w}"`);let b;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),b=w):u>0?(x("insertHeader",`ACTION: Replacing H${u} with H${e}`),b=o.prefix+w):(x("insertHeader","ACTION: Adding new header"),b=o.prefix+w),x("insertHeader",`New line: "${b}"`),{text:b,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,y,w,b)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${g}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${y}, selEnd: ${w}`),x("insertHeader",`  - lineStartPos: ${b}`),f){let L=Math.max(y-h,b);return x("insertHeader",`  - Removing header, adjusting by -${h}`),{start:L,end:y===w?L:Math.max(w-h,b)}}else if(h>0){let L=o.prefix.length-h;return x("insertHeader",`  - Replacing header, adjusting by ${L}`),{start:y+L,end:w+L}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:y+o.prefix.length,end:w+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),F(t,m)}function He(t){de(t,1,!0)}function $e(t){de(t,2,!0)}function Pe(t){de(t,3,!0)}function Oe(t){return kt(t)}function Lt(t,e){return $n(t,e)}function St(t,e={}){Pn(t,e)}function Et(t,e){if(!t||t.disabled||t.readOnly)return;let n=R(e),i;if(n.multiline){let o=t.value.slice(t.selectionStart,t.selectionEnd);Ke(o)?i=Je(t,n):i=te(t,n)}else i=te(t,n);F(t,i)}var On={toggleBold:Ee,toggleItalic:Te,toggleCode:Ae,insertLink:Ce,toggleBulletList:Ie,toggleNumberedList:Me,toggleQuote:_e,toggleTaskList:pe,insertHeader:de,toggleH1:He,toggleH2:$e,toggleH3:Pe,getActiveFormats:Oe,hasFormat:Lt,expandSelection:St,applyCustomFormat:Et,preserveSelection:bt,setUndoMethod:yt,setDebugMode:gt,getDebugMode:Ze};var Re=class{constructor(e,n={}){this.editor=e,this.container=null,this.buttons={},this.currentItemIndex=0,this.handleDocumentClick=null,this.activeDropdown=null,this.activeDropdownButton=null,this.toolbarButtons=n.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.id=this.getInstanceElementId("toolbar"),this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.container.setAttribute("aria-controls",this.editor.textarea.id),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let n=this.createSeparator();this.container.appendChild(n)}else{let n=this.createButton(e);this.buttons[e.name]=n,this.container.appendChild(n)}}),this.setupRovingTabIndex(),this.updateButtonStates(),this.editor.container.insertBefore(this.container,this.editor.wrapper)}getInstanceElementId(e){return`overtype-${this.editor.instanceId}-${e}`}setupRovingTabIndex(){this.getToolbarItems().length!==0&&(this.currentItemIndex=this.getValidItemIndex(this.currentItemIndex),this.updateTabIndexes(),this.container.addEventListener("keydown",n=>{this.onToolbarKeydown(n)}),this.container.addEventListener("focusin",n=>{this.onToolbarFocusin(n)}))}getToolbarItems(){return this.container?Array.from(this.container.querySelectorAll(".overtype-toolbar-button")):[]}onToolbarKeydown(e){let n=this.getToolbarItems();if(n.includes(e.target))switch(e.key){case"ArrowRight":e.preventDefault(),this.focusItem(this.currentItemIndex+1);break;case"ArrowLeft":e.preventDefault(),this.focusItem(this.currentItemIndex-1);break;case"Home":e.preventDefault(),this.focusItem(0);break;case"End":e.preventDefault(),this.focusItem(n.length-1);break}}onToolbarFocusin(e){let n=this.getToolbarItems().indexOf(e.target);n!==-1&&(this.currentItemIndex=n,this.updateTabIndexes())}focusItem(e){let n=this.getToolbarItems();n.length!==0&&(this.currentItemIndex=this.getValidItemIndex(e,n),this.updateTabIndexes(),n[this.currentItemIndex].focus())}getValidItemIndex(e,n=this.getToolbarItems()){let i=n.length;return i===0?0:e<0?i-1:e>=i?0:e}updateTabIndexes(){this.getToolbarItems().forEach((e,n)=>{e.tabIndex=n===this.currentItemIndex?0:-1})}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let n=document.createElement("button");return n.className="overtype-toolbar-button",n.type="button",n.setAttribute("data-button",e.name),n.title=e.title||"",n.setAttribute("aria-label",e.title||e.name),n.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(n.classList.add("has-dropdown"),n.dataset.dropdown="true",n.setAttribute("aria-haspopup","menu"),n.setAttribute("aria-expanded","false"),n._clickHandler=i=>{i.preventDefault(),this.toggleViewModeDropdown(n)},n._keydownHandler=i=>{if(!["ArrowDown","ArrowUp","Enter"," "].includes(i.key))return;i.preventDefault();let o=i.key==="ArrowUp"?"last":"current";this.openViewModeDropdown(n,o)},n.addEventListener("click",n._clickHandler),n.addEventListener("keydown",n._keydownHandler),n):(n._clickHandler=i=>{i.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,i)},n.addEventListener("click",n._clickHandler),n)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:n=>this.editor.setValue(n),event:null}),!0}catch(n){return console.error(`Action "${e.name}" error:`,n),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:n}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){if(this.activeDropdown){this.closeViewModeDropdown(e);return}this.openViewModeDropdown(e)}openViewModeDropdown(e,n=null){this.closeViewModeDropdown(e),e.classList.add("dropdown-active");let i=this.createViewModeDropdown(e),o=e.getBoundingClientRect();i.style.position="absolute",i.style.top=`${o.bottom+5}px`,i.style.left=`${o.left}px`,document.body.appendChild(i),this.activeDropdown=i,this.activeDropdownButton=e,e.setAttribute("aria-controls",i.id),e.setAttribute("aria-expanded","true"),this.handleDocumentClick=r=>{!i.contains(r.target)&&!e.contains(r.target)&&this.closeViewModeDropdown(e)},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0),n&&this.focusViewModeMenuItem(i,n)}closeViewModeDropdown(e=this.activeDropdownButton,n=!1){this.activeDropdown&&(this.activeDropdown.remove(),this.activeDropdown=null),e&&(e.classList.remove("dropdown-active"),e.setAttribute("aria-expanded","false")),this.handleDocumentClick&&(document.removeEventListener("click",this.handleDocumentClick),this.handleDocumentClick=null),this.activeDropdownButton=null,n&&e&&e.focus()}createViewModeDropdown(e){let n=document.createElement("div");n.className="overtype-dropdown-menu",n.id=this.getInstanceElementId("toolbar-view-mode-menu"),n.setAttribute("role","menu"),n.setAttribute("aria-label","View mode"),n.addEventListener("keydown",r=>{this.onViewModeMenuKeydown(r,e)});let i=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return i.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.tabIndex=-1,s.setAttribute("role","menuitemradio"),s.setAttribute("aria-checked",String(r.id===o)),s.textContent=r.label,r.id===o){s.classList.add("active");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.setAttribute("aria-hidden","true"),a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}this.closeViewModeDropdown(e,!0)}),n.appendChild(s)}),n}onViewModeMenuKeydown(e,n){let o=this.getViewModeMenuItems().indexOf(e.target);if(o!==-1)switch(e.key){case"ArrowDown":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,o+1);break;case"ArrowUp":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,o-1);break;case"Home":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,"first");break;case"End":e.preventDefault(),this.focusViewModeMenuItem(this.activeDropdown,"last");break;case"Escape":e.preventDefault(),this.closeViewModeDropdown(n,!0);break}}focusViewModeMenuItem(e,n){let i=this.getViewModeMenuItems(e);if(i.length===0)return;let o=n;n==="first"?o=0:n==="last"?o=i.length-1:n==="current"&&(o=i.findIndex(r=>r.getAttribute("aria-checked")==="true")),o<0&&(o=i.length-1),o>=i.length&&(o=0),i[o].focus()}getViewModeMenuItems(e=this.activeDropdown){return e?Array.from(e.querySelectorAll('[role="menuitemradio"]')):[]}updateButtonStates(){var e;try{let n=((e=Oe)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([i,o])=>{if(i==="viewMode")return;let r=this.toolbarButtons.find(a=>a.name===i);if(!(r!=null&&r.isActive))return;let s=!!r.isActive({editor:this.editor,activeFormats:n});o.classList.toggle("active",s),o.setAttribute("aria-pressed",s.toString())})}catch(n){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.activeDropdown?this.closeViewModeDropdown():this.handleDocumentClick&&(document.removeEventListener("click",this.handleDocumentClick),this.handleDocumentClick=null),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler),e._keydownHandler&&(e.removeEventListener("keydown",e._keydownHandler),delete e._keydownHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var he=Math.min,W=Math.max,fe=Math.round;var $=t=>({x:t,y:t}),Rn={left:"right",right:"left",bottom:"top",top:"bottom"},Bn={start:"end",end:"start"};function Xe(t,e,n){return W(t,he(e,n))}function me(t,e){return typeof t=="function"?t(e):t}function q(t){return t.split("-")[0]}function ge(t){return t.split("-")[1]}function Ge(t){return t==="x"?"y":"x"}function Ye(t){return t==="y"?"height":"width"}var Dn=new Set(["top","bottom"]);function N(t){return Dn.has(q(t))?"y":"x"}function et(t){return Ge(N(t))}function Ct(t,e,n){n===void 0&&(n=!1);let i=ge(t),o=et(t),r=Ye(o),s=o==="x"?i===(n?"end":"start")?"right":"left":i==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=ue(s)),[s,ue(s)]}function It(t){let e=ue(t);return[Be(t),e,Be(e)]}function Be(t){return t.replace(/start|end/g,e=>Bn[e])}var Tt=["left","right"],At=["right","left"],Fn=["top","bottom"],Nn=["bottom","top"];function Vn(t,e,n){switch(t){case"top":case"bottom":return n?e?At:Tt:e?Tt:At;case"left":case"right":return e?Fn:Nn;default:return[]}}function Mt(t,e,n,i){let o=ge(t),r=Vn(q(t),n==="start",i);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(Be)))),r}function ue(t){return t.replace(/left|right|bottom|top/g,e=>Rn[e])}function zn(t){return{top:0,right:0,bottom:0,left:0,...t}}function _t(t){return typeof t!="number"?zn(t):{top:t,right:t,bottom:t,left:t}}function J(t){let{x:e,y:n,width:i,height:o}=t;return{width:i,height:o,top:n,left:e,right:e+i,bottom:n+o,x:e,y:n}}function Ht(t,e,n){let{reference:i,floating:o}=t,r=N(e),s=et(e),a=Ye(s),l=q(e),p=r==="y",c=i.x+i.width/2-o.width/2,d=i.y+i.height/2-o.height/2,u=i[a]/2-o[a]/2,h;switch(l){case"top":h={x:c,y:i.y-o.height};break;case"bottom":h={x:c,y:i.y+i.height};break;case"right":h={x:i.x+i.width,y:d};break;case"left":h={x:i.x-o.width,y:d};break;default:h={x:i.x,y:i.y}}switch(ge(e)){case"start":h[s]-=u*(n&&p?-1:1);break;case"end":h[s]+=u*(n&&p?-1:1);break}return h}async function $t(t,e){var n;e===void 0&&(e={});let{x:i,y:o,platform:r,rects:s,elements:a,strategy:l}=t,{boundary:p="clippingAncestors",rootBoundary:c="viewport",elementContext:d="floating",altBoundary:u=!1,padding:h=0}=me(e,t),f=_t(h),g=a[u?d==="floating"?"reference":"floating":d],y=J(await r.getClippingRect({element:(n=await(r.isElement==null?void 0:r.isElement(g)))==null||n?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:p,rootBoundary:c,strategy:l})),w=d==="floating"?{x:i,y:o,width:s.floating.width,height:s.floating.height}:s.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),L=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},k=J(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:b,strategy:l}):w);return{top:(y.top-k.top+f.top)/L.y,bottom:(k.bottom-y.bottom+f.bottom)/L.y,left:(y.left-k.left+f.left)/L.x,right:(k.right-y.right+f.right)/L.x}}var Pt=async(t,e,n)=>{let{placement:i="bottom",strategy:o="absolute",middleware:r=[],platform:s}=n,a=r.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(e)),p=await s.getElementRects({reference:t,floating:e,strategy:o}),{x:c,y:d}=Ht(p,i,l),u=i,h={},f=0;for(let g=0;g<a.length;g++){var m;let{name:y,fn:w}=a[g],{x:b,y:L,data:k,reset:E}=await w({x:c,y:d,initialPlacement:i,placement:u,strategy:o,middlewareData:h,rects:p,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:$t},elements:{reference:t,floating:e}});c=b!=null?b:c,d=L!=null?L:d,h={...h,[y]:{...h[y],...k}},E&&f<=50&&(f++,typeof E=="object"&&(E.placement&&(u=E.placement),E.rects&&(p=E.rects===!0?await s.getElementRects({reference:t,floating:e,strategy:o}):E.rects),{x:c,y:d}=Ht(p,u,l)),g=-1)}return{x:c,y:d,placement:u,strategy:o,middlewareData:h}};var Ot=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var n,i;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:l,elements:p}=e,{mainAxis:c=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=me(t,e);if((n=r.arrow)!=null&&n.alignmentOffset)return{};let y=q(o),w=N(a),b=q(a)===a,L=await(l.isRTL==null?void 0:l.isRTL(p.floating)),k=u||(b||!m?[ue(a)]:It(a)),E=f!=="none";!u&&E&&k.push(...Mt(a,m,f,L));let be=[a,...k],Y=await l.detectOverflow(e,g),xe=[],ee=((i=r.flip)==null?void 0:i.overflows)||[];if(c&&xe.push(Y[y]),d){let K=Ct(o,s,L);xe.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:xe}],!xe.every(K=>K<=0)){var it,ot;let K=(((it=r.flip)==null?void 0:it.index)||0)+1,We=be[K];if(We&&(!(d==="alignment"?w!==N(We):!1)||ee.every(H=>N(H.placement)===w?H.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:We}};let se=(ot=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,H)=>Z.overflows[1]-H.overflows[1])[0])==null?void 0:ot.placement;if(!se)switch(h){case"bestFit":{var rt;let Z=(rt=ee.filter(H=>{if(E){let j=N(H.placement);return j===w||j==="y"}return!0}).map(H=>[H.placement,H.overflows.filter(j=>j>0).reduce((j,vn)=>j+vn,0)]).sort((H,j)=>H[1]-j[1])[0])==null?void 0:rt[0];Z&&(se=Z);break}case"initialPlacement":se=a;break}if(o!==se)return{reset:{placement:se}}}return{}}}};var jn=new Set(["left","top"]);async function Un(t,e){let{placement:n,platform:i,elements:o}=t,r=await(i.isRTL==null?void 0:i.isRTL(o.floating)),s=q(n),a=ge(n),l=N(n)==="y",p=jn.has(s)?-1:1,c=r&&l?-1:1,d=me(e,t),{mainAxis:u,crossAxis:h,alignmentAxis:f}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&typeof f=="number"&&(h=a==="end"?f*-1:f),l?{x:h*c,y:u*p}:{x:u*p,y:h*c}}var Rt=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var n,i;let{x:o,y:r,placement:s,middlewareData:a}=e,l=await Un(e,t);return s===((n=a.offset)==null?void 0:n.placement)&&(i=a.arrow)!=null&&i.alignmentOffset?{}:{x:o+l.x,y:r+l.y,data:{...l,placement:s}}}}},Bt=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:n,y:i,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:y=>{let{x:w,y:b}=y;return{x:w,y:b}}},...p}=me(t,e),c={x:n,y:i},d=await r.detectOverflow(e,p),u=N(q(o)),h=Ge(u),f=c[h],m=c[u];if(s){let y=h==="y"?"top":"left",w=h==="y"?"bottom":"right",b=f+d[y],L=f-d[w];f=Xe(b,f,L)}if(a){let y=u==="y"?"top":"left",w=u==="y"?"bottom":"right",b=m+d[y],L=m-d[w];m=Xe(b,m,L)}let g=l.fn({...e,[h]:f,[u]:m});return{...g,data:{x:g.x-n,y:g.y-i,enabled:{[h]:s,[u]:a}}}}}};function Fe(){return typeof window<"u"}function X(t){return Ft(t)?(t.nodeName||"").toLowerCase():"#document"}function C(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function B(t){var e;return(e=(Ft(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function Ft(t){return Fe()?t instanceof Node||t instanceof C(t).Node:!1}function M(t){return Fe()?t instanceof Element||t instanceof C(t).Element:!1}function P(t){return Fe()?t instanceof HTMLElement||t instanceof C(t).HTMLElement:!1}function Dt(t){return!Fe()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof C(t).ShadowRoot}var Wn=new Set(["inline","contents"]);function ie(t){let{overflow:e,overflowX:n,overflowY:i,display:o}=_(t);return/auto|scroll|overlay|hidden|clip/.test(e+i+n)&&!Wn.has(o)}var qn=new Set(["table","td","th"]);function Nt(t){return qn.has(X(t))}var Kn=[":popover-open",":modal"];function ve(t){return Kn.some(e=>{try{return t.matches(e)}catch(n){return!1}})}var Zn=["transform","translate","scale","rotate","perspective"],Qn=["transform","translate","scale","rotate","perspective","filter"],Jn=["paint","layout","strict","content"];function Ne(t){let e=Ve(),n=M(t)?_(t):t;return Zn.some(i=>n[i]?n[i]!=="none":!1)||(n.containerType?n.containerType!=="normal":!1)||!e&&(n.backdropFilter?n.backdropFilter!=="none":!1)||!e&&(n.filter?n.filter!=="none":!1)||Qn.some(i=>(n.willChange||"").includes(i))||Jn.some(i=>(n.contain||"").includes(i))}function Vt(t){let e=V(t);for(;P(e)&&!G(e);){if(Ne(e))return e;if(ve(e))return null;e=V(e)}return null}function Ve(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Xn=new Set(["html","body","#document"]);function G(t){return Xn.has(X(t))}function _(t){return C(t).getComputedStyle(t)}function ye(t){return M(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function V(t){if(X(t)==="html")return t;let e=t.assignedSlot||t.parentNode||Dt(t)&&t.host||B(t);return Dt(e)?e.host:e}function zt(t){let e=V(t);return G(e)?t.ownerDocument?t.ownerDocument.body:t.body:P(e)&&ie(e)?e:zt(e)}function De(t,e,n){var i;e===void 0&&(e=[]),n===void 0&&(n=!0);let o=zt(t),r=o===((i=t.ownerDocument)==null?void 0:i.body),s=C(o);if(r){let a=ze(s);return e.concat(s,s.visualViewport||[],ie(o)?o:[],a&&n?De(a):[])}return e.concat(o,De(o,[],n))}function ze(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function qt(t){let e=_(t),n=parseFloat(e.width)||0,i=parseFloat(e.height)||0,o=P(t),r=o?t.offsetWidth:n,s=o?t.offsetHeight:i,a=fe(n)!==r||fe(i)!==s;return a&&(n=r,i=s),{width:n,height:i,$:a}}function Kt(t){return M(t)?t:t.contextElement}function oe(t){let e=Kt(t);if(!P(e))return $(1);let n=e.getBoundingClientRect(),{width:i,height:o,$:r}=qt(e),s=(r?fe(n.width):n.width)/i,a=(r?fe(n.height):n.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var Gn=$(0);function Zt(t){let e=C(t);return!Ve()||!e.visualViewport?Gn:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Yn(t,e,n){return e===void 0&&(e=!1),!n||e&&n!==C(t)?!1:e}function we(t,e,n,i){e===void 0&&(e=!1),n===void 0&&(n=!1);let o=t.getBoundingClientRect(),r=Kt(t),s=$(1);e&&(i?M(i)&&(s=oe(i)):s=oe(t));let a=Yn(r,n,i)?Zt(r):$(0),l=(o.left+a.x)/s.x,p=(o.top+a.y)/s.y,c=o.width/s.x,d=o.height/s.y;if(r){let u=C(r),h=i&&M(i)?C(i):i,f=u,m=ze(f);for(;m&&i&&h!==f;){let g=oe(m),y=m.getBoundingClientRect(),w=_(m),b=y.left+(m.clientLeft+parseFloat(w.paddingLeft))*g.x,L=y.top+(m.clientTop+parseFloat(w.paddingTop))*g.y;l*=g.x,p*=g.y,c*=g.x,d*=g.y,l+=b,p+=L,f=C(m),m=ze(f)}}return J({width:c,height:d,x:l,y:p})}function je(t,e){let n=ye(t).scrollLeft;return e?e.left+n:we(B(t)).left+n}function Qt(t,e){let n=t.getBoundingClientRect(),i=n.left+e.scrollLeft-je(t,n),o=n.top+e.scrollTop;return{x:i,y:o}}function ei(t){let{elements:e,rect:n,offsetParent:i,strategy:o}=t,r=o==="fixed",s=B(i),a=e?ve(e.floating):!1;if(i===s||a&&r)return n;let l={scrollLeft:0,scrollTop:0},p=$(1),c=$(0),d=P(i);if((d||!d&&!r)&&((X(i)!=="body"||ie(s))&&(l=ye(i)),P(i))){let h=we(i);p=oe(i),c.x=h.x+i.clientLeft,c.y=h.y+i.clientTop}let u=s&&!d&&!r?Qt(s,l):$(0);return{width:n.width*p.x,height:n.height*p.y,x:n.x*p.x-l.scrollLeft*p.x+c.x+u.x,y:n.y*p.y-l.scrollTop*p.y+c.y+u.y}}function ti(t){return Array.from(t.getClientRects())}function ni(t){let e=B(t),n=ye(t),i=t.ownerDocument.body,o=W(e.scrollWidth,e.clientWidth,i.scrollWidth,i.clientWidth),r=W(e.scrollHeight,e.clientHeight,i.scrollHeight,i.clientHeight),s=-n.scrollLeft+je(t),a=-n.scrollTop;return _(i).direction==="rtl"&&(s+=W(e.clientWidth,i.clientWidth)-o),{width:o,height:r,x:s,y:a}}var jt=25;function ii(t,e){let n=C(t),i=B(t),o=n.visualViewport,r=i.clientWidth,s=i.clientHeight,a=0,l=0;if(o){r=o.width,s=o.height;let c=Ve();(!c||c&&e==="fixed")&&(a=o.offsetLeft,l=o.offsetTop)}let p=je(i);if(p<=0){let c=i.ownerDocument,d=c.body,u=getComputedStyle(d),h=c.compatMode==="CSS1Compat"&&parseFloat(u.marginLeft)+parseFloat(u.marginRight)||0,f=Math.abs(i.clientWidth-d.clientWidth-h);f<=jt&&(r-=f)}else p<=jt&&(r+=p);return{width:r,height:s,x:a,y:l}}var oi=new Set(["absolute","fixed"]);function ri(t,e){let n=we(t,!0,e==="fixed"),i=n.top+t.clientTop,o=n.left+t.clientLeft,r=P(t)?oe(t):$(1),s=t.clientWidth*r.x,a=t.clientHeight*r.y,l=o*r.x,p=i*r.y;return{width:s,height:a,x:l,y:p}}function Ut(t,e,n){let i;if(e==="viewport")i=ii(t,n);else if(e==="document")i=ni(B(t));else if(M(e))i=ri(e,n);else{let o=Zt(t);i={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return J(i)}function Jt(t,e){let n=V(t);return n===e||!M(n)||G(n)?!1:_(n).position==="fixed"||Jt(n,e)}function si(t,e){let n=e.get(t);if(n)return n;let i=De(t,[],!1).filter(a=>M(a)&&X(a)!=="body"),o=null,r=_(t).position==="fixed",s=r?V(t):t;for(;M(s)&&!G(s);){let a=_(s),l=Ne(s);!l&&a.position==="fixed"&&(o=null),(r?!l&&!o:!l&&a.position==="static"&&!!o&&oi.has(o.position)||ie(s)&&!l&&Jt(t,s))?i=i.filter(c=>c!==s):o=a,s=V(s)}return e.set(t,i),i}function ai(t){let{element:e,boundary:n,rootBoundary:i,strategy:o}=t,s=[...n==="clippingAncestors"?ve(e)?[]:si(e,this._c):[].concat(n),i],a=s[0],l=s.reduce((p,c)=>{let d=Ut(e,c,o);return p.top=W(d.top,p.top),p.right=he(d.right,p.right),p.bottom=he(d.bottom,p.bottom),p.left=W(d.left,p.left),p},Ut(e,a,o));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function li(t){let{width:e,height:n}=qt(t);return{width:e,height:n}}function ci(t,e,n){let i=P(e),o=B(e),r=n==="fixed",s=we(t,!0,r,e),a={scrollLeft:0,scrollTop:0},l=$(0);function p(){l.x=je(o)}if(i||!i&&!r)if((X(e)!=="body"||ie(o))&&(a=ye(e)),i){let h=we(e,!0,r,e);l.x=h.x+e.clientLeft,l.y=h.y+e.clientTop}else o&&p();r&&!i&&o&&p();let c=o&&!i&&!r?Qt(o,a):$(0),d=s.left+a.scrollLeft-l.x-c.x,u=s.top+a.scrollTop-l.y-c.y;return{x:d,y:u,width:s.width,height:s.height}}function tt(t){return _(t).position==="static"}function Wt(t,e){if(!P(t)||_(t).position==="fixed")return null;if(e)return e(t);let n=t.offsetParent;return B(t)===n&&(n=n.ownerDocument.body),n}function Xt(t,e){let n=C(t);if(ve(t))return n;if(!P(t)){let o=V(t);for(;o&&!G(o);){if(M(o)&&!tt(o))return o;o=V(o)}return n}let i=Wt(t,e);for(;i&&Nt(i)&&tt(i);)i=Wt(i,e);return i&&G(i)&&tt(i)&&!Ne(i)?n:i||Vt(t)||n}var pi=async function(t){let e=this.getOffsetParent||Xt,n=this.getDimensions,i=await n(t.floating);return{reference:ci(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}};function di(t){return _(t).direction==="rtl"}var ui={convertOffsetParentRelativeRectToViewportRelativeRect:ei,getDocumentElement:B,getClippingRect:ai,getOffsetParent:Xt,getElementRects:pi,getClientRects:ti,getDimensions:li,getScale:oe,isElement:M,isRTL:di};var Gt=Rt;var Yt=Bt,en=Ot;var tn=(t,e,n)=>{let i=new Map,o={platform:ui,...n},r={...o.platform,_c:i};return Pt(t,e,{...o,platform:r})};var Ue=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
