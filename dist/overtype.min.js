...
`),i=0,r=0,s=0;for(let u=0;u<n.length;u++){let h=n[u].length;if(i+h>=t){r=u,s=i;break}i+=h+1}let l=n[r],a=s+l.length,c=l.match(this.LIST_PATTERNS.checkbox);if(c)return{inList:!0,listType:"checkbox",indent:c[1],marker:"-",checked:c[2]==="x",content:c[3],lineStart:s,lineEnd:a,markerEndPos:s+c[1].length+c[2].length+5};let d=l.match(this.LIST_PATTERNS.bullet);if(d)return{inList:!0,listType:"bullet",indent:d[1],marker:d[2],content:d[3],lineStart:s,lineEnd:a,markerEndPos:s+d[1].length+d[2].length+1};let p=l.match(this.LIST_PATTERNS.numbered);return p?{inList:!0,listType:"numbered",indent:p[1],marker:parseInt(p[2]),content:p[3],lineStart:s,lineEnd:a,markerEndPos:s+p[1].length+p[2].length+2}:{inList:!1,listType:null,indent:"",marker:null,content:l,lineStart:s,lineEnd:a,markerEndPos:s}}static createNewListItem(e){switch(e.listType){case"bullet":return`${e.indent}${e.marker} `;case"numbered":return`${e.indent}${e.marker+1}. `;case"checkbox":return`${e.indent}- [ ] `;default:return""}}static renumberLists(e){let t=e.split(`
`),n=new Map,i=!1;return t.map(s=>{let l=s.match(this.LIST_PATTERNS.numbered);if(l){let a=l[1],c=a.length,d=l[3];i||n.clear();let p=(n.get(c)||0)+1;n.set(c,p);for(let[u]of n)u>c&&n.delete(u);return i=!0,`${a}${p}. ${d}`}else return(s.trim()===""||!s.match(/^\s/))&&(i=!1,n.clear()),s}).join(`
`)}};H(L,"linkIndex",0),H(L,"LIST_PATTERNS",{bullet:/^(\s*)([-*+])\s+(.*)$/,numbered:/^(\s*)(\d+)\.\s+(.*)$/,checkbox:/^(\s*)-\s+\[([ x])\]\s+(.*)$/});var Re=Object.defineProperty,Y=Object.getOwnPropertySymbols,Fe=Object.prototype.hasOwnProperty,Ve=Object.prototype.propertyIsEnumerable,ee=(o,e,t)=>e in o?Re(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t,te=(o,e)=>{for(var t in e||(e={}))Fe.call(e,t)&&ee(o,t,e[t]);if(Y)for(var t of Y(e))Ve.call(e,t)&&ee(o,t,e[t]);return o},S={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function De(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function T(o){return te(te({},De()),o)}var j=!1;function qe(){return j}function v(o,e,t){j&&(console.group(`\u{1F50D} ${o}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function z(o,e){if(!j)return;let t=o.value.slice(o.selectionStart,o.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${o.selectionStart}-${o.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=o.value.slice(Math.max(0,o.selectionStart-10),o.selectionStart),i=o.value.slice(o.selectionEnd,Math.min(o.value.length,o.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(i)),console.groupEnd()}function re(o){j&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(o.text)),console.log("New selection:",`${o.selectionStart}-${o.selectionEnd}`),console.groupEnd())}var E=null;function I(o,{text:e,selectionStart:t,selectionEnd:n}){let i=qe();i&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${o.selectionStart}-${o.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),o.focus();let r=o.selectionStart,s=o.selectionEnd,l=o.value.slice(0,r),a=o.value.slice(s);i&&(console.log("Before text (last 20):",JSON.stringify(l.slice(-20))),console.log("After text (first 20):",JSON.stringify(a.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(o.value.slice(r,s))));let c=o.value,d=r!==s;if(E===null||E===!0){o.contentEditable="true";try{E=document.execCommand("insertText",!1,e),i&&console.log("execCommand returned:",E,"for text with",e.split(`
`).length,"lines")}catch(p){E=!1,i&&console.log("execCommand threw error:",p)}o.contentEditable="false"}if(i&&(console.log("canInsertText before:",E),console.log("execCommand result:",E)),E){let p=l+e+a,u=o.value;i&&(console.log("Expected length:",p.length),console.log("Actual length:",u.length)),u!==p&&i&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(p.slice(0,100))),console.log("Actual:",JSON.stringify(u.slice(0,100))))}if(!E)if(i&&console.log("Using manual insertion"),o.value===c){i&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(p){}o.value=l+e+a;try{document.execCommand("ms-endUndoUnit")}catch(p){}o.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else i&&console.log("Value was changed by execCommand, skipping manual insertion");i&&console.log("Setting selection range:",t,n),t!=null&&n!=null?o.setSelectionRange(t,n):o.setSelectionRange(r,o.selectionEnd),i&&(console.log("Final value length:",o.value.length),console.groupEnd())}function ne(o){return o.trim().split(`
...
`),t=0;for(let n=0;n<e.length;n++){let i=e[n].length+1;o.selectionStart>=t&&o.selectionStart<t+i&&(o.selectionStart=t),o.selectionEnd>=t&&o.selectionEnd<t+i&&(n===e.length-1?o.selectionEnd=Math.min(t+e[n].length,o.value.length):o.selectionEnd=t+i-1),t+=i}}function Ke(o,e,t,n=!1){if(o.selectionStart===o.selectionEnd)o.selectionStart=Ue(o.value,o.selectionStart),o.selectionEnd=We(o.value,o.selectionEnd,n);else{let i=o.selectionStart-e.length,r=o.selectionEnd+t.length,s=o.value.slice(i,o.selectionStart)===e,l=o.value.slice(o.selectionEnd,r)===t;s&&l&&(o.selectionStart=i,o.selectionEnd=r)}return o.value.slice(o.selectionStart,o.selectionEnd)}function J(o){let e=o.value.slice(0,o.selectionStart),t=o.value.slice(o.selectionEnd),n=e.match(/\n*$/),i=t.match(/^\n*/),r=n?n[0].length:0,s=i?i[0].length:0,l="",a="";return e.match(/\S/)&&r<2&&(l=`
`.repeat(2-r)),t.match(/\S/)&&s<2&&(a=`
`.repeat(2-s)),{newlinesToAppend:l,newlinesToPrepend:a}}function R(o,e,t={}){let n=o.selectionStart,i=o.selectionEnd,r=n===i,s=o.value,l=n;for(;l>0&&s[l-1]!==`
`;)l--;if(r){let c=n;for(;c<s.length&&s[c]!==`
`;)c++;o.selectionStart=l,o.selectionEnd=c}else se(o);let a=e(o);if(t.adjustSelection){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(d,n,i,l);a.selectionStart=p.start,a.selectionEnd=p.end}else if(t.prefix){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix);r?d?(a.selectionStart=Math.max(n-t.prefix.length,l),a.selectionEnd=a.selectionStart):(a.selectionStart=n+t.prefix.length,a.selectionEnd=a.selectionStart):d?(a.selectionStart=Math.max(n-t.prefix.length,l),a.selectionEnd=Math.max(i-t.prefix.length,l)):(a.selectionStart=n+t.prefix.length,a.selectionEnd=i+t.prefix.length)}return a}function F(o,e){let t,n,{prefix:i,suffix:r,blockPrefix:s,blockSuffix:l,replaceNext:a,prefixSpace:c,scanFor:d,surroundWithNewlines:p,trimFirst:u}=e,h=o.selectionStart,f=o.selectionEnd,g=o.value.slice(o.selectionStart,o.selectionEnd),m=ne(g)&&s&&s.length>0?`${s}
`:i,b=ne(g)&&l&&l.length>0?`
${l}`:r;if(c){let x=o.value[o.selectionStart-1];o.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(m=` ${m}`)}g=Ke(o,m,b,e.multiline);let y=o.selectionStart,k=o.selectionEnd,M=a&&a.length>0&&b.indexOf(a)>-1&&g.length>0;if(p){let x=J(o);t=x.newlinesToAppend,n=x.newlinesToPrepend,m=t+i,b+=n}if(g.startsWith(m)&&g.endsWith(b)){let x=g.slice(m.length,g.length-b.length);if(h===f){let C=h-m.length;C=Math.max(C,y),C=Math.min(C,y+x.length),y=k=C}else k=y+x.length;return{text:x,selectionStart:y,selectionEnd:k}}else if(M)if(d&&d.length>0&&g.match(d)){b=b.replace(a,g);let x=m+b;return y=k=y+m.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=m+g+b;return y=y+m.length+g.length+b.indexOf(a),k=y+a.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=m+g+b;y=h+m.length,k=f+m.length;let C=g.match(/^\s*|\s*$/g);if(u&&C){let G=C[0]||"",X=C[1]||"";x=G+m+g.trim()+b+X,y+=G.length,k-=X.length}return{text:x,selectionStart:y,selectionEnd:k}}}function ae(o,e){let{prefix:t,suffix:n,surroundWithNewlines:i}=e,r=o.value.slice(o.selectionStart,o.selectionEnd),s=o.selectionStart,l=o.selectionEnd,a=r.split(`
...
`),i){let{newlinesToAppend:d,newlinesToPrepend:p}=J(o);s+=d.length,l=s+r.length,r=d+r+p}return{text:r,selectionStart:s,selectionEnd:l}}function oe(o){let e=o.split(`
...
`),processed:n}}function P(o,e){return e?"- ":`${o+1}. `}function Ze(o,e){let t,n,i;return o.orderedList?(t=oe(e),n=ie(t.text),i=n.text):(t=ie(e),n=oe(t.text),i=n.text),[t,n,i]}function Je(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;se(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,l,a]=Ze(e,r),c=a.split(`
`).map((g,m)=>`${P(m,e.unorderedList)}${g}`),d=c.reduce((g,m,b)=>g+P(b,e.unorderedList).length,0),p=c.reduce((g,m,b)=>g+P(b,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-P(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-d),{text:a,selectionStart:n,selectionEnd:i};let{newlinesToAppend:u,newlinesToPrepend:h}=J(o),f=u+c.join(`
`)+h;return t?(n=Math.max(n+P(0,e.unorderedList).length+u.length,0),i=n):l.processed?(n=Math.max(o.selectionStart+u.length,0),i=o.selectionEnd+u.length+d-p):(n=Math.max(o.selectionStart+u.length,0),i=o.selectionEnd+u.length+d),{text:f,selectionStart:n,selectionEnd:i}}function le(o,e){let t=R(o,n=>Je(n,e),{adjustSelection:(n,i,r,s)=>{let l=o.value.slice(s,o.selectionEnd),a=/^\d+\.\s+/,c=/^- /,d=a.test(l),p=c.test(l),u=e.orderedList&&d||e.unorderedList&&p;if(i===r)if(u){let h=l.match(e.orderedList?a:c),f=h?h[0].length:0;return{start:Math.max(i-f,s),end:Math.max(i-f,s)}}else if(d||p){let h=l.match(d?a:c),f=h?h[0].length:0,m=(e.unorderedList?2:3)-f;return{start:i+m,end:i+m}}else{let h=e.unorderedList?2:3;return{start:i+h,end:i+h}}else if(u){let h=l.match(e.orderedList?a:c),f=h?h[0].length:0;return{start:Math.max(i-f,s),end:Math.max(r-f,s)}}else if(d||p){let h=l.match(d?a:c),f=h?h[0].length:0,m=(e.unorderedList?2:3)-f;return{start:i+m,end:r+m}}else{let h=e.unorderedList?2:3;return{start:i+h,end:r+h}}}});I(o,t)}function Qe(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),s=0,l="";for(let p of r){if(t>=s&&t<=s+p.length){l=p;break}s+=p.length+1}l.startsWith("- ")&&(l.startsWith("- [ ] ")||l.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(l)&&e.push("numbered-list"),l.startsWith("> ")&&e.push("quote"),l.startsWith("# ")&&e.push("header"),l.startsWith("## ")&&e.push("header-2"),l.startsWith("### ")&&e.push("header-3");let a=Math.max(0,t-10),c=Math.min(i.length,n+10),d=i.slice(a,c);if(d.includes("**")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(n,Math.min(i.length,n+100)),h=p.lastIndexOf("**"),f=u.indexOf("**");h!==-1&&f!==-1&&e.push("bold")}if(d.includes("_")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(n,Math.min(i.length,n+100)),h=p.lastIndexOf("_"),f=u.indexOf("_");h!==-1&&f!==-1&&e.push("italic")}if(d.includes("`")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(n,Math.min(i.length,n+100));p.includes("`")&&u.includes("`")&&e.push("code")}if(d.includes("[")&&d.includes("]")){let p=i.slice(Math.max(0,t-100),t),u=i.slice(n,Math.min(i.length,n+100)),h=p.lastIndexOf("["),f=u.indexOf("]");h!==-1&&f!==-1&&i.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function V(o){if(!o||o.disabled||o.readOnly)return;v("toggleBold","Starting"),z(o,"Before");let e=T(S.bold),t=F(o,e);re(t),I(o,t),z(o,"After")}function D(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.italic),t=F(o,e);I(o,t)}function ce(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.code),t=F(o,e);I(o,t)}function q(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=T(S.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=o.selectionStart;o.value=o.value.slice(0,s)+e.text+o.value.slice(s),o.selectionStart=s,o.selectionEnd=s+e.text.length}let r=F(o,n);I(o,r)}function U(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.bulletList);le(o,e)}function W(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.numberedList);le(o,e)}function pe(o){if(!o||o.disabled||o.readOnly)return;v("toggleQuote","Starting"),z(o,"Initial");let e=T(S.quote),t=R(o,n=>ae(n,e),{prefix:e.prefix});re(t),I(o,t),z(o,"Final")}function de(o){if(!o||o.disabled||o.readOnly)return;let e=T(S.taskList),t=R(o,n=>ae(n,e),{prefix:e.prefix});I(o,t)}function Q(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),v("insertHeader","============ START ============"),v("insertHeader",`Level: ${e}, Toggle: ${t}`),v("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=T(S[n]||S.header1);v("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,s=o.selectionStart,l=o.selectionEnd,a=s;for(;a>0&&r[a-1]!==`
`;)a--;let c=l;for(;c<r.length&&r[c]!==`
`;)c++;let d=r.slice(a,c);v("insertHeader",`Current line (before): "${d}"`);let p=d.match(/^(#{1,6})\s*/),u=p?p[1].length:0,h=p?p[0].length:0;v("insertHeader","Existing header check:"),v("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),v("insertHeader",`  - Existing level: ${u}`),v("insertHeader",`  - Existing prefix length: ${h}`),v("insertHeader",`  - Target level: ${e}`);let f=t&&u===e;v("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${u}, level=${e})`);let g=R(o,m=>{let b=m.value.slice(m.selectionStart,m.selectionEnd);v("insertHeader",`Line in operation: "${b}"`);let y=b.replace(/^#{1,6}\s*/,"");v("insertHeader",`Cleaned line: "${y}"`);let k;return f?(v("insertHeader","ACTION: Toggling OFF - removing header"),k=y):u>0?(v("insertHeader",`ACTION: Replacing H${u} with H${e}`),k=i.prefix+y):(v("insertHeader","ACTION: Adding new header"),k=i.prefix+y),v("insertHeader",`New line: "${k}"`),{text:k,selectionStart:m.selectionStart,selectionEnd:m.selectionEnd}},{prefix:i.prefix,adjustSelection:(m,b,y,k)=>{if(v("insertHeader","Adjusting selection:"),v("insertHeader",`  - isRemoving param: ${m}`),v("insertHeader",`  - shouldToggleOff: ${f}`),v("insertHeader",`  - selStart: ${b}, selEnd: ${y}`),v("insertHeader",`  - lineStartPos: ${k}`),f){let M=Math.max(b-h,k);return v("insertHeader",`  - Removing header, adjusting by -${h}`),{start:M,end:b===y?M:Math.max(y-h,k)}}else if(h>0){let M=i.prefix.length-h;return v("insertHeader",`  - Replacing header, adjusting by ${M}`),{start:b+M,end:y+M}}else return v("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:b+i.prefix.length,end:y+i.prefix.length}}});v("insertHeader",`Final result: text="${g.text}", cursor=${g.selectionStart}-${g.selectionEnd}`),v("insertHeader","============ END ============"),I(o,g)}function ue(o){Q(o,1,!0)}function he(o){Q(o,2,!0)}function me(o){Q(o,3,!0)}function fe(o){return Qe(o)}var N=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var $={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:$,cave:ve,light:$,dark:ve};function B(o){return typeof o=="string"?{...ye[o]||ye.solar,name:o}:o}function _(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
`)}function be(o,e={}){return{...o,colors:{...o.colors,...e}}}function we(o={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:s={}}=o,l=Object.keys(s).length>0?`
  ...
  `:"",a=r&&r.colors?_(r.colors):"";return`
