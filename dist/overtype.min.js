...
`),i){let{newlinesToAppend:l,newlinesToPrepend:c}=Z(o);s+=l.length,a=s+r.length,r=l+r+c}return{text:r,selectionStart:s,selectionEnd:a}}function ae(o){let e=o.split(`
