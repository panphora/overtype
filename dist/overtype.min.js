...
`),h.textContent+=g,c.remove();continue}let p=null;if(c.tagName==="DIV"&&(p=c.querySelector("li")),p){let h=p.classList.contains("bullet-list"),u=p.classList.contains("ordered-list");if(!h&&!u){n=null,i=null;continue}let m=h?"ul":"ol";(!n||i!==m)&&(n=document.createElement(m),t.insertBefore(n,c),i=m),n.appendChild(p),c.remove()}else n=null,i=null}return t.innerHTML}static postProcessHTMLManual(e){let t=e;t=t.replace(/((?:<div>(?:&nbsp;)*<li class="bullet-list">.*?<\/li><\/div>\s*)+)/gs,i=>{let r=i.match(/<li class="bullet-list">.*?<\/li>/gs)||[];return r.length>0?"<ul>"+r.join("")+"</ul>":i}),t=t.replace(/((?:<div>(?:&nbsp;)*<li class="ordered-list">.*?<\/li><\/div>\s*)+)/gs,i=>{let r=i.match(/<li class="ordered-list">.*?<\/li>/gs)||[];return r.length>0?"<ol>"+r.join("")+"</ol>":i});let n=/<div><span class="code-fence">(```[^<]*)<\/span><\/div>(.*?)<div><span class="code-fence">(```)<\/span><\/div>/gs;return t=t.replace(n,(i,r,s,l)=>{let c=(s.match(/<div>(.*?)<\/div>/gs)||[]).map(u=>{let m=u.replace(/<div>(.*?)<\/div>/s,"$1");return/^(&nbsp;)*$/.test(m.trim())?"":m.replace(/&nbsp;/g," ")}).join(`
...
`;)c++;o.selectionStart=l,o.selectionEnd=c}else se(o);let a=e(o);if(t.adjustSelection){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix),p=t.adjustSelection(d,n,i,l);a.selectionStart=p.start,a.selectionEnd=p.end}else if(t.prefix){let d=o.value.slice(o.selectionStart,o.selectionEnd).startsWith(t.prefix);r?d?(a.selectionStart=Math.max(n-t.prefix.length,l),a.selectionEnd=a.selectionStart):(a.selectionStart=n+t.prefix.length,a.selectionEnd=a.selectionStart):d?(a.selectionStart=Math.max(n-t.prefix.length,l),a.selectionEnd=Math.max(i-t.prefix.length,l)):(a.selectionStart=n+t.prefix.length,a.selectionEnd=i+t.prefix.length)}return a}function F(o,e){let t,n,{prefix:i,suffix:r,blockPrefix:s,blockSuffix:l,replaceNext:a,prefixSpace:c,scanFor:d,surroundWithNewlines:p,trimFirst:h}=e,u=o.selectionStart,m=o.selectionEnd,g=o.value.slice(o.selectionStart,o.selectionEnd),f=ne(g)&&s&&s.length>0?`${s}
`:i,b=ne(g)&&l&&l.length>0?`
${l}`:r;if(c){let x=o.value[o.selectionStart-1];o.selectionStart!==0&&x!=null&&!x.match(/\s/)&&(f=` ${f}`)}g=Ke(o,f,b,e.multiline);let y=o.selectionStart,k=o.selectionEnd,H=a&&a.length>0&&b.indexOf(a)>-1&&g.length>0;if(p){let x=J(o);t=x.newlinesToAppend,n=x.newlinesToPrepend,f=t+i,b+=n}if(g.startsWith(f)&&g.endsWith(b)){let x=g.slice(f.length,g.length-b.length);if(u===m){let E=u-f.length;E=Math.max(E,y),E=Math.min(E,y+x.length),y=k=E}else k=y+x.length;return{text:x,selectionStart:y,selectionEnd:k}}else if(H)if(d&&d.length>0&&g.match(d)){b=b.replace(a,g);let x=f+b;return y=k=y+f.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+b;return y=y+f.length+g.length+b.indexOf(a),k=y+a.length,{text:x,selectionStart:y,selectionEnd:k}}else{let x=f+g+b;y=u+f.length,k=m+f.length;let E=g.match(/^\s*|\s*$/g);if(h&&E){let G=E[0]||"",X=E[1]||"";x=G+f+g.trim()+b+X,y+=G.length,k-=X.length}return{text:x,selectionStart:y,selectionEnd:k}}}function ae(o,e){let{prefix:t,suffix:n,surroundWithNewlines:i}=e,r=o.value.slice(o.selectionStart,o.selectionEnd),s=o.selectionStart,l=o.selectionEnd,a=r.split(`
...
`),processed:n}}function B(o,e){return e?"- ":`${o+1}. `}function Ze(o,e){let t,n,i;return o.orderedList?(t=oe(e),n=ie(t.text),i=n.text):(t=ie(e),n=oe(t.text),i=n.text),[t,n,i]}function Je(o,e){let t=o.selectionStart===o.selectionEnd,n=o.selectionStart,i=o.selectionEnd;se(o);let r=o.value.slice(o.selectionStart,o.selectionEnd),[s,l,a]=Ze(e,r),c=a.split(`
`).map((g,f)=>`${B(f,e.unorderedList)}${g}`),d=c.reduce((g,f,b)=>g+B(b,e.unorderedList).length,0),p=c.reduce((g,f,b)=>g+B(b,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-B(0,e.unorderedList).length,0),i=n):(n=o.selectionStart,i=o.selectionEnd-d),{text:a,selectionStart:n,selectionEnd:i};let{newlinesToAppend:h,newlinesToPrepend:u}=J(o),m=h+c.join(`
`)+u;return t?(n=Math.max(n+B(0,e.unorderedList).length+h.length,0),i=n):l.processed?(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d-p):(n=Math.max(o.selectionStart+h.length,0),i=o.selectionEnd+h.length+d),{text:m,selectionStart:n,selectionEnd:i}}function le(o,e){let t=R(o,n=>Je(n,e),{adjustSelection:(n,i,r,s)=>{let l=o.value.slice(s,o.selectionEnd),a=/^\d+\.\s+/,c=/^- /,d=a.test(l),p=c.test(l),h=e.orderedList&&d||e.unorderedList&&p;if(i===r)if(h){let u=l.match(e.orderedList?a:c),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(i-m,s)}}else if(d||p){let u=l.match(d?a:c),m=u?u[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:i+f}}else{let u=e.unorderedList?2:3;return{start:i+u,end:i+u}}else if(h){let u=l.match(e.orderedList?a:c),m=u?u[0].length:0;return{start:Math.max(i-m,s),end:Math.max(r-m,s)}}else if(d||p){let u=l.match(d?a:c),m=u?u[0].length:0,f=(e.unorderedList?2:3)-m;return{start:i+f,end:r+f}}else{let u=e.unorderedList?2:3;return{start:i+u,end:r+u}}}});$(o,t)}function Qe(o){if(!o)return[];let e=[],{selectionStart:t,selectionEnd:n,value:i}=o,r=i.split(`
`),s=0,l="";for(let p of r){if(t>=s&&t<=s+p.length){l=p;break}s+=p.length+1}l.startsWith("- ")&&(l.startsWith("- [ ] ")||l.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(l)&&e.push("numbered-list"),l.startsWith("> ")&&e.push("quote"),l.startsWith("# ")&&e.push("header"),l.startsWith("## ")&&e.push("header-2"),l.startsWith("### ")&&e.push("header-3");let a=Math.max(0,t-10),c=Math.min(i.length,n+10),d=i.slice(a,c);if(d.includes("**")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("**"),m=h.indexOf("**");u!==-1&&m!==-1&&e.push("bold")}if(d.includes("_")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("_"),m=h.indexOf("_");u!==-1&&m!==-1&&e.push("italic")}if(d.includes("`")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100));p.includes("`")&&h.includes("`")&&e.push("code")}if(d.includes("[")&&d.includes("]")){let p=i.slice(Math.max(0,t-100),t),h=i.slice(n,Math.min(i.length,n+100)),u=p.lastIndexOf("["),m=h.indexOf("]");u!==-1&&m!==-1&&i.slice(n+m+1,n+m+10).startsWith("(")&&e.push("link")}return e}function V(o){if(!o||o.disabled||o.readOnly)return;v("toggleBold","Starting"),z(o,"Before");let e=A(S.bold),t=F(o,e);re(t),$(o,t),z(o,"After")}function D(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.italic),t=F(o,e);$(o,t)}function ce(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.code),t=F(o,e);$(o,t)}function q(o,e={}){if(!o||o.disabled||o.readOnly)return;let t=o.value.slice(o.selectionStart,o.selectionEnd),n=A(S.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=o.selectionStart;o.value=o.value.slice(0,s)+e.text+o.value.slice(s),o.selectionStart=s,o.selectionEnd=s+e.text.length}let r=F(o,n);$(o,r)}function U(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.bulletList);le(o,e)}function W(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.numberedList);le(o,e)}function pe(o){if(!o||o.disabled||o.readOnly)return;v("toggleQuote","Starting"),z(o,"Initial");let e=A(S.quote),t=R(o,n=>ae(n,e),{prefix:e.prefix});re(t),$(o,t),z(o,"Final")}function de(o){if(!o||o.disabled||o.readOnly)return;let e=A(S.taskList),t=R(o,n=>ae(n,e),{prefix:e.prefix});$(o,t)}function Q(o,e=1,t=!1){if(!o||o.disabled||o.readOnly)return;(e<1||e>6)&&(e=1),v("insertHeader","============ START ============"),v("insertHeader",`Level: ${e}, Toggle: ${t}`),v("insertHeader",`Initial cursor: ${o.selectionStart}-${o.selectionEnd}`);let n=`header${e===1?"1":e}`,i=A(S[n]||S.header1);v("insertHeader",`Style prefix: "${i.prefix}"`);let r=o.value,s=o.selectionStart,l=o.selectionEnd,a=s;for(;a>0&&r[a-1]!==`
`;)a--;let c=l;for(;c<r.length&&r[c]!==`
`;)c++;let d=r.slice(a,c);v("insertHeader",`Current line (before): "${d}"`);let p=d.match(/^(#{1,6})\s*/),h=p?p[1].length:0,u=p?p[0].length:0;v("insertHeader","Existing header check:"),v("insertHeader",`  - Match: ${p?`"${p[0]}"`:"none"}`),v("insertHeader",`  - Existing level: ${h}`),v("insertHeader",`  - Existing prefix length: ${u}`),v("insertHeader",`  - Target level: ${e}`);let m=t&&h===e;v("insertHeader",`Should toggle OFF: ${m} (toggle=${t}, existingLevel=${h}, level=${e})`);let g=R(o,f=>{let b=f.value.slice(f.selectionStart,f.selectionEnd);v("insertHeader",`Line in operation: "${b}"`);let y=b.replace(/^#{1,6}\s*/,"");v("insertHeader",`Cleaned line: "${y}"`);let k;return m?(v("insertHeader","ACTION: Toggling OFF - removing header"),k=y):h>0?(v("insertHeader",`ACTION: Replacing H${h} with H${e}`),k=i.prefix+y):(v("insertHeader","ACTION: Adding new header"),k=i.prefix+y),v("insertHeader",`New line: "${k}"`),{text:k,selectionStart:f.selectionStart,selectionEnd:f.selectionEnd}},{prefix:i.prefix,adjustSelection:(f,b,y,k)=>{if(v("insertHeader","Adjusting selection:"),v("insertHeader",`  - isRemoving param: ${f}`),v("insertHeader",`  - shouldToggleOff: ${m}`),v("insertHeader",`  - selStart: ${b}, selEnd: ${y}`),v("insertHeader",`  - lineStartPos: ${k}`),m){let H=Math.max(b-u,k);return v("insertHeader",`  - Removing header, adjusting by -${u}`),{start:H,end:b===y?H:Math.max(y-u,k)}}else if(u>0){let H=i.prefix.length-u;return v("insertHeader",`  - Replacing header, adjusting by ${H}`),{start:b+H,end:y+H}}else return v("insertHeader",`  - Adding header, adjusting by +${i.prefix.length}`),{start:b+i.prefix.length,end:y+i.prefix.length}}});v("insertHeader",`Final result: text="${g.text}", cursor=${g.selectionStart}-${g.selectionEnd}`),v("insertHeader","============ END ============"),$(o,g)}function he(o){Q(o,1,!0)}function ue(o){Q(o,2,!0)}function me(o){Q(o,3,!0)}function fe(o){return Qe(o)}var N=class{constructor(e){this.editor=e,this.textarea=e.textarea}handleKeydown(e){if(!(navigator.platform.toLowerCase().includes("mac")?e.metaKey:e.ctrlKey))return!1;let i=null;switch(e.key.toLowerCase()){case"b":e.shiftKey||(i="toggleBold");break;case"i":e.shiftKey||(i="toggleItalic");break;case"k":e.shiftKey||(i="insertLink");break;case"7":e.shiftKey&&(i="toggleNumberedList");break;case"8":e.shiftKey&&(i="toggleBulletList");break}return i?(e.preventDefault(),this.editor.toolbar?this.editor.toolbar.handleAction(i):this.handleAction(i),!0):!1}async handleAction(e){let t=this.textarea;if(t){t.focus();try{switch(e){case"toggleBold":V(t);break;case"toggleItalic":D(t);break;case"insertLink":q(t);break;case"toggleBulletList":U(t);break;case"toggleNumberedList":W(t);break}t.dispatchEvent(new Event("input",{bubbles:!0}))}catch(n){console.error("Error in markdown action:",n)}}}destroy(){}};var I={name:"solar",colors:{bgPrimary:"#faf0ca",bgSecondary:"#ffffff",text:"#0d3b66",h1:"#f95738",h2:"#ee964b",h3:"#3d8a51",strong:"#ee964b",em:"#f95738",link:"#0d3b66",code:"#0d3b66",codeBg:"rgba(244, 211, 94, 0.4)",blockquote:"#5a7a9b",hr:"#5a7a9b",syntaxMarker:"rgba(13, 59, 102, 0.52)",cursor:"#f95738",selection:"rgba(244, 211, 94, 0.4)",listMarker:"#ee964b",toolbarBg:"#ffffff",toolbarBorder:"rgba(13, 59, 102, 0.15)",toolbarIcon:"#0d3b66",toolbarHover:"#f5f5f5",toolbarActive:"#faf0ca"}},ve={name:"cave",colors:{bgPrimary:"#141E26",bgSecondary:"#1D2D3E",text:"#c5dde8",h1:"#d4a5ff",h2:"#f6ae2d",h3:"#9fcfec",strong:"#f6ae2d",em:"#9fcfec",link:"#9fcfec",code:"#c5dde8",codeBg:"#1a232b",blockquote:"#9fcfec",hr:"#c5dde8",syntaxMarker:"rgba(159, 207, 236, 0.73)",cursor:"#f26419",selection:"rgba(51, 101, 138, 0.4)",listMarker:"#f6ae2d",toolbarBg:"#1D2D3E",toolbarBorder:"rgba(197, 221, 232, 0.1)",toolbarIcon:"#c5dde8",toolbarHover:"#243546",toolbarActive:"#2a3f52"}},ye={solar:I,cave:ve,light:I,dark:ve};function P(o){return typeof o=="string"?{...ye[o]||ye.solar,name:o}:o}function O(o){let e=[];for(let[t,n]of Object.entries(o)){let i=t.replace(/([A-Z])/g,"-$1").toLowerCase();e.push(`--${i}: ${n};`)}return e.join(`
`)}function be(o,e={}){return{...o,colors:{...o.colors,...e}}}function we(o={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:i="20px",theme:r=null,mobile:s={}}=o,l=Object.keys(s).length>0?`
  ...
  `:"",a=r&&r.colors?O(r.colors):"";return`
