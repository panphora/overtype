...
`;)c++;t.selectionStart=a,t.selectionEnd=c}else wt(t);let l=e(t);if(n.adjustSelection){let p=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix),d=n.adjustSelection(p,i,o,a);l.selectionStart=d.start,l.selectionEnd=d.end}else if(n.prefix){let p=t.value.slice(t.selectionStart,t.selectionEnd).startsWith(n.prefix);r?p?(l.selectionStart=Math.max(i-n.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=i+n.prefix.length,l.selectionEnd=l.selectionStart):p?(l.selectionStart=Math.max(i-n.prefix.length,a),l.selectionEnd=Math.max(o-n.prefix.length,a)):(l.selectionStart=i+n.prefix.length,l.selectionEnd=o+n.prefix.length)}return l}function te(t,e){let n,i,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:c,scanFor:p,surroundWithNewlines:d,trimFirst:u}=e,h=t.selectionStart,f=t.selectionEnd,m=t.value.slice(t.selectionStart,t.selectionEnd),v=Ke(m)&&s&&s.length>0?`${s}
`:o,y=Ke(m)&&a&&a.length>0?`
${a}`:r;if(c){let k=t.value[t.selectionStart-1];t.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(v=` ${v}`)}m=_n(t,v,y,e.multiline);let w=t.selectionStart,b=t.selectionEnd,L=l&&l.length>0&&y.indexOf(l)>-1&&m.length>0;if(d){let k=Qe(t);n=k.newlinesToAppend,i=k.newlinesToPrepend,v=n+o,y+=i}if(m.startsWith(v)&&m.endsWith(y)){let k=m.slice(v.length,m.length-y.length);if(h===f){let E=h-v.length;E=Math.max(E,w),E=Math.min(E,w+k.length),w=b=E}else b=w+k.length;return{text:k,selectionStart:w,selectionEnd:b}}else if(L)if(p&&p.length>0&&m.match(p)){y=y.replace(l,m);let k=v+y;return w=b=w+v.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=v+m+y;return w=w+v.length+m.length+y.indexOf(l),b=w+l.length,{text:k,selectionStart:w,selectionEnd:b}}else{let k=v+m+y;w=h+v.length,b=f+v.length;let E=m.match(/^\s*|\s*$/g);if(u&&E){let be=E[0]||"",Y=E[1]||"";k=be+v+m.trim()+y+Y,w+=be.length,b-=Y.length}return{text:k,selectionStart:w,selectionEnd:b}}}function Ge(t,e){let{prefix:n,suffix:i,surroundWithNewlines:o}=e,r=t.value.slice(t.selectionStart,t.selectionEnd),s=t.selectionStart,a=t.selectionEnd,l=r.split(`
...
`),o){let{newlinesToAppend:p,newlinesToPrepend:d}=Qe(t);s+=p.length,a=s+r.length,r=p+r+d}return{text:r,selectionStart:s,selectionEnd:a}}function ft(t){let e=t.split(`
...
`),processed:i}}function le(t,e){return e?"- ":`${t+1}. `}function Pn(t,e){let n,i,o;return t.orderedList?(n=ft(e),i=mt(n.text),o=i.text):(n=mt(e),i=ft(n.text),o=i.text),[n,i,o]}function $n(t,e){let n=t.selectionStart===t.selectionEnd,i=t.selectionStart,o=t.selectionEnd;wt(t);let r=t.value.slice(t.selectionStart,t.selectionEnd),[s,a,l]=Pn(e,r),c=l.split(`
`).map((m,v)=>`${le(v,e.unorderedList)}${m}`),p=c.reduce((m,v,y)=>m+le(y,e.unorderedList).length,0),d=c.reduce((m,v,y)=>m+le(y,!e.unorderedList).length,0);if(s.processed)return n?(i=Math.max(i-le(0,e.unorderedList).length,0),o=i):(i=t.selectionStart,o=t.selectionEnd-p),{text:l,selectionStart:i,selectionEnd:o};let{newlinesToAppend:u,newlinesToPrepend:h}=Qe(t),f=u+c.join(`
`)+h;return n?(i=Math.max(i+le(0,e.unorderedList).length+u.length,0),o=i):a.processed?(i=Math.max(t.selectionStart+u.length,0),o=t.selectionEnd+u.length+p-d):(i=Math.max(t.selectionStart+u.length,0),o=t.selectionEnd+u.length+p),{text:f,selectionStart:i,selectionEnd:o}}function xt(t,e){let n=Se(t,i=>$n(i,e),{adjustSelection:(i,o,r,s)=>{let a=t.value.slice(s,t.selectionEnd),l=/^\d+\.\s+/,c=/^- /,p=l.test(a),d=c.test(a),u=e.orderedList&&p||e.unorderedList&&d;if(o===r)if(u){let h=a.match(e.orderedList?l:c),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(p||d){let h=a.match(p?l:c),f=h?h[0].length:0,v=(e.unorderedList?2:3)-f;return{start:o+v,end:o+v}}else{let h=e.unorderedList?2:3;return{start:o+h,end:o+h}}else if(u){let h=a.match(e.orderedList?l:c),f=h?h[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(p||d){let h=a.match(p?l:c),f=h?h[0].length:0,v=(e.unorderedList?2:3)-f;return{start:o+v,end:r+v}}else{let h=e.unorderedList?2:3;return{start:o+h,end:r+h}}}});N(t,n)}function kt(t){if(!t)return[];let e=[],{selectionStart:n,selectionEnd:i,value:o}=t,r=o.split(`
`),s=0,a="";for(let d of r){if(n>=s&&n<=s+d.length){a=d;break}s+=d.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,n-10),c=Math.min(o.length,i+10),p=o.slice(l,c);if(p.includes("**")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("**"),f=u.indexOf("**");h!==-1&&f!==-1&&e.push("bold")}if(p.includes("_")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("_"),f=u.indexOf("_");h!==-1&&f!==-1&&e.push("italic")}if(p.includes("`")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100));d.includes("`")&&u.includes("`")&&e.push("code")}if(p.includes("[")&&p.includes("]")){let d=o.slice(Math.max(0,n-100),n),u=o.slice(i,Math.min(o.length,i+100)),h=d.lastIndexOf("["),f=u.indexOf("]");h!==-1&&f!==-1&&o.slice(i+f+1,i+f+10).startsWith("(")&&e.push("link")}return e}function Hn(t,e){return kt(t).includes(e)}function On(t,e={}){if(!t)return;let{toWord:n,toLine:i,toFormat:o}=e,{selectionStart:r,selectionEnd:s,value:a}=t;if(i){let l=a.split(`
`),c=0,p=0,d=0;for(let u of l){if(r>=d&&r<=d+u.length){c=d,p=d+u.length;break}d+=u.length+1}t.selectionStart=c,t.selectionEnd=p}else if(n&&r===s){let l=r,c=s;for(;l>0&&!/\s/.test(a[l-1]);)l--;for(;c<a.length&&!/\s/.test(a[c]);)c++;t.selectionStart=l,t.selectionEnd=c}}function Ee(t){if(!t||t.disabled||t.readOnly)return;x("toggleBold","Starting"),Le(t,"Before");let e=R(I.bold),n=te(t,e);vt(n),N(t,n),Le(t,"After")}function Te(t){if(!t||t.disabled||t.readOnly)return;let e=R(I.italic),n=te(t,e);N(t,n)}function Ce(t){if(!t||t.disabled||t.readOnly)return;let e=R(I.code),n=te(t,e);N(t,n)}function Ae(t,e={}){if(!t||t.disabled||t.readOnly)return;let n=t.value.slice(t.selectionStart,t.selectionEnd),i=R(I.link);if(n&&n.match(/^https?:\/\//)&&!e.url?(i.suffix=`](${n})`,i.replaceNext=""):e.url&&(i.suffix=`](${e.url})`,i.replaceNext=""),e.text&&!n){let s=t.selectionStart;t.value=t.value.slice(0,s)+e.text+t.value.slice(s),t.selectionStart=s,t.selectionEnd=s+e.text.length}let r=te(t,i);N(t,r)}function Me(t){if(!t||t.disabled||t.readOnly)return;let e=R(I.bulletList);xt(t,e)}function _e(t){if(!t||t.disabled||t.readOnly)return;let e=R(I.numberedList);xt(t,e)}function Pe(t){if(!t||t.disabled||t.readOnly)return;x("toggleQuote","Starting"),Le(t,"Initial");let e=R(I.quote),n=Se(t,i=>Ge(i,e),{prefix:e.prefix});vt(n),N(t,n),Le(t,"Final")}function pe(t){if(!t||t.disabled||t.readOnly)return;let e=R(I.taskList),n=Se(t,i=>Ge(i,e),{prefix:e.prefix});N(t,n)}function de(t,e=1,n=!1){if(!t||t.disabled||t.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${n}`),x("insertHeader",`Initial cursor: ${t.selectionStart}-${t.selectionEnd}`);let i=`header${e===1?"1":e}`,o=R(I[i]||I.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=t.value,s=t.selectionStart,a=t.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let c=a;for(;c<r.length&&r[c]!==`
`;)c++;let p=r.slice(l,c);x("insertHeader",`Current line (before): "${p}"`);let d=p.match(/^(#{1,6})\s*/),u=d?d[1].length:0,h=d?d[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${d?`"${d[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${u}`),x("insertHeader",`  - Existing prefix length: ${h}`),x("insertHeader",`  - Target level: ${e}`);let f=n&&u===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${n}, existingLevel=${u}, level=${e})`);let m=Se(t,v=>{let y=v.value.slice(v.selectionStart,v.selectionEnd);x("insertHeader",`Line in operation: "${y}"`);let w=y.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${w}"`);let b;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),b=w):u>0?(x("insertHeader",`ACTION: Replacing H${u} with H${e}`),b=o.prefix+w):(x("insertHeader","ACTION: Adding new header"),b=o.prefix+w),x("insertHeader",`New line: "${b}"`),{text:b,selectionStart:v.selectionStart,selectionEnd:v.selectionEnd}},{prefix:o.prefix,adjustSelection:(v,y,w,b)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${v}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${y}, selEnd: ${w}`),x("insertHeader",`  - lineStartPos: ${b}`),f){let L=Math.max(y-h,b);return x("insertHeader",`  - Removing header, adjusting by -${h}`),{start:L,end:y===w?L:Math.max(w-h,b)}}else if(h>0){let L=o.prefix.length-h;return x("insertHeader",`  - Replacing header, adjusting by ${L}`),{start:y+L,end:w+L}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:y+o.prefix.length,end:w+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),N(t,m)}function $e(t){de(t,1,!0)}function He(t){de(t,2,!0)}function Oe(t){de(t,3,!0)}function Ie(t){return kt(t)}function Lt(t,e){return Hn(t,e)}function St(t,e={}){On(t,e)}function Et(t,e){if(!t||t.disabled||t.readOnly)return;let n=R(e),i;if(n.multiline){let o=t.value.slice(t.selectionStart,t.selectionEnd);Ke(o)?i=Ge(t,n):i=te(t,n)}else i=te(t,n);N(t,i)}var In={toggleBold:Ee,toggleItalic:Te,toggleCode:Ce,insertLink:Ae,toggleBulletList:Me,toggleNumberedList:_e,toggleQuote:Pe,toggleTaskList:pe,insertHeader:de,toggleH1:$e,toggleH2:He,toggleH3:Oe,getActiveFormats:Ie,hasFormat:Lt,expandSelection:St,applyCustomFormat:Et,preserveSelection:bt,setUndoMethod:yt,setDebugMode:gt,getDebugMode:Ze};var Re=class{constructor(e,n={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=n.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let n=this.createSeparator();this.container.appendChild(n)}else{let n=this.createButton(e);this.buttons[e.name]=n,this.container.appendChild(n)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let n=document.createElement("button");return n.className="overtype-toolbar-button",n.type="button",n.setAttribute("data-button",e.name),n.title=e.title||"",n.setAttribute("aria-label",e.title||e.name),n.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(n.classList.add("has-dropdown"),n.dataset.dropdown="true",n.addEventListener("click",i=>{i.preventDefault(),this.toggleViewModeDropdown(n)}),n):(n._clickHandler=i=>{i.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,i)},n.addEventListener("click",n._clickHandler),n)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:n=>this.editor.setValue(n),event:null}),!0}catch(n){return console.error(`Action "${e.name}" error:`,n),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:n}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){let n=document.querySelector(".overtype-dropdown-menu");if(n){n.remove(),e.classList.remove("dropdown-active");return}e.classList.add("dropdown-active");let i=this.createViewModeDropdown(e),o=e.getBoundingClientRect();i.style.position="absolute",i.style.top=`${o.bottom+5}px`,i.style.left=`${o.left}px`,document.body.appendChild(i),this.handleDocumentClick=r=>{!i.contains(r.target)&&!e.contains(r.target)&&(i.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createViewModeDropdown(e){let n=document.createElement("div");n.className="overtype-dropdown-menu";let i=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return i.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.textContent=r.label,r.id===o){s.classList.add("active"),s.setAttribute("aria-current","true");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),n.appendChild(s)}),n}updateButtonStates(){var e;try{let n=((e=Ie)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([i,o])=>{if(i==="viewMode")return;let r=!1;switch(i){case"bold":r=n.includes("bold");break;case"italic":r=n.includes("italic");break;case"code":r=!1;break;case"bulletList":r=n.includes("bullet-list");break;case"orderedList":r=n.includes("numbered-list");break;case"taskList":r=n.includes("task-list");break;case"quote":r=n.includes("quote");break;case"h1":r=n.includes("header");break;case"h2":r=n.includes("header-2");break;case"h3":r=n.includes("header-3");break}o.classList.toggle("active",r),o.setAttribute("aria-pressed",r.toString())})}catch(n){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var he=Math.min,W=Math.max,fe=Math.round;var H=t=>({x:t,y:t}),Rn={left:"right",right:"left",bottom:"top",top:"bottom"},Bn={start:"end",end:"start"};function Je(t,e,n){return W(t,he(e,n))}function me(t,e){return typeof t=="function"?t(e):t}function q(t){return t.split("-")[0]}function ge(t){return t.split("-")[1]}function Xe(t){return t==="x"?"y":"x"}function Ye(t){return t==="y"?"height":"width"}var Fn=new Set(["top","bottom"]);function D(t){return Fn.has(q(t))?"y":"x"}function et(t){return Xe(D(t))}function At(t,e,n){n===void 0&&(n=!1);let i=ge(t),o=et(t),r=Ye(o),s=o==="x"?i===(n?"end":"start")?"right":"left":i==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=ue(s)),[s,ue(s)]}function Mt(t){let e=ue(t);return[Be(t),e,Be(e)]}function Be(t){return t.replace(/start|end/g,e=>Bn[e])}var Tt=["left","right"],Ct=["right","left"],Nn=["top","bottom"],Dn=["bottom","top"];function zn(t,e,n){switch(t){case"top":case"bottom":return n?e?Ct:Tt:e?Tt:Ct;case"left":case"right":return e?Nn:Dn;default:return[]}}function _t(t,e,n,i){let o=ge(t),r=zn(q(t),n==="start",i);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(Be)))),r}function ue(t){return t.replace(/left|right|bottom|top/g,e=>Rn[e])}function jn(t){return{top:0,right:0,bottom:0,left:0,...t}}function Pt(t){return typeof t!="number"?jn(t):{top:t,right:t,bottom:t,left:t}}function G(t){let{x:e,y:n,width:i,height:o}=t;return{width:i,height:o,top:n,left:e,right:e+i,bottom:n+o,x:e,y:n}}function $t(t,e,n){let{reference:i,floating:o}=t,r=D(e),s=et(e),a=Ye(s),l=q(e),c=r==="y",p=i.x+i.width/2-o.width/2,d=i.y+i.height/2-o.height/2,u=i[a]/2-o[a]/2,h;switch(l){case"top":h={x:p,y:i.y-o.height};break;case"bottom":h={x:p,y:i.y+i.height};break;case"right":h={x:i.x+i.width,y:d};break;case"left":h={x:i.x-o.width,y:d};break;default:h={x:i.x,y:i.y}}switch(ge(e)){case"start":h[s]-=u*(n&&c?-1:1);break;case"end":h[s]+=u*(n&&c?-1:1);break}return h}async function Ht(t,e){var n;e===void 0&&(e={});let{x:i,y:o,platform:r,rects:s,elements:a,strategy:l}=t,{boundary:c="clippingAncestors",rootBoundary:p="viewport",elementContext:d="floating",altBoundary:u=!1,padding:h=0}=me(e,t),f=Pt(h),v=a[u?d==="floating"?"reference":"floating":d],y=G(await r.getClippingRect({element:(n=await(r.isElement==null?void 0:r.isElement(v)))==null||n?v:v.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:p,strategy:l})),w=d==="floating"?{x:i,y:o,width:s.floating.width,height:s.floating.height}:s.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),L=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},k=G(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:w,offsetParent:b,strategy:l}):w);return{top:(y.top-k.top+f.top)/L.y,bottom:(k.bottom-y.bottom+f.bottom)/L.y,left:(y.left-k.left+f.left)/L.x,right:(k.right-y.right+f.right)/L.x}}var Ot=async(t,e,n)=>{let{placement:i="bottom",strategy:o="absolute",middleware:r=[],platform:s}=n,a=r.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(e)),c=await s.getElementRects({reference:t,floating:e,strategy:o}),{x:p,y:d}=$t(c,i,l),u=i,h={},f=0;for(let v=0;v<a.length;v++){var m;let{name:y,fn:w}=a[v],{x:b,y:L,data:k,reset:E}=await w({x:p,y:d,initialPlacement:i,placement:u,strategy:o,middlewareData:h,rects:c,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:Ht},elements:{reference:t,floating:e}});p=b!=null?b:p,d=L!=null?L:d,h={...h,[y]:{...h[y],...k}},E&&f<=50&&(f++,typeof E=="object"&&(E.placement&&(u=E.placement),E.rects&&(c=E.rects===!0?await s.getElementRects({reference:t,floating:e,strategy:o}):E.rects),{x:p,y:d}=$t(c,u,l)),v=-1)}return{x:p,y:d,placement:u,strategy:o,middlewareData:h}};var It=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var n,i;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:l,elements:c}=e,{mainAxis:p=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...v}=me(t,e);if((n=r.arrow)!=null&&n.alignmentOffset)return{};let y=q(o),w=D(a),b=q(a)===a,L=await(l.isRTL==null?void 0:l.isRTL(c.floating)),k=u||(b||!m?[ue(a)]:Mt(a)),E=f!=="none";!u&&E&&k.push(..._t(a,m,f,L));let be=[a,...k],Y=await l.detectOverflow(e,v),xe=[],ee=((i=r.flip)==null?void 0:i.overflows)||[];if(p&&xe.push(Y[y]),d){let K=At(o,s,L);xe.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:xe}],!xe.every(K=>K<=0)){var it,ot;let K=(((it=r.flip)==null?void 0:it.index)||0)+1,We=be[K];if(We&&(!(d==="alignment"?w!==D(We):!1)||ee.every($=>D($.placement)===w?$.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:We}};let se=(ot=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,$)=>Z.overflows[1]-$.overflows[1])[0])==null?void 0:ot.placement;if(!se)switch(h){case"bestFit":{var rt;let Z=(rt=ee.filter($=>{if(E){let V=D($.placement);return V===w||V==="y"}return!0}).map($=>[$.placement,$.overflows.filter(V=>V>0).reduce((V,vn)=>V+vn,0)]).sort(($,V)=>$[1]-V[1])[0])==null?void 0:rt[0];Z&&(se=Z);break}case"initialPlacement":se=a;break}if(o!==se)return{reset:{placement:se}}}return{}}}};var Vn=new Set(["left","top"]);async function Un(t,e){let{placement:n,platform:i,elements:o}=t,r=await(i.isRTL==null?void 0:i.isRTL(o.floating)),s=q(n),a=ge(n),l=D(n)==="y",c=Vn.has(s)?-1:1,p=r&&l?-1:1,d=me(e,t),{mainAxis:u,crossAxis:h,alignmentAxis:f}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&typeof f=="number"&&(h=a==="end"?f*-1:f),l?{x:h*p,y:u*c}:{x:u*c,y:h*p}}var Rt=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var n,i;let{x:o,y:r,placement:s,middlewareData:a}=e,l=await Un(e,t);return s===((n=a.offset)==null?void 0:n.placement)&&(i=a.arrow)!=null&&i.alignmentOffset?{}:{x:o+l.x,y:r+l.y,data:{...l,placement:s}}}}},Bt=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:n,y:i,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:y=>{let{x:w,y:b}=y;return{x:w,y:b}}},...c}=me(t,e),p={x:n,y:i},d=await r.detectOverflow(e,c),u=D(q(o)),h=Xe(u),f=p[h],m=p[u];if(s){let y=h==="y"?"top":"left",w=h==="y"?"bottom":"right",b=f+d[y],L=f-d[w];f=Je(b,f,L)}if(a){let y=u==="y"?"top":"left",w=u==="y"?"bottom":"right",b=m+d[y],L=m-d[w];m=Je(b,m,L)}let v=l.fn({...e,[h]:f,[u]:m});return{...v,data:{x:v.x-n,y:v.y-i,enabled:{[h]:s,[u]:a}}}}}};function Ne(){return typeof window<"u"}function J(t){return Nt(t)?(t.nodeName||"").toLowerCase():"#document"}function A(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function B(t){var e;return(e=(Nt(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function Nt(t){return Ne()?t instanceof Node||t instanceof A(t).Node:!1}function _(t){return Ne()?t instanceof Element||t instanceof A(t).Element:!1}function O(t){return Ne()?t instanceof HTMLElement||t instanceof A(t).HTMLElement:!1}function Ft(t){return!Ne()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof A(t).ShadowRoot}var Wn=new Set(["inline","contents"]);function ie(t){let{overflow:e,overflowX:n,overflowY:i,display:o}=P(t);return/auto|scroll|overlay|hidden|clip/.test(e+i+n)&&!Wn.has(o)}var qn=new Set(["table","td","th"]);function Dt(t){return qn.has(J(t))}var Kn=[":popover-open",":modal"];function ve(t){return Kn.some(e=>{try{return t.matches(e)}catch(n){return!1}})}var Zn=["transform","translate","scale","rotate","perspective"],Qn=["transform","translate","scale","rotate","perspective","filter"],Gn=["paint","layout","strict","content"];function De(t){let e=ze(),n=_(t)?P(t):t;return Zn.some(i=>n[i]?n[i]!=="none":!1)||(n.containerType?n.containerType!=="normal":!1)||!e&&(n.backdropFilter?n.backdropFilter!=="none":!1)||!e&&(n.filter?n.filter!=="none":!1)||Qn.some(i=>(n.willChange||"").includes(i))||Gn.some(i=>(n.contain||"").includes(i))}function zt(t){let e=z(t);for(;O(e)&&!X(e);){if(De(e))return e;if(ve(e))return null;e=z(e)}return null}function ze(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Jn=new Set(["html","body","#document"]);function X(t){return Jn.has(J(t))}function P(t){return A(t).getComputedStyle(t)}function ye(t){return _(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function z(t){if(J(t)==="html")return t;let e=t.assignedSlot||t.parentNode||Ft(t)&&t.host||B(t);return Ft(e)?e.host:e}function jt(t){let e=z(t);return X(e)?t.ownerDocument?t.ownerDocument.body:t.body:O(e)&&ie(e)?e:jt(e)}function Fe(t,e,n){var i;e===void 0&&(e=[]),n===void 0&&(n=!0);let o=jt(t),r=o===((i=t.ownerDocument)==null?void 0:i.body),s=A(o);if(r){let a=je(s);return e.concat(s,s.visualViewport||[],ie(o)?o:[],a&&n?Fe(a):[])}return e.concat(o,Fe(o,[],n))}function je(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function qt(t){let e=P(t),n=parseFloat(e.width)||0,i=parseFloat(e.height)||0,o=O(t),r=o?t.offsetWidth:n,s=o?t.offsetHeight:i,a=fe(n)!==r||fe(i)!==s;return a&&(n=r,i=s),{width:n,height:i,$:a}}function Kt(t){return _(t)?t:t.contextElement}function oe(t){let e=Kt(t);if(!O(e))return H(1);let n=e.getBoundingClientRect(),{width:i,height:o,$:r}=qt(e),s=(r?fe(n.width):n.width)/i,a=(r?fe(n.height):n.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var Xn=H(0);function Zt(t){let e=A(t);return!ze()||!e.visualViewport?Xn:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Yn(t,e,n){return e===void 0&&(e=!1),!n||e&&n!==A(t)?!1:e}function we(t,e,n,i){e===void 0&&(e=!1),n===void 0&&(n=!1);let o=t.getBoundingClientRect(),r=Kt(t),s=H(1);e&&(i?_(i)&&(s=oe(i)):s=oe(t));let a=Yn(r,n,i)?Zt(r):H(0),l=(o.left+a.x)/s.x,c=(o.top+a.y)/s.y,p=o.width/s.x,d=o.height/s.y;if(r){let u=A(r),h=i&&_(i)?A(i):i,f=u,m=je(f);for(;m&&i&&h!==f;){let v=oe(m),y=m.getBoundingClientRect(),w=P(m),b=y.left+(m.clientLeft+parseFloat(w.paddingLeft))*v.x,L=y.top+(m.clientTop+parseFloat(w.paddingTop))*v.y;l*=v.x,c*=v.y,p*=v.x,d*=v.y,l+=b,c+=L,f=A(m),m=je(f)}}return G({width:p,height:d,x:l,y:c})}function Ve(t,e){let n=ye(t).scrollLeft;return e?e.left+n:we(B(t)).left+n}function Qt(t,e){let n=t.getBoundingClientRect(),i=n.left+e.scrollLeft-Ve(t,n),o=n.top+e.scrollTop;return{x:i,y:o}}function ei(t){let{elements:e,rect:n,offsetParent:i,strategy:o}=t,r=o==="fixed",s=B(i),a=e?ve(e.floating):!1;if(i===s||a&&r)return n;let l={scrollLeft:0,scrollTop:0},c=H(1),p=H(0),d=O(i);if((d||!d&&!r)&&((J(i)!=="body"||ie(s))&&(l=ye(i)),O(i))){let h=we(i);c=oe(i),p.x=h.x+i.clientLeft,p.y=h.y+i.clientTop}let u=s&&!d&&!r?Qt(s,l):H(0);return{width:n.width*c.x,height:n.height*c.y,x:n.x*c.x-l.scrollLeft*c.x+p.x+u.x,y:n.y*c.y-l.scrollTop*c.y+p.y+u.y}}function ti(t){return Array.from(t.getClientRects())}function ni(t){let e=B(t),n=ye(t),i=t.ownerDocument.body,o=W(e.scrollWidth,e.clientWidth,i.scrollWidth,i.clientWidth),r=W(e.scrollHeight,e.clientHeight,i.scrollHeight,i.clientHeight),s=-n.scrollLeft+Ve(t),a=-n.scrollTop;return P(i).direction==="rtl"&&(s+=W(e.clientWidth,i.clientWidth)-o),{width:o,height:r,x:s,y:a}}var Vt=25;function ii(t,e){let n=A(t),i=B(t),o=n.visualViewport,r=i.clientWidth,s=i.clientHeight,a=0,l=0;if(o){r=o.width,s=o.height;let p=ze();(!p||p&&e==="fixed")&&(a=o.offsetLeft,l=o.offsetTop)}let c=Ve(i);if(c<=0){let p=i.ownerDocument,d=p.body,u=getComputedStyle(d),h=p.compatMode==="CSS1Compat"&&parseFloat(u.marginLeft)+parseFloat(u.marginRight)||0,f=Math.abs(i.clientWidth-d.clientWidth-h);f<=Vt&&(r-=f)}else c<=Vt&&(r+=c);return{width:r,height:s,x:a,y:l}}var oi=new Set(["absolute","fixed"]);function ri(t,e){let n=we(t,!0,e==="fixed"),i=n.top+t.clientTop,o=n.left+t.clientLeft,r=O(t)?oe(t):H(1),s=t.clientWidth*r.x,a=t.clientHeight*r.y,l=o*r.x,c=i*r.y;return{width:s,height:a,x:l,y:c}}function Ut(t,e,n){let i;if(e==="viewport")i=ii(t,n);else if(e==="document")i=ni(B(t));else if(_(e))i=ri(e,n);else{let o=Zt(t);i={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return G(i)}function Gt(t,e){let n=z(t);return n===e||!_(n)||X(n)?!1:P(n).position==="fixed"||Gt(n,e)}function si(t,e){let n=e.get(t);if(n)return n;let i=Fe(t,[],!1).filter(a=>_(a)&&J(a)!=="body"),o=null,r=P(t).position==="fixed",s=r?z(t):t;for(;_(s)&&!X(s);){let a=P(s),l=De(s);!l&&a.position==="fixed"&&(o=null),(r?!l&&!o:!l&&a.position==="static"&&!!o&&oi.has(o.position)||ie(s)&&!l&&Gt(t,s))?i=i.filter(p=>p!==s):o=a,s=z(s)}return e.set(t,i),i}function ai(t){let{element:e,boundary:n,rootBoundary:i,strategy:o}=t,s=[...n==="clippingAncestors"?ve(e)?[]:si(e,this._c):[].concat(n),i],a=s[0],l=s.reduce((c,p)=>{let d=Ut(e,p,o);return c.top=W(d.top,c.top),c.right=he(d.right,c.right),c.bottom=he(d.bottom,c.bottom),c.left=W(d.left,c.left),c},Ut(e,a,o));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function li(t){let{width:e,height:n}=qt(t);return{width:e,height:n}}function ci(t,e,n){let i=O(e),o=B(e),r=n==="fixed",s=we(t,!0,r,e),a={scrollLeft:0,scrollTop:0},l=H(0);function c(){l.x=Ve(o)}if(i||!i&&!r)if((J(e)!=="body"||ie(o))&&(a=ye(e)),i){let h=we(e,!0,r,e);l.x=h.x+e.clientLeft,l.y=h.y+e.clientTop}else o&&c();r&&!i&&o&&c();let p=o&&!i&&!r?Qt(o,a):H(0),d=s.left+a.scrollLeft-l.x-p.x,u=s.top+a.scrollTop-l.y-p.y;return{x:d,y:u,width:s.width,height:s.height}}function tt(t){return P(t).position==="static"}function Wt(t,e){if(!O(t)||P(t).position==="fixed")return null;if(e)return e(t);let n=t.offsetParent;return B(t)===n&&(n=n.ownerDocument.body),n}function Jt(t,e){let n=A(t);if(ve(t))return n;if(!O(t)){let o=z(t);for(;o&&!X(o);){if(_(o)&&!tt(o))return o;o=z(o)}return n}let i=Wt(t,e);for(;i&&Dt(i)&&tt(i);)i=Wt(i,e);return i&&X(i)&&tt(i)&&!De(i)?n:i||zt(t)||n}var pi=async function(t){let e=this.getOffsetParent||Jt,n=this.getDimensions,i=await n(t.floating);return{reference:ci(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}};function di(t){return P(t).direction==="rtl"}var ui={convertOffsetParentRelativeRectToViewportRelativeRect:ei,getDocumentElement:B,getClippingRect:ai,getOffsetParent:Jt,getElementRects:pi,getClientRects:ti,getDimensions:li,getScale:oe,isElement:_,isRTL:di};var Xt=Rt;var Yt=Bt,en=It;var tn=(t,e,n)=>{let i=new Map,o={platform:ui,...n},r={...o.platform,_c:i};return Ot(t,e,{...o,platform:r})};var Ue=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
